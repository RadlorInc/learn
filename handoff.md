...
> 📱 **2026-07-26 (LATEST) — PORTRAIT IS NOW A REAL LAYOUT FOR 12–18, NOT JUST AN ALLOWED ONE. ✅ COMMITTED, NOT PUSHED — `feat/teen-17-18-gameshell`@`496c2dd`. `tsc` · 136/136 vitest · `next build` · e2e question-quality 7/7 across all three teen bands · measured at 390×844 · 834×1194 · 640×320 · 1280×800.**
>
...
>
> **Before this can merge:** the full 34-chapter `question-quality` run (~20m), not the 11 chapters
> driven here — this touches the shared shell for all 24 existing teen chapters, not only the 10 new
> ones. Then bump `public/sw.js` VERSION, which is a deploy step and was deliberately NOT done here.
>
> ## ▶ OPEN
