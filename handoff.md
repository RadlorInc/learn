...
>
> ## ▶ OPEN
> 1. ✅ **SHIPPED — `main`@`1bc48af`, prod serving sw v75.** (The chapter landed at `fa48746`/v74; the two faults §⑤b found shipped on top as `6fd8551` + `1bc48af`/v75, prod confirmed on the ninth poll.)
>    | commit | what |
>    |---|---|
