...
> **Noticed, not fixed (different chapter, not this session's scope):** CoinShop's INTRO card still says
> *"count that much out of your purse onto his cloth"* — the cloth was deleted in its own §④a and the
> in-round wording was fixed, but the intro copy still names it.
>
