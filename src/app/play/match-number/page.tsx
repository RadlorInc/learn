...
import { useMiloSpeaker, useIsSpeaking } from '@/infra/useMiloSpeaker'
...
import CameraError from '@/shared/ui/CameraError'
import HowToPlay from '@/shared/ui/HowToPlay'
import { useHandPincher } from '@/infra/ar/useHandPincher'
...
export default function MatchNumberActivity() {
  ...
  if (phase === 'howto') {
    return <HowToPlay title="Match the Number" steps={['Pinch a number with your fingers.', 'Drag it onto the apples!']} demo="pinch" onStart={() => setPhase('playing')} />
  }
