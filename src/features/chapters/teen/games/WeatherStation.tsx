...
function colder(): Task {
  ...
  return {
    ...
    context: `One account has ${disp(a)}. The other has ${disp(b)}.`,
    padInstruction: `Tap the ${low ? 'lower' : 'higher'} balance. Below 0 is lower than above 0.`,
...
function afterChange(): Task {
  ...
  return {
    ...
    context: `Your balance is ${disp(s)}. Then you ${dir}.`,
    padInstruction: 'Work out the new balance. Then tap that number.',
...
function opposite(): Task {
  ...
  return {
    ...
    context: `The opposite is the same distance from 0, but on the other side.`,
...
function distance(): Task {
  ...
  return {
    ...
    context: `Count the steps from ${disp(t)} back to 0. Steps are always positive.`,
...
const GUIDED_TASK: Task = {
  ...
  context: 'Your balance is −1. Then you withdraw 4.',
  padInstruction: 'Work out the new balance. Then tap that number.',
