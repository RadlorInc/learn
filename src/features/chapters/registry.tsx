...
const PORTAL_CHAPTERS = {
  ...
  numberRecognition: story("numberRecognition", "#241c39", () => import("@/features/chapters/story/NumberDoors")),
  numberOrdering: story("numberOrdering", "#bfe6f7", () => import("@/features/chapters/story/RiverCrossing")),
