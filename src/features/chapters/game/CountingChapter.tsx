...
import { useAdaptive, countTarget } from '@/core/adaptive'
import { makeDistinct } from '@/core/questionVariety'
import { nounFor, singular } from '@/core/grammar'
import { DifficultyBadge } from '@/shared/ui/DifficultyBadge'


import { useChapterPhase } from '@/shared/hooks/useChapterPhase'
import SpeakingLock from '@/shared/ui/SpeakingLock'
import GameTopbar from '@/shared/ui/GameTopbar'
import { afterSpeech, speakAfterCurrent, speak, speakAt, stopSpeech, useMiloSpeaker } from '@/infra/useMiloSpeaker'
