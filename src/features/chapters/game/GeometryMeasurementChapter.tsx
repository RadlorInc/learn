'use client'
/**
 * GeometryMeasurementChapter (12–14) — PLAYABLE-GAME chapter shape (no slides, no MCQ).
 * One continuous BuildSite scene; Milo demos order #1 in-scene, then the kid plays.
...
import BuildSite from '@/features/chapters/teen/games/BuildSite'
  ...
  if (phase === 'done') {
    return (
      <div className="milo-lesson" style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 18px', background: 'var(--bg-page)', color: 'var(--ink)', fontFamily: 'var(--font-body)', boxSizing: 'border-box' }}>
        <MasteryState
          band={BAND}
          conceptsConfirmed={['Area of a rectangle', 'Perimeter', 'Volume of a box', 'Pythagoras (the brace)']}
          nextPointer="You have finished the 12-14 set."
