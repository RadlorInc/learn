'use client'
/**
 * OrderOfOperationsChapter (12–14) — PLAYABLE-GAME chapter shape (no slides, no MCQ).
 * One continuous ScoreMachine scene; Milo demos order #1 in-scene, then the kid plays.
  ...
  if (phase === 'done') {
    return (
      <div className="milo-lesson" style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 18px', background: 'var(--bg-page)', color: 'var(--ink)', fontFamily: 'var(--font-body)', boxSizing: 'border-box' }}>
        <MasteryState
          band={BAND}
          conceptsConfirmed={['Brackets first', 'Times & divide next', 'Add & subtract last', 'Reading an expression']}
