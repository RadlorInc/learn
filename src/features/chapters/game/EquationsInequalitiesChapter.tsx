'use client'
/**
 * EquationsInequalitiesChapter (12–14) — PLAYABLE-GAME chapter shape (no slides, no MCQ).
 * One continuous BalanceBench scene; Milo demos order #1 in-scene, then the kid plays.
...
import BalanceBench from '@/features/chapters/teen/games/BalanceBench'
  ...
  if (phase === 'done') {
    return (
      <div className="milo-lesson" style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 18px', background: 'var(--bg-page)', color: 'var(--ink)', fontFamily: 'var(--font-body)', boxSizing: 'border-box' }}>
        <MasteryState
          band={BAND}
          conceptsConfirmed={['Balancing an equation', 'Solving for x', 'Undoing operations', 'Checking the solution']}
