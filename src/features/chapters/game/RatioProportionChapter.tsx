'use client'
/**
 * RatioProportionChapter (12–14) — PLAYABLE-GAME chapter shape (no slides, no MCQ).
 * One continuous JuiceBar scene; Milo demos order #1 in-scene, then the kid plays.
...
import JuiceBar from '@/features/chapters/teen/games/JuiceBar'
  ...
  if (phase === 'done') {
    return (
      <div className="milo-lesson" style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 18px', background: 'var(--bg-page)', color: 'var(--ink)', fontFamily: 'var(--font-body)', boxSizing: 'border-box' }}>
        <MasteryState
          band={BAND}
          conceptsConfirmed={['Filling to a ratio', 'Scaling a recipe', 'Finding the missing part', 'Equivalent ratios']}
