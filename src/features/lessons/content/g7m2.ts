...
export const G7M2: Lesson[] = [
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: '4 is not enough', text: 'Both are 4 feet from the water. If you write 4 for both, you cannot tell which one is up and which one is down.',
      ...
      { title: 'The big idea', text: 'Opposites are the same distance from 0, on different sides. Change the sign and you get the opposite.',
        pictures: [line(-10, 10, [{ at: 4, label: '4' }, { at: -4, label: '−4' }])] },
      { title: 'Count from 0', text: 'The water is 0. The bird is 4 steps to the right of 0, so the bird is at 4.',
        pictures: [line(-10, 10, [{ at: 4, label: '4' }], [{ from: 0, to: 4, label: '4 steps' }], true)] },
      { title: 'Same distance, other side', text: 'The fish is 4 steps to the LEFT of 0. Left of 0 gets a minus sign, so the fish is at −4.',
        pictures: [line(-10, 10, [{ at: 4, label: '4' }, { at: -4, label: '−4' }], [{ from: 0, to: 4, label: '4 steps' }, { from: 0, to: -4, label: '4 steps' }], true)] },
      { title: 'Opposites come in pairs', text: '4 and −4 are opposites. So are 7 and −7. The opposite of 7 is −7, and the opposite of −7 is 7.',
        pictures: [line(-10, 10, [{ at: 7, label: '7' }, { at: -7, label: '−7' }]), eq('opposite of 7 → −7', ['opposite of −7 → 7'])] },
      { title: 'One thing not to do', text: "Don't keep the minus sign. The opposite of a number left of 0 is on the right of 0.",
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The minus sign is not the distance', text: "Ben's spot is −5. But he did not walk −5 blocks. Nobody can walk a negative number of blocks.",
        pictures: [line(-10, 10, [{ at: 5, label: 'Ana' }, { at: -5, label: 'Ben' }])] },
      ...
      { title: 'Count the steps', text: 'Start at −5 and count the steps to 0: 1, 2, 3, 4, 5. So −5 is 5 steps from 0.',
        pictures: [line(-10, 10, [{ at: -5, label: '−5' }], [{ from: -5, to: 0, label: '5 steps' }], true)] },
      { title: 'Both are 5 away', text: 'From 5 to 0 is also 5 steps. Ana and Ben walked the same distance: 5 blocks each.',
        pictures: [line(-10, 10, [{ at: 5, label: '5' }, { at: -5, label: '−5' }], [{ from: -5, to: 0, label: '5 steps' }, { from: 5, to: 0, label: '5 steps' }], true)] },
      { title: 'Write it with bars', text: 'Two bars around a number mean "how far from 0". |−5| = 5 and |5| = 5. Only 0 is 0 steps away.',
        pictures: [eq('|−5| = 5', ['|5| = 5', '|0| = 0'])] },
      { title: 'One thing not to do', text: "Don't keep the minus sign inside the bars. A distance is never negative.",
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Adding does not always make more', text: '3 + 5 would be 8. But you LOST 5 points, so your score cannot have gone up. Adding a negative number makes less.',
        pictures: [chips(3, 5)] },
      ...
      { title: 'Pair them up', text: 'Put one plus counter with one minus counter. Win 1 and lose 1 is 0. You can make 3 pairs.',
        pictures: [chips(3, 5, 3, true)] },
      { title: 'Take the pairs away', text: 'Each pair is 0, so taking the pairs away changes nothing. 2 minus counters are left.',
        pictures: [chips(0, 2, 0, true)] },
      { title: 'Read what is left', text: '2 minus counters is −2. So 3 + (−5) = −2. Your score went down by 2.',
        pictures: [chips(0, 2), eq('3 + (−5) = −2')] },
      { title: 'One thing not to do', text: "Don't add the 5 on. A minus counter cancels a plus counter.",
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Too many minus signs', text: 'In −3 − 5, one minus sign is part of the number and one means take away. And what could −3 − (−5) mean? It gets confusing fast.',
        pictures: [eq('−3 − 5', ['−3 − (−5)'])] },
      { title: 'The big idea', text: 'Taking away a number is the same as adding its opposite. Change − to +, and change the second number to its opposite.',
        pictures: [eq('−3 − 5 = −3 + (−5)')] },
      { title: 'Change it to adding', text: 'Change − to +. The opposite of 5 is −5. So −3 − 5 becomes −3 + (−5).',
        pictures: [line(-10, 10, [{ at: -3, label: 'start' }]), eq('−3 − 5', ['−3 + (−5)'])] },
      { title: 'Add on the number line', text: 'Start at −3. Adding −5 means 5 steps to the left.',
        pictures: [line(-10, 10, [{ at: -3, label: 'start' }], [{ from: -3, to: -8, label: '+ (−5)' }], true)] },
      { title: 'Where you land', text: 'You land on −8. So −3 − 5 = −8. The elevator is on floor −8.',
        pictures: [line(-10, 10, [{ at: -3, label: 'start' }, { at: -8, label: '−8' }], [{ from: -3, to: -8, label: '+ (−5)' }]), eq('−3 − 5 = −8')] },
      { title: 'One thing not to do', text: "Don't just take the small number from the big one. Change it to adding the opposite, then move on the line.",
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'What about two minus signs?', text: '3 × (−2) is 3 groups of −2. But what could −3 × (−2) mean? You cannot make −3 groups.',
        pictures: [eq('3 × (−2) = ?', ['−3 × (−2) = ?'])] },
      { title: 'The big idea', text: 'Multiply the numbers as usual. Same signs make a positive answer, and different signs make a negative answer.',
        pictures: [SIGNS] },
      { title: 'Groups of −2', text: 'Watch 3 × a number as the number counts down. The answers drop by 3 each time: 6, 3, 0, −3, −6. So 3 × (−2) = −6.',
        pictures: [{ kind: 'table', head: ['3 × 2', '3 × 1', '3 × 0', '3 × (−1)', '3 × (−2)'], rows: [['6', '3', '0', '−3', '−6']], motion: true }] },
      { title: 'Now start with −3', text: 'Now −3 × a number. As the number counts down, the answers go UP by 3: −6, −3, 0, 3, 6. So −3 × (−2) = 6.',
        pictures: [{ kind: 'table', head: ['−3 × 2', '−3 × 1', '−3 × 0', '−3 × (−1)', '−3 × (−2)'], rows: [['−6', '−3', '0', '3', '6']], motion: true }] },
      { title: 'Just check the signs', text: 'Multiply 3 × 2 = 6. Then look at the signs. 3 × (−2): different signs, so −6. −3 × (−2): same signs, so 6.',
        pictures: [SIGNS, eq('3 × (−2) = −6', ['−3 × (−2) = 6'])] },
      { title: 'One thing not to do', text: "Don't think two negatives make a bigger negative. Same signs give a positive answer.",
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The sign matters', text: '12 ÷ 4 = 3. But an answer of 3 would say the team GAINED 3 points a game. It lost points, so the sign has to show that.',
      ...
      { title: 'The big idea', text: 'Dividing uses the same sign rule as multiplying. Same signs make a positive answer, and different signs make a negative answer.',
        pictures: [SIGNS] },
      { title: 'Undo a multiplication', text: 'Dividing undoes multiplying. What times 4 makes −12? 4 × (−3) = −12. So −12 ÷ 4 = −3.',
        pictures: [{ kind: 'table', head: ['Divide', 'Check by multiplying'], rows: [['−12 ÷ 4 = −3', '4 × (−3) = −12']], motion: true }] },
      { title: 'Two negatives', text: 'Now −12 ÷ (−4). What times −4 makes −12? −4 × 3 = −12. So −12 ÷ (−4) = 3.',
        pictures: [{ kind: 'table', head: ['Divide', 'Check by multiplying'], rows: [['−12 ÷ 4 = −3', '4 × (−3) = −12'], ['−12 ÷ (−4) = 3', '−4 × 3 = −12']], motion: true }] },
      { title: 'Just check the signs', text: 'Divide 12 ÷ 4 = 3. Then look at the signs. Same signs give 3. Different signs give −3.',
        pictures: [{ kind: 'table', head: ['Divide', 'Signs', 'Answer'], rows: [['12 ÷ 4', 'same', '3'], ['−12 ÷ (−4)', 'same', '3'], ['−12 ÷ 4', 'different', '−3'], ['12 ÷ (−4)', 'different', '−3']], motion: true }] },
      { title: 'One thing not to do', text: "Don't keep a minus sign just because both numbers have one. Two negatives divide to a positive.",
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Easy to drop the sign', text: 'It is easy to forget the minus sign and work out 1/2 + 3/4 = 5/4. But the frog started BELOW 0, so it cannot get that high.',
        pictures: [fourths([{ at: -0.5, label: 'frog' }])] },
      ...
      { title: 'Use the same bottom number', text: '−1/2 is the same as −2/4. Now both numbers are in fourths: −2/4 + 3/4.',
        pictures: [fourths([{ at: -0.5, label: '−2/4' }], undefined, true), eq('−1/2 + 3/4', ['−2/4 + 3/4'])] },
      { title: 'Jump on the line', text: 'Start at −2/4. Adding 3/4 means 3 fourths to the right: −1/4, 0, 1/4.',
        pictures: [fourths([{ at: -0.5, label: 'start' }], [{ from: -0.5, to: 0.25, label: '+3/4' }], true)] },
      { title: 'Where it lands', text: 'The frog lands on 1/4. So −1/2 + 3/4 = 1/4. Decimals work the same way: −2.5 × 4 has different signs, so it is −10.',
        pictures: [fourths([{ at: 0.25, label: '1/4' }], [{ from: -0.5, to: 0.25, label: '+3/4' }]), eq('−1/2 + 3/4 = 1/4', ['−2.5 × 4 = −10'])] },
      { title: 'One thing not to do', text: "Don't drop the minus sign on a fraction or a decimal. It still means left of 0.",
  ...
  // ── Topic 8 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The words pick the sign', text: 'If you do −5 − 8 you get −13, which is colder. But the story says warmer. The words tell you which way to go.',
        pictures: [thermo(-5, -10, 10, 5)] },
      ...
      { title: 'Write it with signs', text: 'Start at −5. Warmer means up, so the change is +8. The math is −5 + 8.',
        pictures: [thermo(-5, -10, 10, 5), change([['−5', '+8', '?']], true)] },
      { title: 'Climb the thermometer', text: 'Go up 5 degrees to reach 0. That uses 5 of the 8. Go up 3 more to reach 3.',
        pictures: [thermo(3, -10, 10, 5), { kind: 'table', head: ['From', 'Up', 'To'], rows: [['−5', '5', '0'], ['0', '3', '3']], motion: true }] },
      { title: 'Check it makes sense', text: 'Warmer should give a higher number, and 3 is higher than −5. It is 3 °C at noon.',
        pictures: [thermo(3, -10, 10, 5), eq('−5 + 8 = 3')] },
      { title: 'One thing not to do', text: "Don't copy the sign of the first number. Warmer means add. Colder means take away.",
