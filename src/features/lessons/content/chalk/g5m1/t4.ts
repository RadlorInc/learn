...
export const T4: (ChalkMark[] | undefined)[] = [
  ...
  [
    ...
    write([1, 'exact'], 'exact', 140, 210, 28, 'd'), cross([1, 'No'], 100, 190, 80, 40),
    write([2, '1,000'], '1,000?', 130, 310, 32), write([2, '10,000'], '10,000?', 300, 310, 32), write([2, '100,000'], '100,000?', 470, 310, 32),
  ],
  // The big idea: swap for round numbers, a fact, then the zeros
  [
    ...
    write([0, 'fact'], '3 × 4', 300, 270, 36, 'b'), write([0, 'fact'], 'a fact you know', 460, 270, 22, 'd'),
    ring([0, 'zeros'], 243, 175, 12, 22, 'r'), ring([0, 'zeros'], 354, 175, 26, 22, 'r'),
    write([0, 'zeros'], 'then the zeros', 300, 345, 30, 'r'),
  ],
  // Round each number
  [
  ...
  [
    ...
    write([2, '12'], '12', 262, 270, 44, 'b'), write([2, 'after'], ',000', 330, 270, 44, 'y'), ring([2, 'after'], 340, 270, 36, 28, 'r'),
  ...
  [
    ...
    write([2, '24'], '24 ÷ 6 = 4', 160, 240, 34, 'b'), write([2, '60'], '60 × 40 = 2,400', 420, 240, 34),
    write([2, 'crates'], 'about 40 crates', 300, 330, 32, 'y'),
  ],
  // One thing not to do
  [
    ...warn([0, 'mix']),
    write([1, '30'], '30 × 400 = 1,200', 300, 180, 34, 'r'), cross([1, 'not'], 335, 160, 105, 40),
    write([2, 'three'], '30 × 400', 180, 280, 36), write([2, 'zeros'], '1 + 2 = 3 zeros', 180, 330, 22, 'd'),
    write([2, '12,000'], '= 12,000', 360, 280, 36, 'y'), ring([2, '12,000'], 405, 280, 34, 24, 'r'),
  ],
]
