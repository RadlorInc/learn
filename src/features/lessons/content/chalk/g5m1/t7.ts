...
export const T7: (ChalkMark[] | undefined)[] = [
  ...
  [
    ...
    write([1, 'adding'], '128 + 128 + 128 + 128 + 128 + 128', 300, 170, 26),
    span([1, 'six'], 85, 515, 205, 'd'), write([1, 'six'], '6 times', 300, 237, 24, 'd'),
    clock([1, 'long'], 500, 310, 26),
    write([1, 'slip'], '1 slip → wrong answer', 260, 310, 26, 'r'),
  ],
  // The big idea
  [
    ...
    ...q([write([1, 'each'], '× 6', 195, 205, 26), write([1, 'each'], '× 6', 390, 205, 26), write([1, 'each'], '× 6', 495, 205, 26)]),
    box([1, 'add'], 160, 245, 70, 44, 'y'), write([1, 'add'], '+', 292, 267, 32),
    box([1, 'add'], 355, 245, 70, 44, 'b'), write([1, 'add'], '+', 442, 267, 32), box([1, 'add'], 460, 245, 70, 44),
    write([1, 'parts'], '= total', 345, 330, 30, 'y'),
  ],
  // Break 128 apart
  [
  ...
  [
    ...warn([0, 'Watch']),
    write([1, 'multiply'], '6 × 128 = 6 + 12 + 48', 300, 140, 30, 'r'), cross([1, 'ones'], 150, 120, 300, 40),
