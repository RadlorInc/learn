...
export const T17: (ChalkMark[] | undefined)[] = [
  ...
  [
    ...
    write([1, '3'], '3 bags', 300, 305, 30, 'y'),
    q(write([1, 'same'], '=', 210, 80, 36, 'r')), q(write([1, 'same'], '=', 390, 80, 36, 'r')),
    write([1, 'same'], 'all the same', 300, 355, 28, 'y'),
  ],
  // The big idea
  [
    ...
    write([1, '3'], '3 ×', 215, 205, 40, 'r'), write([1, '4'], '(4 + 2)', 340, 205, 40),
    ...bags3([1, 'times'], 250, 60),
    write([1, 'much'], '3 times as much as 4 + 2', 300, 360, 26, 'y'),
  ],
  ...
  [
    ...bags3([0, 'bags'], 30, 70),
    q(write([0, 'same'], '=', 210, 65, 36, 'r')), q(write([0, 'same'], '=', 390, 65, 36, 'r')),
    write([0, 'write'], '3 ×', 215, 160, 40, 'r'), write([0, '4'], '(4 + 2)', 340, 160, 40),
    write([1, 'times'], '3 times as much as 4 + 2', 300, 220, 26, 'y'),
  ...
  [
    write([0, '3'], '3 × (4 + 2)', 150, 50, 34), write([0, 'and'], '3 × 4 + 2', 450, 50, 34),
    ...L3.flatMap(y => [q(box([1, 'bags'], 50, y, 200, 50)), q(box([1, 'bags'], 350, y, 200, 50))]),
    dots([1, 'apples'], L3.flatMap(y => [...row(75, y + 25, 4, 24), ...row(375, y + 25, 4, 24)]), 9, 'y'),
    dots([1, 'pears'], L3.flatMap(y => row(171, y + 25, 2, 24)), 9, 'b'),
    write([1, 'every'], 'in every bag', 150, 290, 24, 'b'),
    dots([2, 'pears'], [[435, 285], [465, 285]], 9, 'b'), write([2, 'all'], 'just 2 in all', 450, 325, 24, 'b'),
    write([2, 'more'], '>', 300, 50, 44, 'r'), ring([2, 'more'], 150, 50, 105, 28, 'y'),
  ],
  // One thing not to do
  [
    ...warn([0, 'careful']),
    write([1, 'leave'], '3 × 4 + 2', 170, 160, 36, 'r'), cross([1, 'out'], 270, 140, 40, 40),
    ...[20, 113, 206].map(x => q(box([2, 'bags'], x, 200, 86, 50))),
    dots([2, 'apples'], [20, 113, 206].flatMap(x => row(x + 16, 225, 4, 18)), 7, 'y'),
    dots([2, 'pears'], [[135, 285], [165, 285]], 9, 'b'),
    write([2, 'put'], '3 × (4 + 2)', 452, 160, 36, 'y'),
    ...[320, 410, 500].map(x => q(box([2, 'every'], x, 200, 84, 56))),
    q(dots([2, 'every'], [320, 410, 500].flatMap(x => row(x + 15, 216, 4, 18)), 7, 'y')),
    dots([2, 'every'], [320, 410, 500].flatMap(x => row(x + 33, 240, 2, 18)), 7, 'b'),
  ],
]
