...
export const T20: (ChalkMark[] | undefined)[] = [
  ...
  [
    ...
    write([1, 'empty'], 'empty seats = ?', 300, 190, 34, 'y'),
    write([2, 'sign'], '+ − × ÷', 300, 270, 40, 'd'),
    write([2, 'different'], 'a different question!', 300, 345, 28, 'r'),
  ],
  // The big idea
  [
    write([0, 'story'], 'the story', 300, 60, 24, 'd'), box([0, 'tape'], 60, 90, 480, 60),
    q(line([1, 'part'], [[360, 90], [360, 150]])), write([1, 'part'], 'part 1', 210, 120, 26, 'b'),
    arrow([1, 'time'], [250, 175], [410, 175], 'b'), write([1, 'time'], 'part 2', 450, 120, 26, 'b'),
    line([1, 'check'], [[90, 250], [110, 270], [145, 225]], 'y'),
    write([1, 'question'], 'what does the question ask?', 340, 250, 26, 'y'),
  ],
  ...
  [
    box([0], 40, 90, 520, 60),
    line([0, '186'], [[161, 90], [161, 150]]), wash([0, '186'], 40, 90, 121, 60, 'r'), write([0, 'sold'], '186 sold', 100, 120, 22, 'r'),
    span([0, '800'], 40, 560, 62), write([0, '800'], '800 seats', 300, 30, 26),
    wash([0, 'empty'], 161, 90, 399, 60, 'y'), write([0, 'empty'], 'empty', 300, 120, 26, 'y'),
  ...
  [
    ...
    write([2, 'part'], '186', 100, 258, 24, 'r'), write([2, '800'], '800 seats', 300, 212, 24),
