...
export const T6: (ChalkMark[] | undefined)[] = [
  ...
  [
    ...
    ring([1, '2'], 130, 145, 40, 26, 'y'), ring([1, '250'], 420, 230, 62, 24, 'b'),
    write([1, 'different'], 'different units!', 300, 305, 30, 'r'),
    write([1, 'divide'], '2 ÷ 250', 300, 362, 30, 'r'), cross([1, 'divide'], 240, 342, 120, 40),
  ],
  // The big idea
  [
    ...
    write([1, 'solve'], '2.', 50, 200, 32, 'd'), write([1, 'solve'], 'solve the story', 250, 200, 30),
    line([1, 'step'], [[90, 330], [90, 300], [160, 300], [160, 270], [230, 270], [230, 240], [300, 240]]),
    write([1, 'step'], 'one step at a time', 440, 290, 28),
  ],
  // First, the same unit
  [
  ...
  [
    ...
    ring([2, '8'], 293, 116, 284, 64, 'y'), write([2, 'cups'], '8 cups', 520, 42, 30, 'y'),
  ],
  // One thing not to do
  [
    ...warn([0, 'avoid']),
