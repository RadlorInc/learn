...
export const T10: (ChalkMark[] | undefined)[] = [
  ...
  [
    write([0, 'number'], '× 2 digits', 160, 60, 28, 'd'),
    ...
    ...q([write([1, 'so'], 'ones row', 440, 140, 28, 'b'), write([1, 'so'], 'tens row', 440, 190, 28, 'y')]),
    write([1, 'hundreds'], 'hundreds row', 440, 240, 28, 'r'),
  ],
  // The big idea
  [
    ...q([...num([0, 'Make'], '231', 400, 45, 'w', 34), write([0, 'Make'], '×', 292, 90, 34), ...num([0, 'Make'], '123', 400, 90, 'w', 34),
      line([0, 'Make'], [[270, 112], [420, 112]])]),
    ...q([write([0, 'digit'], 'row 1', 180, 145, 24, 'b'), write([0, 'digit'], 'row 2', 180, 190, 24, 'y'), write([0, 'digit'], 'row 3', 180, 235, 24)]),
    ring([0, 'bottom'], 364, 90, 56, 22, 'b'),
    write([0, 'new'], '0', 400, 190, 34, 'r'),
    write([0, '0'], '0', 364, 235, 34, 'r'), write([0, '0'], '0', 400, 235, 34, 'r'),
    write([1, 'add'], '+', 232, 190, 34), line([1, 'add'], [[222, 258], [420, 258]]),
    write([1, 'rows'], 'total', 350, 290, 26, 'd'),
  ],
  // The ones row
  [
    ...setup([0, 'Start']),
    ring([0, '3'], 330, 120, 16, 24, 'b'), write([0, '231'], '231 × 3', 110, 185, 24, 'd'),
  ...
  // The tens row
  [
    ...setup([0, 'Next']), ...q([...num([0, 'Next'], '693', 330, 185, 'b'), write([0, 'Next'], '231 × 3', 110, 185, 24, 'd')]),
    ring([0, '2'], 294, 120, 16, 24, 'y'), write([0, 'tens'], '2 tens', 500, 120, 24, 'y'),
    write([0, '0'], '0', 330, 230, 40, 'r'),
    write([1, '231'], '231 × 2 = 462', 500, 230, 24, 'd'), ...num([1, '462'], '462', 294, 230, 'y', 40, true),
    ring([1, '4,620'], 276, 230, 80, 28, 'y'), write([1, '4,620'], '231 × 20', 110, 230, 24, 'd'),
  ],
  ...
  [
    ...
    write([1, '231'], '231 × 1 = 231', 500, 256, 24, 'd'), ...num([1, 'and'], '231', 258, 256, 'w', 34, true),
    ring([1, '23,100'], 258, 256, 90, 20, 'r'),
  ...
  [
    ...warn([0, 'Careful']),
    ...num([1, 'forget'], '231', 222, 150), ...num([1, '0s'], '00', 294, 150, 'r'),
    ring([1, 'hundreds'], 276, 150, 36, 26, 'r'), write([1, 'hundreds'], 'hundreds row', 200, 100, 24, 'd'),
    ...
    write([2, '231'], '231', 430, 330, 36, 'r'), cross([2, '231'], 400, 308, 60, 44),
  ],
]
