...
export const T13: (ChalkMark[] | undefined)[] = [
  ...
  // No facts for 17s
  [
    write([0, 'facts'], 'my facts', 150, 45, 24, 'd'), write([0, '10'], 'up to 10 × 10', 150, 90, 30),
    write([0, '17s'], '17s?', 440, 80, 40, 'r'),
    line([1, 'count'], [[50, 210], [540, 210]]), write([1, 'count'], '0', 60, 240, 24),
    hop([1, '17'], 60, 162, 210, 'b'), write([1, '17'], '17', 162, 240, 24, 'b'),
    hop([1, '34'], 162, 264, 210, 'b'), write([1, '34'], '34', 264, 240, 24, 'b'),
    hop([1, '51'], 264, 366, 210, 'b'), write([1, '51'], '51', 366, 240, 24, 'b'),
    hop([1, 'on'], 366, 468, 210, 'd'), write([1, 'on'], 'and on', 468, 240, 24, 'd'),
    write([1, 'slow'], 'slow', 160, 290, 28, 'd'), write([1, 'hard'], 'hard to track', 430, 290, 28, 'r'),
    write([2, 'guess'], 'a smart guess', 300, 355, 32, 'y'),
  ],
  // The big idea
  [
    write([0, 'Guess'], '17', 100, 80, 40), arrow([0, 'nearest'], [140, 80], [210, 80], 'd'), write([0, 'ten'], '20', 250, 80, 40, 'y'),
    write([0, 'ten'], 'guess', 420, 80, 34, 'y'),
    write([0, 'multiply'], 'multiply to check', 300, 165, 30, 'b'),
    box([0, 'group'], 90, 230, 130, 50, 'y'), write([0, 'group'], 'a group', 155, 255, 24, 'y'),
    arrow([0, 'fits'], [225, 255], [290, 255], 'y'),
    box([0, 'left'], 300, 225, 180, 60), write([0, 'left'], 'what is left', 390, 255, 24),
    write([0, 'add'], 'add 1 more', 300, 345, 32, 'y'),
  ],
  // Make a guess
  [
  ...
  [
    ...
    ...teams([0, '17'], 90, 3, 'b'), wash([0, '51'], 60, 90, 306, 50, 'b'),
    write([0, '51'], '3 × 17 = 51', 200, 190, 34, 'b'),
  ...
  [
    ...
    wash([1, 'Add'], 366, 80, 102, 50, 'b'), write([1, 'team'], '+ 1 team', 470, 185, 26, 'b'),
  ...
  [
    ...warn([0, 'mix']),
    write([1, 'STOP'], '68 ÷ 17 = 3 and 17 left', 300, 170, 30, 'r'), ring([1, 'left'], 425, 170, 62, 24, 'y'),
    arrow([2, 'makes'], [425, 196], [425, 240], 'b'), write([2, 'team'], '+ 1 team', 425, 265, 28, 'b'),
    write([2, '4'], '68 ÷ 17 = 4', 300, 340, 40, 'y'), cross([2, 'not'], 266, 155, 24, 30),
  ],
]
