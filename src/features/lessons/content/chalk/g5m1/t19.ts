...
export const T19: (ChalkMark[] | undefined)[] = [
  ...
  [
    ...
    arrow([0, 'classes'], [245, 115], [322, 100], 'd'), write([0, 'Not'], 'not yet', 285, 150, 22, 'r'),
  ...
  [
    ...
    arrow([0, 'use'], [230, 105], [350, 105], 'y'), write([0, 'use'], 'step 2: use it', 450, 200, 26, 'b'),
    box([0, 'question'], 360, 60, 180, 90, 'b'), write([0, 'question'], 'the question', 450, 105, 26, 'b'),
  ],
  ...
  [
    write([0, 'sense'], 'does 48 make sense?', 300, 35, 26, 'd'),
    cells([1, '18'], 40, 65, 520, 50, 18, 'b'),
    ...Array.from({ length: 18 }, (_, i) => q(write([1, 'each'], '48', 40 + (520 / 18) * (i + 0.5), 90, 20, 'y'))),
    write([1, 'is'], '18 × 48 = 864', 300, 185, 40),
    span([2, 'every'], 40, 560, 135, 'y'),
    cells([2, '24'], 40, 245, 520, 45, 24, 'y'), write([2, 'boxes'], '864 in 24 boxes', 300, 315, 28, 'y'),
    write([2, 'checks'], 'it checks out', 300, 365, 32, 'y'),
  ],
  // One thing not to do
  [
    ...warn([0, 'mix']),
    write([1, 'STOP'], 'stop at 864', 170, 210, 30, 'r'), cross([1, 'number'], 80, 190, 180, 40),
    write([2, '864'], '864 = all markers', 170, 280, 28, 'y'), write([2, 'share'], 'not one class', 430, 280, 26, 'r'),
