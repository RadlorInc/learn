...
export const T14: (ChalkMark[] | undefined)[] = [
  ...
  [
    ...
    write([1, '1'], '23 in 1?', 150, 240, 30, 'b'), write([1, 'and'], 'no', 290, 240, 30, 'r'),
    write([1, '18'], '23 in 18?', 150, 300, 30, 'y'), write([1, 'either'], 'no', 290, 300, 30, 'r'),
  ],
  // The big idea
  [
    ...setup([0, 'divide']),
    line([0, 'fit'], [[238, 160], [292, 160]], 'r'), write([0, 'fit'], "doesn't fit", 265, 195, 24, 'r'),
    box([0, 'answer'], 292, 45, 36, 46, 'y'), write([0, 'digit'], '1 digit', 430, Q, 26, 'y'),
    write([0, 'round'], 'guess: 23 → 20', 300, 265, 30, 'b'),
    write([0, 'less'], 'too big? try one less', 300, 340, 30, 'y'),
  ],
  // Only one digit
  [
    ...setup([0, '23']),
    ring([0, '18'], 263, D, 28, 24, 'r'), line([0, 'no'], [[272, Q], [288, Q]], 'r'), write([0, 'no'], 'no tens', 140, 60, 24, 'r'),
    box([1, 'one'], 292, 45, 36, 46, 'y'), arrow([1, 'Up'], [372, 118], [338, 80], 'b'), write([1, '4'], '?', C[2], Q, S, 'y'),
  ...
  [
    ...
    write([0, '184'], '20s in 184?', 460, 130, 26, 'b'),
    write([0, '180'], '9 × 20 = 180', 470, 190, 28), write([0, 'guess'], '9', C[2], Q, S, 'y'),
    write([1, '207'], '9 × 23 = 207', 470, 250, 28),
    write([2, 'more'], '207 > 184', 470, 305, 28, 'r'),
  ...
  [
    ...warn([0, 'mix']),
    write([1, 'guess'], '184 ÷ 23 = 9', 300, 170, 34, 'r'), cross([1, 'big'], 378, 150, 32, 40),
    write([2, '9'], '9 × 23 = 207', 220, 250, 30), write([2, '184'], '> 184', 380, 250, 30, 'r'),
    write([2, 'less'], 'try one less', 300, 330, 34, 'y'),
  ],
]
