...
export const G7M5: Lesson[] = [
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "A fair sample gives everyone in the group the same chance to be picked.",
    screens: [
      { title: 'The favorite sport at school', text: 'A school has 400 students. You want to know their favorite sport, but you can only ask 20 of them. Which 20 should you ask?',
        pictures: [SCHOOL] },
      { title: "Asking the basketball team", text: "The basketball team has 20 kids, and they're easy to find. Look. 16 of the 20 pick basketball. Does that sound like the whole school? No. We only asked one kind of kid.",
        beats: [
          { say: "The basketball team has 20 kids, and they're easy to find.", pic: 0 },
          { say: "Look. 16 of the 20 pick basketball." },
          { say: "Does that sound like the whole school? No. We only asked one kind of kid." },
        ],
        pictures: [TEAM] },
      { title: "The big idea", text: "A fair sample gives everyone in the group the same chance to be picked.",
        beats: [
          { say: "A fair sample gives everyone in the group the same chance to be picked.", pic: 0 },
        ],
        pictures: [SCHOOL] },
      { title: "Pick names from a hat", text: "Here is a better way. Put all 400 names in a hat. Pull out 20 without looking. Now every student has the same chance. Nobody is left out.",
        beats: [
          { say: "Here is a better way. Put all 400 names in a hat.", pic: 0 },
          { say: "Pull out 20 without looking." },
          { say: "Now every student has the same chance. Nobody is left out." },
        ],
        pictures: [{ ...HAT, motion: true }] },
      { title: "It looks like the school", text: "So how did the hat do? 7 of the 20 names picked soccer. That's 35 out of every 100. In the whole school, 140 of 400 picked soccer. Also 35 out of every 100. The small group is a little copy of the big one.",
        beats: [
          { say: "So how did the hat do? 7 of the 20 names picked soccer.", pic: 0 },
          { say: "That's 35 out of every 100.", pic: 1 },
          { say: "In the whole school, 140 of 400 picked soccer. Also 35 out of every 100." },
          { say: "The small group is a little copy of the big one." },
        ],
        pictures: [HAT, { kind: 'eq', text: '7/20 = 35/100', lines: ['140/400 = 35/100'] }] },
      { title: "Ask who is left out", text: "So ask this every time. Could anyone never be picked? Ask the team, and every kid who is not on the team is left out. That's 380 kids. Draw from the hat, and nobody is left out.",
        beats: [
          { say: "So ask this every time. Could anyone never be picked?" },
          { say: "Ask the team, and every kid who is not on the team is left out. That's 380 kids.", pic: 0 },
          { say: "Draw from the hat, and nobody is left out.", pic: 1 },
        ],
        pictures: [{ ...TEAM, motion: true }, HAT] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't call a sample fair just because it's BIG. 100 fans at a basketball game is a lot, but they still pick basketball. Ask who is left out, not how many you asked. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't call a sample fair just because it's BIG.", pic: 0 },
          { say: "100 fans at a basketball game is a lot, but they still pick basketball." },
          { say: "Ask who is left out, not how many you asked." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "A fair sample is a small copy of the whole group, so the same fraction works for both.",
    screens: [
      { title: 'Pizza for the whole school', text: 'A school has 600 students. You ask 40 of them, picked by chance. 12 say pizza is their favorite lunch. How many of all 600 like pizza best?',
        pictures: [PIZZA_TAPE] },
      { title: "It is not just 12", text: "12 of the kids you asked like pizza best. So do just 12 kids in the whole school like pizza? No. You asked only 40 of the 600. Lots of pizza fans never got asked.",
        beats: [
          { say: "12 of the kids you asked like pizza best.", pic: 0 },
          { say: "So do just 12 kids in the whole school like pizza? No." },
          { say: "You asked only 40 of the 600. Lots of pizza fans never got asked." },
        ],
        pictures: [PIZZA_TAPE] },
      { title: "The big idea", text: "A fair sample is a small copy of the whole group, so the same fraction works for both.",
        beats: [
          { say: "A fair sample is a small copy of the whole group, so the same fraction works for both.", pic: 0 },
        ],
        pictures: [PIZZA_TAPE] },
      { title: "Find the fraction", text: "Start with the kids you asked. 12 out of 40 like pizza. Divide both by 4. 12 out of 40 is the same as 3 out of 10. So about 3 out of every 10 kids pick pizza.",
        beats: [
          { say: "Start with the kids you asked. 12 out of 40 like pizza." },
          { say: "Divide both by 4. 12 out of 40 is the same as 3 out of 10.", pic: 1 },
      ...
      { title: "Stretch it to 600", text: "Now the whole school. Does it need a new fraction? No. Same tape, just bigger. Split the 600 students into those same 10 equal parts. 600 ÷ 10 = 60, so each part is 60 kids.",
        beats: [
          { say: "Now the whole school. Does it need a new fraction? No. Same tape, just bigger.", pic: 0 },
      ...
      { title: "Count the pizza parts", text: "3 of those 10 parts are the pizza parts. So count them up. 3 × 60 = 180. Predict that about 180 of the 600 students pick pizza.",
        beats: [
          ...
          { say: "Predict that about 180 of the 600 students pick pizza." },
        ],
        pictures: [{ kind: 'tape', rows: [{ label: 'School', cells: tens('60'), brace: '600 kids' }] }, { kind: 'eq', text: '3/10 of 600', lines: ['3 × 60 = 180'] }] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't STOP at the 12 from the sample. 12 is out of the 40 you asked. Scale it up to 600, and you get 180. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't STOP at the 12 from the sample.", pic: 0 },
          { say: "12 is out of the 40 you asked. Scale it up to 600, and you get 180." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "To compare two groups, find the gap between their means, then check it against the spread.",
    screens: [
      ...
      { title: "One plant does not tell you", text: "Careful. Class A has a plant that is only 5 inches. Class B has one that is 7. So is Class B taller? No. Pick two other plants, and A wins. We need one number for a whole class.",
        beats: [
          { say: "Careful. Class A has a plant that is only 5 inches.", pic: 0 },
          { say: "Class B has one that is 7.", pic: 1 },
          { say: "So is Class B taller? No. Pick two other plants, and A wins." },
          { say: "We need one number for a whole class." },
        ],
        pictures: [CLASS_A, CLASS_B] },
      { title: "The big idea", text: "To compare two groups, find the gap between their means, then check it against the spread.",
        beats: [
          { say: "To compare two groups, find the gap between their means, then check it against the spread.", pic: 0 },
        ],
        pictures: [CLASS_A, CLASS_B] },
      { title: "Find each mean", text: "Add up Class A. 5 + 6 + 6 + 7 + 7 + 7 + 8 + 8 + 9 = 63. Class B adds up to 45. Each class has 9 plants, so divide each total by 9. 63 ÷ 9 = 7, and 45 ÷ 9 = 5.",
        beats: [
          { say: "Add up Class A. 5 + 6 + 6 + 7 + 7 + 7 + 8 + 8 + 9 = 63.", pic: 0 },
          { say: "Class B adds up to 45.", pic: 1 },
          { say: "Each class has 9 plants, so divide each total by 9." },
          { say: "63 ÷ 9 = 7, and 45 ÷ 9 = 5.", pic: 2 },
        ],
        pictures: [{ ...CLASS_A, motion: true }, { ...CLASS_B, motion: true }, { kind: 'eq', text: '63 ÷ 9 = 7', lines: ['45 ÷ 9 = 5'] }] },
      { title: "Find the gap", text: "So Class A's plants are 7 inches on average. Class B's are 5. How far apart is that? 7 − 5 = 2. On average, Class A's plants are 2 inches taller.",
        beats: [
          { say: "So Class A's plants are 7 inches on average. Class B's are 5.", pic: 0 },
          { say: "How far apart is that? 7 − 5 = 2.", pic: 2 },
          { say: "On average, Class A's plants are 2 inches taller." },
        ],
        pictures: [CLASS_A, CLASS_B, { kind: 'eq', text: '7 − 5 = 2' }] },
      { title: "Is the gap big?", text: "Is a gap of 2 a lot? That depends on the spread. Class A runs from 5 to 9. Class B runs from 3 to 7. That's a spread of 4 in each class. The gap is only half of that, so the plots overlap a lot. Class A is a bit taller, not a lot.",
        beats: [
          { say: "Is a gap of 2 a lot? That depends on the spread.", pic: 0 },
          { say: "Class A runs from 5 to 9. Class B runs from 3 to 7.", pic: 1 },
          { say: "That's a spread of 4 in each class.", pic: 2 },
          { say: "The gap is only half of that, so the plots overlap a lot." },
          { say: "Class A is a bit taller, not a lot." },
        ],
        pictures: [CLASS_A, CLASS_B, { kind: 'eq', text: '9 − 5 = 4', lines: ['7 − 3 = 4'] }] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't compare just the TALLEST plants. 9 beats 7, but one plant is not the class. Find the means first, then check the spread. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't compare just the TALLEST plants.", pic: 0 },
          { say: "9 beats 7, but one plant is not the class." },
          { say: "Find the means first, then check the spread." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'A probability is the ways it can happen over all the equal ways. It is a fraction or a decimal from 0 to 1.',
    screens: [
      { title: 'Spin to win', text: 'This spinner has 10 equal parts. You win if it lands on blue. What is your chance, as a fraction and as a decimal?',
        pictures: [WIN] },
      { title: 'Four colors does not mean 1/4', text: 'Careful here. There are four colors, but the colors are not the same size. Blue covers way more parts than yellow does. So count parts, not colors.',
        beats: [
          { say: 'Careful here. There are four colors, but the colors are not the same size.', pic: 0 },
          { say: 'Blue covers way more parts than yellow does.' },
          { say: 'So count parts, not colors.', write: 'count parts, not colors' },
        ],
        pictures: [WIN] },
      { title: 'The big idea', text: 'A probability is the ways it can happen over all the equal ways. It is a fraction or a decimal from 0 to 1.',
        beats: [
          { say: 'A probability is the ways it can happen over all the equal ways.', pic: 0 },
          { say: 'It is a fraction or a decimal from 0 to 1.' },
        ],
        pictures: [WIN] },
      { title: 'Count the ways', text: 'Here is the spinner again. Count the blue parts: 4. Here is every color counted up. Add them and you get all 10 parts. So the chance of blue is 4 out of 10.',
        beats: [
          { say: 'Here is the spinner again. Count the blue parts: 4.', pic: 0 },
          { say: 'Here is every color counted up. Add them and you get all 10 parts.', pic: 1 },
          { say: 'So the chance of blue is 4 out of 10.', pic: 2 },
        ],
        pictures: [WIN, WIN_COUNTS(true), { kind: 'eq', text: '4/10' }] },
      { title: 'Write it as a decimal', text: '4/10 is four tenths. Tenths are easy to write as a decimal: that is 0.4. A fraction and a decimal, saying exactly the same chance.',
        beats: [
          { say: '4/10 is four tenths.', pic: 0 },
          { say: 'Tenths are easy to write as a decimal: that is 0.4.', pic: 1 },
          { say: 'A fraction and a decimal, saying exactly the same chance.', write: 'a chance can be a fraction or a decimal' },
        ],
        pictures: [WIN, { kind: 'eq', text: '4/10 = 2/5', lines: ['= 0.4'] }] },
      { title: 'And not blue?', text: 'What about not blue? The other 6 parts are not blue, and 6/10 is 0.6. So blue is 0.4 and not blue is 0.6. Put them together and you get 1, because the spinner always lands somewhere.',
        beats: [
          { say: 'What about not blue? The other 6 parts are not blue, and 6/10 is 0.6.', pic: 0 },
          { say: 'So blue is 0.4 and not blue is 0.6.', pic: 1 },
          { say: 'Put them together and you get 1, because the spinner always lands somewhere.', pic: 2 },
        ],
        pictures: [WIN, { kind: 'table', head: ['blue', 'not blue'], rows: [['0.4', '0.6']], motion: true }, { kind: 'eq', text: '0.4 + 0.6 = 1' }] },
      { title: 'One thing not to do', text: "Here is the one that catches people. Don't put the blue parts over the parts that are not blue. Blue goes over ALL the parts.",
        beats: [
          { say: 'Here is the one that catches people.' },
          { say: "Don't put the blue parts over the parts that are not blue.", pic: 0 },
          { say: 'Blue goes over ALL the parts.' },
        ],
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Expected count = probability × number of tries. Real results land near it, but not always right on it.',
    screens: [
      ...
      { title: 'Guessing is not enough', text: 'One kid in that class guessed 40 heads. Another guessed 10. A guess can be anything at all. What we want is a number that comes from the coin itself.',
        beats: [
          { say: 'One kid in that class guessed 40 heads. Another guessed 10.', pic: 0 },
          { say: 'A guess can be anything at all.' },
          { say: 'What we want is a number that comes from the coin itself.', write: 'use the chance, not a guess' },
        ],
        pictures: [flips(27, 23, 5)] },
      { title: 'The big idea', text: 'Expected count = probability × number of tries. Real results land near it, but not always right on it.',
        beats: [
          { say: 'Expected count = probability × number of tries.', pic: 0 },
          { say: 'Real results land near it, but not always right on it.' },
        ],
        pictures: [flips(27, 23, 5)] },
      { title: 'Find the expected count', text: 'On each flip, heads has a chance of 1/2. Now multiply that by the number of tries: 1/2 × 50 = 25. So we expect 25 heads.',
        beats: [
          { say: 'On each flip, heads has a chance of 1/2.', write: 'chance × tries = what to expect' },
          { say: 'Now multiply that by the number of tries: 1/2 × 50 = 25.', pic: 1 },
          { say: 'So we expect 25 heads.', pic: 0 },
        ],
        pictures: [flips(25, 25, 5, true), { kind: 'eq', text: '1/2 × 50 = 25' }] },
      { title: 'The real results', text: 'Here is what the class really got: 27 heads and 23 tails. That is close to 25, but it is not exactly 25. Every flip starts fresh, so real results wander a little.',
        beats: [
          { say: 'Here is what the class really got: 27 heads and 23 tails.', pic: 0 },
          { say: 'That is close to 25, but it is not exactly 25.', pic: 1 },
          { say: 'Every flip starts fresh, so real results wander a little.', write: 'close to expected, not equal to it' },
        ],
        pictures: [flips(27, 23, 5, true), { kind: 'eq', text: 'expected 25', lines: ['real 27'] }] },
      { title: 'More flips, closer', text: 'Another class flipped 500 times and got 246 heads. Look at the fractions. 27 out of 50 is 0.54, and 246 out of 500 is 0.492, which sits much closer to 0.5. The more tries you take, the closer the fraction gets.',
        beats: [
          { say: 'Another class flipped 500 times and got 246 heads.', pic: 0 },
          { say: 'Look at the fractions. 27 out of 50 is 0.54, and 246 out of 500 is 0.492, which sits much closer to 0.5.', pic: 1 },
          { say: 'The more tries you take, the closer the fraction gets.', write: 'more tries → closer to the chance' },
        ],
        pictures: [flips(246, 254, 50), { kind: 'eq', text: '27/50 = 0.54', lines: ['246/500 = 0.492'] }] },
      { title: 'One thing not to do', text: "Here is the one that catches people. Don't think the real count has to equal the expected count. 27 heads out of 50 is not a mistake, and the coin is not broken.",
        beats: [
          { say: 'Here is the one that catches people.' },
          { say: "Don't think the real count has to equal the expected count.", pic: 0 },
          { say: '27 heads out of 50 is not a mistake, and the coin is not broken.' },
        ],
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'To find the chance of two things together, list every pair in a table. Count the pairs you want over all the pairs.',
    screens: [
      { title: 'Flip and roll', text: 'You flip a coin and roll a number cube. What is the chance of getting heads AND a 5?',
        pictures: [COIN_DIE] },
      { title: 'Adding the chances does not work', text: 'You might think we just add. Heads is 1/2 and a 5 is 1/6. Add those and you get 1/2 + 1/6 = 4/6. But that is bigger than either one on its own. Getting both at once should be harder than getting one, not easier.',
        beats: [
          { say: 'You might think we just add. Heads is 1/2 and a 5 is 1/6.' },
          { say: 'Add those and you get 1/2 + 1/6 = 4/6. But that is bigger than either one on its own.', pic: 1 },
          { say: 'Getting both at once should be harder than getting one, not easier.', write: 'both at once → a smaller chance' },
        ],
        pictures: [COIN_DIE, { kind: 'eq', text: '1/2 + 1/6 = 4/6' }] },
      { title: 'The big idea', text: 'To find the chance of two things together, list every pair in a table. Count the pairs you want over all the pairs.',
        beats: [
          { say: 'To find the chance of two things together, list every pair in a table.', pic: 0 },
          { say: 'Count the pairs you want over all the pairs.' },
        ],
        pictures: [COIN_DIE] },
      { title: 'Fill in every pair', text: "Let's build the table. Each row is the coin, heads or tails. Each column is the cube, 1 through 6. Every box is one way the two can land together: H1, H2, all the way to T6.",
        beats: [
          { say: "Let's build the table. Each row is the coin, heads or tails.", pic: 0 },
          { say: 'Each column is the cube, 1 through 6.' },
          { say: 'Every box is one way the two can land together: H1, H2, all the way to T6.' },
        ],
        pictures: [COIN_DIE_FULL(undefined, true)] },
      { title: 'Count all the pairs', text: 'Now count the boxes. 2 rows × 6 columns = 12. So there are 12 pairs, and every one of them is equally likely.',
        beats: [
          { say: 'Now count the boxes.', pic: 0 },
          { say: '2 rows × 6 columns = 12.', pic: 1 },
          { say: 'So there are 12 pairs, and every one of them is equally likely.', write: 'rows × columns = all the pairs' },
        ],
        pictures: [COIN_DIE_FULL(), { kind: 'eq', text: '2 × 6 = 12' }] },
      { title: 'Find the pair you want', text: 'Now find the one we wanted: heads and a 5. That is a single box, H5. One box out of 12, so the chance is 1/12.',
        beats: [
          { say: 'Now find the one we wanted: heads and a 5.', pic: 0 },
          { say: 'That is a single box, H5.' },
          { say: 'One box out of 12, so the chance is 1/12.', pic: 1 },
        ],
        pictures: [COIN_DIE_FULL([[0, 5]], true), { kind: 'eq', text: '1/12' }] },
      { title: 'One thing not to do', text: "Here is the one that catches people. Don't add the two chances together. Make the table, then count the pairs.",
        beats: [
          { say: 'Here is the one that catches people.' },
          { say: "Don't add the two chances together.", pic: 0 },
          { say: 'Make the table, then count the pairs.' },
        ],
