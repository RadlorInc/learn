  ...
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Asking the basketball team', text: "The 20 kids on the basketball team are easy to find. So let's ask them. But look at what they said. Almost all of them say basketball. That does not look like the whole school at all.",
        beats: [
          { say: "The 20 kids on the basketball team are easy to find. So let's ask them.", pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'A fair sample gives everyone in the group the same chance to be picked. Asking only one kind of person is not fair.',
        beats: [
          { say: 'A fair sample gives everyone in the group the same chance to be picked.', pic: 0, effect: 'draw' },
      ...
      { title: 'Pick names from a hat', text: 'Here is a better way. Put all 400 names in a hat and pull out 20 without looking. Now every single student has the same chance to be picked. Nobody is left out.',
        beats: [
          { say: 'Here is a better way. Put all 400 names in a hat and pull out 20 without looking.', pic: 0, effect: 'draw' },
      ...
      { title: 'It looks like the school', text: 'So how did the hat do? 7 of the 20 names picked soccer. That is 35 out of every 100. In the whole school, 140 of the 400 picked soccer, and that is 35 out of every 100 too. The small group came out looking like a little copy of the big one.',
        beats: [
          { say: 'So how did the hat do? 7 of the 20 names picked soccer.', pic: 0, effect: 'draw' },
      ...
      { title: 'Ask who is left out', text: 'Here is the question to ask yourself every time. Could anyone in the school never be picked? Ask the team, and every kid who is not on the team is left out. Draw from the hat, and nobody is left out.',
        beats: [
          ...
          { say: 'Ask the team, and every kid who is not on the team is left out.', pic: 0, effect: 'draw' },
          { say: 'Draw from the hat, and nobody is left out.', pic: 1, effect: 'draw' },
        ],
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'It is not just 12', text: 'Careful here. 12 is only the kids you asked. The school has 600 students, and you talked to 40 of them. So there are a lot more pizza fans out there that you never asked.',
        beats: [
          { say: 'Careful here. 12 is only the kids you asked.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'A fair sample is a small copy of the whole group. Find its fraction, then take that fraction of the whole group.',
        beats: [
          { say: 'A fair sample is a small copy of the whole group.', pic: 0, effect: 'draw' },
      ...
      { title: 'Find the fraction', text: 'Start with the kids you asked. 12 out of 40 like pizza. 12/40 is the same as 3/10. So about 3 out of every 10 kids pick pizza.',
        beats: [
          ...
          { say: 'So about 3 out of every 10 kids pick pizza.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'Stretch it to 600', text: 'Now the whole school. It is the same tape, just bigger. Split the 600 students into those same 10 equal parts. 600 ÷ 10 = 60, so each part is 60 kids.',
        beats: [
          { say: 'Now the whole school. It is the same tape, just bigger.', pic: 0, effect: 'draw' },
      ...
      { title: 'Count the pizza parts', text: '3 of those 10 parts are the pizza parts. So count them up: 3 × 60 = 180. Predict that about 180 of the 600 students pick pizza.',
        beats: [
          { say: '3 of those 10 parts are the pizza parts.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'One plant does not tell you', text: 'Careful here. Class A has a plant that is only 5 inches. And Class B has one that is 7. Pick single plants and you can make either class look like the winner. We need one number that stands for a whole class.',
        beats: [
          { say: 'Careful here. Class A has a plant that is only 5 inches.', pic: 0, effect: 'draw' },
          { say: 'And Class B has one that is 7.', pic: 1, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'To compare two groups, find the gap between their means. Then look at the spread to see if that gap is big or small.',
        beats: [
          { say: 'To compare two groups, find the gap between their means.', pic: 0, effect: 'draw' },
          { say: 'Then look at the spread to see if that gap is big or small.', pic: 1, effect: 'draw' },
        ],
        pictures: [CLASS_A, CLASS_B] },
      { title: 'Find each mean', text: "Let's find one number for each class. Add up Class A: 5 + 6 + 6 + 7 + 7 + 7 + 8 + 8 + 9 = 63. Class B adds up to 45. Now divide each one by its 9 plants. 63 ÷ 9 = 7 and 45 ÷ 9 = 5.",
        beats: [
          { say: "Let's find one number for each class. Add up Class A: 5 + 6 + 6 + 7 + 7 + 7 + 8 + 8 + 9 = 63.", pic: 0, effect: 'draw' },
          { say: 'Class B adds up to 45.', pic: 1, effect: 'draw' },
      ...
      { title: 'Find the gap', text: 'So Class A sits at 7. Class B sits at 5. Take one from the other: 7 − 5 = 2. On average, Class A grew plants 2 inches taller.',
        beats: [
          { say: 'So Class A sits at 7.', pic: 0, effect: 'draw' },
          { say: 'Class B sits at 5.', pic: 1, effect: 'draw' },
      ...
      { title: 'Is the gap big?', text: 'A gap of 2. Is that a lot? It depends on how spread out each class is. Class A runs from 5 up to 9, and Class B runs from 3 up to 7. That is a spread of 4 inches each. The gap of 2 is only half of that, so the two plots overlap a lot. Class A is a bit taller, not a lot.',
        beats: [
          { say: 'A gap of 2. Is that a lot? It depends on how spread out each class is.', pic: 0, effect: 'draw' },
          { say: 'Class A runs from 5 up to 9, and Class B runs from 3 up to 7.', pic: 1, effect: 'draw' },
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Four colors does not mean 1/4', text: 'Careful here. There are four colors, but the colors are not the same size. Blue covers way more parts than yellow does. So count parts, not colors.',
        beats: [
          { say: 'Careful here. There are four colors, but the colors are not the same size.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'A probability is the ways it can happen over all the equal ways. It is a fraction or a decimal from 0 to 1.',
        beats: [
          { say: 'A probability is the ways it can happen over all the equal ways.', pic: 0, effect: 'draw' },
      ...
      { title: 'Count the ways', text: 'Here is the spinner again. Count the blue parts: 4. Here is every color counted up. Add them and you get all 10 parts. So the chance of blue is 4 out of 10.',
        beats: [
          { say: 'Here is the spinner again. Count the blue parts: 4.', pic: 0, effect: 'draw' },
      ...
      { title: 'Write it as a decimal', text: '4/10 is four tenths. Tenths are easy to write as a decimal: that is 0.4. A fraction and a decimal, saying exactly the same chance.',
        beats: [
          { say: '4/10 is four tenths.', pic: 0, effect: 'draw' },
      ...
      { title: 'And not blue?', text: 'What about not blue? The other 6 parts are not blue, and 6/10 is 0.6. So blue is 0.4 and not blue is 0.6. Put them together and you get 1, because the spinner always lands somewhere.',
        beats: [
          { say: 'What about not blue? The other 6 parts are not blue, and 6/10 is 0.6.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Guessing is not enough', text: 'One kid in that class guessed 40 heads. Another guessed 10. A guess can be anything at all. What we want is a number that comes from the coin itself.',
        beats: [
          { say: 'One kid in that class guessed 40 heads. Another guessed 10.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Expected count = probability × number of tries. Real results land near it, but not always right on it.',
        beats: [
          { say: 'Expected count = probability × number of tries.', pic: 0, effect: 'draw' },
      ...
      { title: 'Find the expected count', text: 'On each flip, heads has a chance of 1/2. Now multiply that by the number of tries: 1/2 × 50 = 25. So we expect 25 heads.',
        beats: [
          ...
          { say: 'So we expect 25 heads.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'The real results', text: 'Here is what the class really got: 27 heads and 23 tails. That is close to 25, but it is not exactly 25. Every flip starts fresh, so real results wander a little.',
        beats: [
          { say: 'Here is what the class really got: 27 heads and 23 tails.', pic: 0, effect: 'draw' },
      ...
      { title: 'More flips, closer', text: 'Another class flipped 500 times and got 246 heads. Look at the fractions. 27 out of 50 is 0.54, and 246 out of 500 is 0.492, which sits much closer to 0.5. The more tries you take, the closer the fraction gets.',
        beats: [
          { say: 'Another class flipped 500 times and got 246 heads.', pic: 0, effect: 'draw' },
