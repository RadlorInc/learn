...
export const G7M4: Lesson[] = [
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The map is shrunk', text: 'The real park is not 6 cm long. A park cannot fit on paper, so every length was shrunk by the same amount.',
        pictures: [plan(6, 4, '6 cm', '4 cm')] },
      { title: 'The big idea', text: 'Each 1 cm on the drawing stands for the same real length. Multiply by it to get the real length, and divide to go back.',
        pictures: [plan(6, 4, '6 cm', '4 cm')] },
      { title: 'Read the rule', text: '1 cm = 50 m means every centimeter on the map is 50 meters on the ground. 2 cm is 100 m, 3 cm is 150 m.',
        pictures: [{ kind: 'table', head: ['map (cm)', '1', '2', '3'], rows: [['real (m)', '50', '100', '150']], rowHead: true, motion: true }] },
      { title: 'Count the centimeters', text: 'The park is 6 cm long on the map. That is 6 pieces of 50 m. 6 × 50 = 300, so the real park is 300 m long.',
        pictures: [plan(6, 4, '6 cm', '4 cm', true), { kind: 'eq', text: '6 × 50 = 300', lines: ['300 meters'] }] },
      { title: 'Go back the other way', text: 'Now start from real life. A real path is 200 m long. How many 50s make 200? 200 ÷ 50 = 4, so it is 4 cm on the map.',
        pictures: [plan(6, 4, '6 cm', '? cm'), { kind: 'eq', text: '200 ÷ 50 = 4', lines: ['4 cm on the map'] }] },
      { title: 'One thing not to do', text: "Don't add the rule to the length. Every centimeter gets its own 50 m, so multiply.",
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Across is not around', text: 'The line straight across, through the center, is the diameter. Half of it, center to edge, is the radius. Neither one is the distance around.',
        pictures: [circle(5, '10 cm', 'd')] },
      { title: 'The big idea', text: 'The distance around a circle is always about 3.14 times the distance across it.',
        pictures: [circle(5, '10 cm', 'd')] },
      { title: 'Roll it out', text: 'Mark a spot on the wheel and roll it one full turn. The track it leaves is the distance around.',
      ...
      { title: 'A little more than 3', text: 'Lay the 10 cm width along the track. It fits 3 times, with a small piece left over. For every circle, it is about 3.14 times.',
      ...
      { title: 'Multiply', text: '10 × 3.14 = 31.4. The wheel rolls 31.4 cm in one turn.',
        pictures: [circle(5, '10 cm', 'd'), { kind: 'eq', text: '10 × 3.14 = 31.4', lines: ['31.4 cm around'] }] },
      { title: 'One thing not to do', text: "Don't multiply the radius by 3.14. It is only half the way across, so double it first.",
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Squares do not fit', text: 'Square tiles leave curved gaps all around the edge. Counting them will not give an exact answer.',
        pictures: [circle(10, '10 m', 'r')] },
      { title: 'The big idea', text: 'The area of a circle is 3.14 × radius × radius. Use the radius, not the diameter.',
        pictures: [circle(10, '10 m', 'r')] },
      { title: 'Cut it into slices', text: 'Cut the circle into thin slices, like a pizza. Lay them side by side, one point up, the next point down.',
        pictures: [slices(false, true)] },
      { title: 'Almost a rectangle', text: 'The long side is half the distance around: 3.14 × 10 = 31.4 m. The short side is the radius: 10 m.',
        pictures: [slices(true)] },
      { title: 'Multiply', text: '31.4 × 10 = 314. That is the same as 3.14 × 10 × 10. The pond covers 314 square meters.',
        pictures: [slices(true), { kind: 'eq', text: '3.14 × 10 × 10 = 314', lines: ['314 square meters'] }] },
      { title: 'One thing not to do', text: "Don't use the distance across. The pond is 20 m across, but the rule needs the radius, 10 m.",
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'What is the whole?', text: 'To find a missing part, you need the whole. A square corner and a straight line are two different wholes.',
      ...
      { title: 'The parts fill the corner', text: 'The two angles fill the square corner with no gap. So together they make 90°.',
        pictures: [corner([55, 35], [null, '35°'], true)] },
      { title: 'Take away the part you know', text: '90 − 35 = 55. The other angle is 55°.',
        pictures: [corner([55, 35], ['?', '35°']), { kind: 'eq', text: '90° − 35° = 55°' }] },
      { title: 'A straight line starts at 180', text: 'If the two angles make a straight line instead, start from 180. 180 − 35 = 145.',
        pictures: [corner([145, 35], ['?', '35°']), { kind: 'eq', text: '180° − 35° = 145°' }] },
      { title: 'One thing not to do', text: "Don't start from 180 when the angles make a square corner. Look at the whole first.",
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Four angles at one crossing', text: 'A crossing makes four angles. You could measure each one. But the lines are straight, and that already tells you a lot.',
      ...
      { title: 'Next door makes a straight line', text: 'The 50° angle and the top angle sit side by side on a straight line. So the top angle is 180 − 50 = 130°.',
        pictures: [cross(50, { r: '50°', t: '130°' }, true)] },
      { title: 'Across comes out the same', text: 'The left angle also sits on a straight line with the top angle. So it is 180 − 130 = 50°, the same as the angle across from it.',
        pictures: [cross(50, { r: '50°', t: '130°', l: '50°' }), { kind: 'eq', text: '180° − 130° = 50°' }] },
      { title: 'Copy it across', text: 'So the angles straight across always match. Left and right are both 50°. Top and bottom are both 130°.',
        pictures: [cross(50, { r: '50°', l: '50°', t: '130°', b: '130°' })] },
      { title: 'One thing not to do', text: "Don't take it away from 180. That finds the angle next door, not the one straight across.",
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Some sets do not close', text: 'It looks like any three sticks should work. But lay the long one down and try to join the other two above it. They do not meet.',
      ...
      { title: 'Lay them flat', text: 'Swing the 3 cm and 4 cm sticks down flat onto the 9 cm stick. Together they reach only 7 cm, so they cannot meet.',
        pictures: [{ kind: 'poly', motion: true, shapes: [], segs: [
          { a: [0, 0], b: [9, 0], dots: true, label: '9 cm' },
      ...
      { title: 'When it works', text: 'Try 3 cm, 4 cm and 5 cm. 3 + 4 = 7, and 7 is more than 5. The two short sticks reach past each other and lift up into a point.',
      ...
      { title: 'Just enough is not enough', text: 'Try 3 cm, 4 cm and 7 cm. 3 + 4 = 7 exactly. The sticks only meet lying flat, so there is no triangle.',
        pictures: [{ kind: 'poly', shapes: [], segs: [
      ...
      { title: 'One thing not to do', text: "Don't add the longest side to a short one. Always add the two shorter sides, then compare with the longest.",
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Not the space inside', text: 'Paint only covers the outside. Finding the space inside will not help. You need the flat faces.',
        pictures: [wedge(4, 3, 10, 'cm', 0, '5 cm')] },
      ...
      { title: 'Unfold it', text: 'Cut along some edges and lay the wedge flat. There are 2 triangle ends and 3 rectangle sides.',
        pictures: [triNet(3, 4, 5, 10, 'cm', 'names', true)] },
      { title: 'Area of each face', text: 'Each triangle end: 1/2 × 4 × 3 = 6. The sides: 3 × 10 = 30, 4 × 10 = 40 and 5 × 10 = 50.',
        pictures: [triNet(3, 4, 5, 10, 'cm', 'areas')] },
      { title: 'Add every face', text: '6 + 6 + 30 + 40 + 50 = 132. The paint covers 132 square centimeters.',
        pictures: [triNet(3, 4, 5, 10, 'cm', 'areas'), { kind: 'eq', text: '6 + 6 + 30 + 40 + 50 = 132', lines: ['132 square centimeters'] }] },
      { title: 'One thing not to do', text: "Don't count only one end. The wedge has a triangle at both ends.",
  ...
  // ── Topic 8 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Too many to count', text: 'You could stack cubes and count them one by one. But most of the cubes would be hidden inside.',
        pictures: [box('5 cm', '3 cm', '4 cm')] },
      { title: 'The big idea', text: 'Find the area of the base. Then multiply it by the height: volume = base area × height.',
        pictures: [box('5 cm', '3 cm', '4 cm')] },
      { title: 'The bottom layer', text: 'The base is 5 cm by 3 cm. Its area is 5 × 3 = 15, so 15 cubes cover the bottom.',
        pictures: [box('5 cm', '3 cm', '4 cm'), { kind: 'eq', text: '5 × 3 = 15', lines: ['15 cubes in one layer'] }] },
      { title: 'Stack the layers', text: 'The box is 4 cm tall, so there are 4 layers of 15. 15 × 4 = 60 cubic centimeters.',
        pictures: [box('5 cm', '3 cm', '4 cm'),
          { kind: 'table', head: ['layers', '1', '2', '3', '4'], rows: [['cubes', '15', '30', '45', '60']], rowHead: true, motion: true }] },
      { title: 'A triangle base works too', text: 'A wedge has a triangle for its base. Find the triangle’s area first, then multiply by how far the wedge goes, the same way.',
        pictures: [{ kind: 'eq', text: 'base area × height', lines: ['triangle base: 1/2 × 4 × 3 = 6', '6 × 10 = 60 cubic centimeters'] }] },
      { title: 'One thing not to do', text: "Don't multiply all three edges of a wedge. Its triangle base is only half a rectangle, so find the base area first.",
