  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t5', title: 'A fun run', text: 'The fun run in the park is 5 kilometers (km) long. The signs along the path count in meters (m). How many meters long is the run?',
        pictures: [RUN_A] },
      { title: 'A meter is much shorter', text: 'A kilometer is a long way. A meter is about one big step. So the run is only 5 kilometers, but it is a lot of meters.',
      ...
      { title: 'One kilometer is 1,000 meters', text: 'The kilometer is the bigger unit. 1 km is the same length as 1,000 m. So each km of the run is 1,000 m.',
        pictures: [twoWaysA(5, ['km', '1'], ['m', '1,000'], undefined, true)] },
      { title: 'Smaller unit: multiply', text: 'Meters are smaller, so there are more of them. Multiply: 5 × 1,000 = 5,000, the same sliding you already know. The run is 5,000 m long.',
        pictures: [twoWaysA(5, ['km', '1'], ['m', '1,000'], '5,000 m'), eqA('5 × 1,000 = 5,000')] },
      { title: 'Bigger unit: divide', text: 'A runner has gone 3,000 m so far. Kilometers are bigger, so there are fewer of them. Divide: 3,000 ÷ 1,000 = 3. The runner has gone 3 km.',
        pictures: [twoWaysA(3, ['m', '1,000'], ['km', '1'], '3 km', true), eqA('3,000 ÷ 1,000 = 3')] },
      { title: 'One thing not to do', text: "Don't multiply when you change to the bigger unit. A kilogram (kg) is 1,000 grams (g), so 6,000 g is only 6 kg.",
