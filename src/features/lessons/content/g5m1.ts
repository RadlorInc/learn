...
import { line, write, box, wash, cells, arrow, span, hop, cross, ring, person, clock, ticks, attachChalk } from '../chalk'
...
const IDEA12C = 'Think in tens. 240 is 24 tens and 60 is 6 tens, so 240 ÷ 60 is the same as 24 ÷ 6.'
const IDEA13C = 'Round the number you divide by to the nearest ten and make a guess. Multiply to check: if a whole group still fits in what is left, the guess was too small.'
const IDEA14C = 'If the number you divide by does not fit into the first two digits, the answer has one digit. Guess with round numbers, and if the guess is too big, try one less.'
const IDEA15C = 'Divide the tens first, then bring down the ones and divide again.'
const IDEA16C = 'Start where the number you divide by first fits, then bring down one digit at a time.'
...
export const G5M1: Lesson[] = [
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'The small number up top says how many 10s to multiply. That is how many zeros, and how many places the digits slide.',
    screens: [
      ...
      { title: 'Zeros are hard to count', text: 'Six zeros in a row are hard to count at a glance. Try it. And if you write one zero too many, the number is 10 times too big.',
        beats: [
          { say: 'Six zeros in a row are hard to count at a glance. Try it.', pic: 0 },
          { say: 'And if you write one zero too many, the number is 10 times too big.' },
        ],
        pictures: [eqA('1,000,000', ['or 10,000,000?'])] },
      { title: 'The big idea', text: 'The small number up top says how many 10s to multiply. That is how many zeros, and how many places the digits slide.',
        beats: [
          { say: 'The small number up top says how many 10s to multiply.', pic: 0 },
          { say: 'That is how many zeros, and how many places the digits slide.' },
        ],
        pictures: [eqA('10³ = 10 × 10 × 10 = 1,000')] },
      { title: 'Count the 10s', text: 'Let us count them together. 10 × 10 is two 10s, so we write 10². And 10 × 10 × 10 is three 10s, so we write 10³. Watch the last column. Each 10 you multiply adds one zero.',
        beats: [
          { say: 'Let us count them together. 10 × 10 is two 10s, so we write 10².', pic: 0 },
          { say: 'And 10 × 10 × 10 is three 10s, so we write 10³.' },
          { say: 'Watch the last column. Each 10 you multiply adds one zero.', write: 'each 10 → one more zero' },
        ],
        pictures: [{ kind: 'table', head: ['Short way', 'Long way', 'Number'], rows: [['10¹', '10', '10'], ['10²', '10 × 10', '100'], ['10³', '10 × 10 × 10', '1,000']], motion: true }] },
      { title: 'The city the short way', text: 'Back to our city. 1,000,000 is a 1 with 6 zeros. Count them with me. Six zeros means six 10s multiplied, so the city has 10⁶ people.',
        beats: [
          { say: 'Back to our city. 1,000,000 is a 1 with 6 zeros. Count them with me.', pic: 0 },
          { say: 'Six zeros means six 10s multiplied, so the city has 10⁶ people.' },
        ],
      ...
      { title: 'It says how far to slide', text: 'Here is the part I really like. That small number also tells you how many places the digits slide. So 45 × 10³ slides them 3 places left, and 62,000 ÷ 10³ slides them 3 places right.',
        beats: [
          { say: 'Here is the part I really like.' },
          { say: 'That small number also tells you how many places the digits slide.' },
          { say: 'So 45 × 10³ slides them 3 places left, and 62,000 ÷ 10³ slides them 3 places right.', pic: 0 },
        ],
        pictures: [eqA('45 × 10³ = 45,000', ['62,000 ÷ 10³ = 62'])] },
      { title: 'One thing not to do', text: 'Careful with this one. Do not multiply 10 by the small number. 10³ is not 10 × 3. It means three 10s multiplied together.',
        beats: [
          { say: 'Careful with this one.' },
          { say: 'Do not multiply 10 by the small number. 10³ is not 10 × 3.', pic: 0 },
          { say: 'It means three 10s multiplied together.' },
        ],
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t4', title: 'Eggs on a farm', text: 'A farm packs 412 eggs a day for 28 days. About how many eggs is that?',
        pictures: [eqA('28 × 412')] },
      { title: 'The exact way takes time', text: 'Working out 28 × 412 exactly takes a lot of steps. But sometimes you do not need exact. You only need to know about how many. Is it near 1,000? Near 10,000? Near 100,000?',
        beats: [
          { say: 'Working out 28 × 412 exactly takes a lot of steps.', pic: 0 },
          { say: 'But sometimes you do not need exact. You only need to know about how many.' },
          { say: 'Is it near 1,000? Near 10,000? Near 100,000?' },
        ],
        pictures: [eqA('28 × 412')] },
      { title: 'The big idea', text: 'Swap each number for a close round number. Use a fact you know, then write the zeros.',
        beats: [
          { say: 'Swap each number for a close round number.', pic: 0 },
          { say: 'Use a fact you know, then write the zeros.' },
        ],
        pictures: [eqA('28 × 412', ['30 × 400'])] },
      { title: 'Round each number', text: 'Round each number at its biggest place. 28 is only 2 away from 30. Look how close that is. And 412 is only 12 away from 400. So 28 × 412 is close to 30 × 400.',
        beats: [
          { say: 'Round each number at its biggest place.', write: 'round at the biggest place' },
          { say: '28 is only 2 away from 30. Look how close that is.', pic: 0 },
      ...
      { title: 'Use a fact, then the zeros', text: 'Now use a fact you already know. 3 × 4 = 12. Then count the zeros. 30 has one and 400 has two, so three zeros go after the 12. 12,000. The farm packs about 12,000 eggs.',
        beats: [
          { say: 'Now use a fact you already know. 3 × 4 = 12.' },
          { say: 'Then count the zeros. 30 has one and 400 has two, so three zeros go after the 12.', write: 'keep every zero' },
          { say: '12,000. The farm packs about 12,000 eggs.', pic: 0 },
        ],
        pictures: [eqA('3 × 4 = 12', ['30 × 400 = 12,000', 'about 12,000 eggs'])] },
      { title: 'Dividing works the same way', text: 'Dividing works the very same way. 2,380 eggs go into crates of 58. Round 58 to the nearest ten, 60, and round 2,380 to the nearest hundred, 2,400. 24 ÷ 6 = 4, and 60 × 40 = 2,400. So it is about 40 crates.',
        beats: [
          { say: 'Dividing works the very same way. 2,380 eggs go into crates of 58.' },
          { say: 'Round 58 to the nearest ten, 60, and round 2,380 to the nearest hundred, 2,400.', pic: 0 },
          { say: '24 ÷ 6 = 4, and 60 × 40 = 2,400. So it is about 40 crates.', pic: 1 },
        ],
        pictures: [roundA(2300, 2400, 2380, 2400, '20 away'), eqA('2,380 ÷ 58', ['2,400 ÷ 60 = 40'])] },
      { title: 'One thing not to do', text: 'Last one, and it is the slip that costs the most. Do not lose the zeros. 30 has one zero and 400 has two, so the answer needs three zeros after the 12.',
        beats: [
          { say: 'Last one, and it is the slip that costs the most.' },
          { say: 'Do not lose the zeros.', pic: 0 },
          { say: '30 has one zero and 400 has two, so the answer needs three zeros after the 12.' },
        ],
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'A bigger unit is made of 10, 100 or 1,000 smaller ones. Multiply to change to the smaller unit, and divide to change to the bigger one.',
    screens: [
      { scene: 'g5m1-t5', title: 'A fun run', text: 'The fun run in the park is 5 kilometers (km) long. The signs along the path count in meters (m). How many meters long is the run?',
        pictures: [RUN_A] },
      { title: 'A meter is much shorter', text: 'A kilometer is a long way. You could walk it, but it would take you a while. A meter? That is about one big step. So the run is only 5 kilometers, but it is going to be a lot of meters.',
        beats: [
          { say: 'A kilometer is a long way. You could walk it, but it would take you a while.', pic: 0 },
          { say: 'A meter? That is about one big step.', write: '1 big step = about 1 m' },
          { say: 'So the run is only 5 kilometers, but it is going to be a lot of meters.', pic: 1 },
        ],
        chalk: [
          span([0, 'kilometer'], 60, 480, 150), write([0, 'kilometer'], '1 km', 270, 180, 32, 'y'),
          person([0, 'walk'], 95, 142, 60), arrow([0, 'walk'], [130, 105], [190, 105], 'd'),
          ...
          ticks([2, 'lot'], 290, 290, 270, 40), write([2, 'meters'], 'lots of m', 425, 325, 26, 'b'),
          write([2, 'meters'], '5 km = ? m', 425, 368, 30),
        ],
        pictures: [RUN_A, eqA('5 km = ? m')] },
      { title: 'The big idea', text: 'A bigger unit is made of 10, 100 or 1,000 smaller ones. Multiply to change to the smaller unit, and divide to change to the bigger one.',
        beats: [
          // The table is the whole idea, so it goes up with the first half and she reads the second half against it.
          { say: 'A bigger unit is made of 10, 100 or 1,000 smaller ones.', pic: 0 },
          { say: 'Multiply to change to the smaller unit, and divide to change to the bigger one.' },
        ],
        chalk: [
          box([0, 'bigger'], 150, 60, 300, 50, 'y'), wash([0, 'bigger'], 150, 60, 300, 50, 'y'), write([0, 'bigger'], 'bigger unit', 300, 85, 28, 'y'),
          line([0, 'made'], [[150, 110], [150, 170]], 'd', 2), line([0, 'made'], [[450, 110], [450, 170]], 'd', 2),
          cells([0, 'made'], 150, 170, 300, 50, 10, 'b'),
          write([0, '10'], '10', 220, 262, 30), write([0, '100'], '100', 300, 262, 30), write([0, '1,000'], '1,000', 395, 262, 30),
          write([0, 'smaller'], 'smaller ones', 300, 238 + 60, 24, 'b'),
          arrow([1, 'multiply'], [115, 90], [115, 190], 'r'), write([1, 'multiply'], '×', 88, 140, 36, 'r'),
          write([1, 'smaller'], 'to smaller → ×', 160, 355, 28, 'r'),
          arrow([1, 'divide'], [485, 190], [485, 90], 'b'), write([1, 'divide'], '÷', 512, 140, 36, 'b'),
          write([1, 'bigger'], 'to bigger → ÷', 440, 355, 28, 'b'),
        ],
      ...
      { title: 'One kilometer is 1,000 meters', text: 'The kilometer is the bigger unit here. And 1 km is exactly the same length as 1,000 m. So every single kilometer of that run is 1,000 m.',
        beats: [
          { say: 'The kilometer is the bigger unit here.', pic: 0 },
          { say: 'And 1 km is exactly the same length as 1,000 m.', write: '1 km = 1,000 m' },
          { say: 'So every single kilometer of that run is 1,000 m.' },
        ],
        chalk: [
          ...
          line([1, 'same'], [[100, 100], [100, 130]]), line([1, 'same'], [[500, 100], [500, 130]]), write([1, 'length'], 'same length!', 300, 240, 24),
          cells([2, 'every'], 60, 295, 480, 40, 5, 'y'), write([2, 'run'], 'the run', 300, 278 - 4, 22, 'd'),
          ...[108, 204, 300, 396, 492].map(x => write([2, '1,000'], '1,000 m', x, 315, 20, 'b')),
        ],
        pictures: [twoWaysA(5, ['km', '1'], ['m', '1,000'], undefined, true)] },
      { title: 'Smaller unit: multiply', text: 'Meters are smaller, so it takes more of them to cover the same distance. Smaller unit, more of them. That means we multiply. 5 × 1,000 = 5,000, the same sliding you already know. So the run is 5,000 m long.',
        beats: [
          ...
          { say: '5 × 1,000 = 5,000, the same sliding you already know. So the run is 5,000 m long.', pic: 1 },
        ],
        chalk: [
          ...
          write([2, '5'], '5', 130, 335, 36), write([2, '1,000'], '× 1,000', 215, 335, 36), write([2, '5,000'], '= 5,000', 345, 335, 36),
          hop([2, 'sliding'], 318, 340, 305, 'd'), hop([2, 'sliding'], 340, 362, 305, 'd'), hop([2, 'sliding'], 362, 384, 305, 'd'),
          box([2, 'run'], 450, 310, 120, 50, 'y'), write([2, 'run'], '5,000 m', 510, 336, 28, 'y'),
        ],
        pictures: [twoWaysA(5, ['km', '1'], ['m', '1,000'], '5,000 m'), eqA('5 × 1,000 = 5,000')] },
      { title: 'Bigger unit: divide', text: 'Now, a runner has gone 3,000 m so far. Kilometers are bigger, so there are fewer of them. Fewer of them means we go the other way, and divide. 3,000 ÷ 1,000 = 3. That runner has gone 3 km.',
        beats: [
          { say: 'Now, a runner has gone 3,000 m so far.', pic: 0 },
          { say: 'Kilometers are bigger, so there are fewer of them. Fewer of them means we go the other way, and divide.', write: 'bigger unit → divide' },
          { say: '3,000 ÷ 1,000 = 3. That runner has gone 3 km.', pic: 1 },
        ],
        chalk: [
          ...
          arrow([1, 'way'], [560, 245], [470, 245], 'r'), write([1, 'divide'], 'divide ÷', 390, 245, 30, 'r'),
      ...
      { title: 'One thing not to do', text: "Here is the one that catches people. When you change to the bigger unit, don't multiply. A kilogram (kg) is 1,000 grams (g), so 6,000 g is only 6 kg. A much smaller number.",
        beats: [
          { say: 'Here is the one that catches people.' },
          { say: "When you change to the bigger unit, don't multiply.", pic: 0 },
          { say: 'A kilogram (kg) is 1,000 grams (g), so 6,000 g is only 6 kg. A much smaller number.' },
        ],
        chalk: [
          line([0, 'catches'], [[300, 30], [345, 105], [255, 105], [300, 30]], 'r'), write([0, 'catches'], '!', 300, 80, 40, 'r'),
          ...
          ring([2, 'smaller'], 318, 320, 62, 26, 'y'), write([2, 'smaller'], 'smaller!', 480, 320, 26, 'b'),
        ],
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Two different units', text: 'Look carefully at the two numbers. The jug is measured in liters, but the cups are in milliliters. The 2 and the 250 count different units, so we cannot divide them yet.',
        beats: [
          { say: 'Look carefully at the two numbers. The jug is measured in liters, but the cups are in milliliters.', pic: 0 },
          { say: 'The 2 and the 250 count different units, so we cannot divide them yet.' },
        ],
        pictures: [eqA('2 L and 250 mL')] },
      { title: 'The big idea', text: 'Change to the same unit first. Then solve the story one step at a time.',
        beats: [
          { say: 'Change to the same unit first.', pic: 0 },
          { say: 'Then solve the story one step at a time.' },
        ],
        pictures: [twoWaysA(2, ['L', '1 L'], ['mL', '1,000 mL'])] },
      { title: 'First, the same unit', text: '1 L is 1,000 mL, so let us count that jug in milliliters. The jug holds 2 × 1,000 = 2,000 mL. Now the jug and the cups are both in milliliters.',
        beats: [
          { say: '1 L is 1,000 mL, so let us count that jug in milliliters.', pic: 0 },
          { say: 'The jug holds 2 × 1,000 = 2,000 mL.' },
      ...
      { title: 'Then, how many cups', text: 'Now the cups. 4 cups of 250 mL make 1,000 mL. The jug holds two of those thousands, so 2 × 4 = 8 cups. And that is exactly what 2,000 ÷ 250 asks.',
        beats: [
          { say: 'Now the cups. 4 cups of 250 mL make 1,000 mL.', pic: 0 },
          { say: 'The jug holds two of those thousands, so 2 × 4 = 8 cups.' },
          { say: 'And that is exactly what 2,000 ÷ 250 asks.', pic: 1 },
        ],
        pictures: [cupsA(undefined, true), eqA('2,000 ÷ 250 = 8')] },
      { title: 'Check the answer', text: 'Always check. 8 cups of 250 mL is 8 × 250 = 2,000 mL. That is 2 L, the whole jug, with nothing left over. You can fill 8 cups.',
        beats: [
          { say: 'Always check. 8 cups of 250 mL is 8 × 250 = 2,000 mL.', pic: 1 },
          { say: 'That is 2 L, the whole jug, with nothing left over.', pic: 0 },
          { say: 'You can fill 8 cups.' },
        ],
        pictures: [cupsA('2,000 mL = 2 L'), eqA('8 × 250 = 2,000')] },
      { title: 'One thing not to do', text: 'Here is the one to avoid. Do not do the math with two different units. Change 2 L into 2,000 mL first, and then divide.',
        beats: [
          { say: 'Here is the one to avoid.' },
          { say: 'Do not do the math with two different units.', pic: 0 },
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Break the big number into hundreds, tens and ones. Multiply each part, then add all the parts.',
    screens: [
      ...
      { title: 'Not in the times tables', text: '6 × 128 is not a fact you know by heart, is it? And adding 128 six times takes a long time, where one slip changes the answer.',
        beats: [
          { say: '6 × 128 is not a fact you know by heart, is it?', pic: 0 },
          { say: 'And adding 128 six times takes a long time, where one slip changes the answer.' },
        ],
        pictures: [areaB('6', ['128'])] },
      { title: 'The big idea', text: 'Break the big number into hundreds, tens and ones. Multiply each part, then add all the parts.',
        beats: [
          { say: 'Break the big number into hundreds, tens and ones.', pic: 0 },
          { say: 'Multiply each part, then add all the parts.' },
        ],
        pictures: [areaB('6', ['100', '20', '8'])] },
      { title: 'Break 128 apart', text: '128 is 1 hundred, 2 tens and 8 ones. So split each row of 128 into three parts: 100, 20 and 8.',
        beats: [
          { say: '128 is 1 hundred, 2 tens and 8 ones.', pic: 1 },
          { say: 'So split each row of 128 into three parts: 100, 20 and 8.', pic: 0 },
        ],
        pictures: [areaB('6', ['100', '20', '8']), eqB('128 = 100 + 20 + 8')] },
      { title: 'Multiply each part', text: 'Now take them one at a time. 6 × 1 hundred is 6 hundreds, so 6 × 100 = 600. 6 × 2 tens is 12 tens, so 6 × 20 = 120. And 6 × 8 = 48.',
        beats: [
          { say: 'Now take them one at a time. 6 × 1 hundred is 6 hundreds, so 6 × 100 = 600.', pic: 0 },
          { say: '6 × 2 tens is 12 tens, so 6 × 20 = 120.' },
          { say: 'And 6 × 8 = 48.' },
        ],
        pictures: [areaB('6', ['100', '20', '8'], ['600', '120', '48'], true)] },
      { title: 'Add all the parts', text: 'Last move. Add the three parts: 600 + 120 + 48 = 768. So 6 × 128 = 768. There are 768 corn plants in the field.',
        beats: [
          { say: 'Last move. Add the three parts: 600 + 120 + 48 = 768.', pic: 0 },
      ...
      { title: 'One thing not to do', text: 'Watch this one. Do not multiply the digits as if they were all ones. The 1 in 128 means 100 and the 2 means 20, so the parts are 600 and 120, not 6 and 12.',
        beats: [
          { say: 'Watch this one.' },
          { say: 'Do not multiply the digits as if they were all ones.', pic: 0 },
  ...
  // ── Topic 8 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Two digits this time', text: 'You can already multiply 115 by one digit. But 26 has two digits, and adding 115 twenty-six times would take far too long.',
        beats: [
          { say: 'You can already multiply 115 by one digit.', pic: 0 },
          { say: 'But 26 has two digits, and adding 115 twenty-six times would take far too long.' },
        ],
        pictures: [areaB('115', ['26'])] },
      { title: 'The big idea', text: 'Break the two-digit number into tens and ones. Multiply by each part, then add the two answers.',
        beats: [
          { say: 'Break the two-digit number into tens and ones.', pic: 0 },
          { say: 'Multiply by each part, then add the two answers.' },
        ],
        pictures: [areaB('115', ['20', '6'])] },
      { title: 'Break 26 apart', text: '26 is 2 tens and 6 ones. So 26 boxes are 20 boxes and 6 more boxes, and each box still holds 115 books.',
        beats: [
          { say: '26 is 2 tens and 6 ones.', pic: 1 },
          { say: 'So 26 boxes are 20 boxes and 6 more boxes, and each box still holds 115 books.', pic: 0 },
        ],
        pictures: [areaB('115', ['20', '6']), eqB('26 = 20 + 6')] },
      { title: 'Multiply by each part', text: 'Start with the easy piece. 115 × 2 = 230. 20 is 10 times 2, so 115 × 20 is 10 times as much: 2,300. Then the ones: 115 × 6 = 690.',
        beats: [
          { say: 'Start with the easy piece. 115 × 2 = 230.', pic: 0 },
          { say: '20 is 10 times 2, so 115 × 20 is 10 times as much: 2,300.' },
      ...
      { title: 'One thing not to do', text: 'Here is the slip to avoid. Do not multiply by 2 when the 2 is in the tens place. It means 2 tens, which is 20. So multiply 115 by 20, not by 2.',
        beats: [
          { say: 'Here is the slip to avoid.' },
          { say: 'Do not multiply by 2 when the 2 is in the tens place.', pic: 0 },
  ...
  // ── Topic 9 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Multiply by the ones, then write a 0 and multiply by the tens. Add the two rows.',
    screens: [
      ...
      { title: 'A shorter way to write it', text: 'Breaking 23 into 20 and 3 works just fine. But writing out 124 × 20 and 124 × 3 takes a lot of space. Columns do the same work with much less writing.',
        beats: [
          { say: 'Breaking 23 into 20 and 3 works just fine.', pic: 0 },
          { say: 'But writing out 124 × 20 and 124 × 3 takes a lot of space.' },
          { say: 'Columns do the same work with much less writing.' },
        ],
        pictures: [askB('124', '23')] },
      { title: 'The big idea', text: 'Multiply by the ones, then write a 0 and multiply by the tens. Add the two rows.',
        beats: [
          { say: 'Multiply by the ones, then write a 0 and multiply by the tens.', pic: 0 },
          { say: 'Add the two rows.' },
        ],
        pictures: [askB('124', '23')] },
      { title: 'Times the 3 ones', text: 'First row first. Multiply 124 by the 3 ones. 4 × 3 = 12, so write the 2 and carry the 1. 2 × 3 = 6, plus the carried 1 makes 7. And 1 × 3 = 3. The first row is 372.',
        beats: [
          { say: 'First row first. Multiply 124 by the 3 ones.', pic: 0 },
          { say: '4 × 3 = 12, so write the 2 and carry the 1.' },
          { say: '2 × 3 = 6, plus the carried 1 makes 7. And 1 × 3 = 3. The first row is 372.' },
        ],
        pictures: [mulB('124', '23', '372', ' 1 ', true)] },
      { title: 'Times the 2 tens', text: 'Now the 2 in 23. It is not 2, it is 2 tens. So write a 0 in the ones place first, to hold it there. Then 124 × 2 = 248, and the second row is 2,480.',
        beats: [
          { say: 'Now the 2 in 23. It is not 2, it is 2 tens.', write: 'tens row → write a 0 first' },
          { say: 'So write a 0 in the ones place first, to hold it there.', pic: 0 },
          { say: 'Then 124 × 2 = 248, and the second row is 2,480.' },
        ],
        pictures: [mulB('124', '23', '2480', undefined, true)] },
      { title: 'Add the two rows', text: 'Now add them. 372 + 2,480 = 2,852. And look: those rows are 124 × 3 and 124 × 20, the same two parts as breaking 23 apart. There are 2,852 chairs in the hall.',
        beats: [
          { say: 'Now add them. 372 + 2,480 = 2,852.', pic: 0 },
          { say: 'And look: those rows are 124 × 3 and 124 × 20, the same two parts as breaking 23 apart.' },
          { say: 'There are 2,852 chairs in the hall.' },
        ],
        pictures: [{ kind: 'columns', rows: ['372', '2480'], op: '+', carry: '1  ', answer: '2852', motion: true }] },
      { title: 'One thing not to do', text: 'This is the one almost everybody trips on. Do not forget the 0 when you multiply by the tens. Without it, the second row is only 248 instead of 2,480.',
        beats: [
          { say: 'This is the one almost everybody trips on.' },
          { say: 'Do not forget the 0 when you multiply by the tens.', pic: 0 },
          { say: 'Without it, the second row is only 248 instead of 2,480.' },
        ],
  ...
  // ── Topic 10 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Make one row for each digit of the bottom number, and start each new row with one more 0. Then add all the rows.',
    screens: [
      ...
      { title: 'Two rows are not enough', text: 'For a two-digit number you made two rows: the ones and the tens. But 123 has three digits, so there are hundreds to deal with too.',
        beats: [
          { say: 'For a two-digit number you made two rows: the ones and the tens.', pic: 0 },
          { say: 'But 123 has three digits, so there are hundreds to deal with too.' },
        ],
        pictures: [askB('231', '123')] },
      { title: 'The big idea', text: 'Make one row for each digit of the bottom number, and start each new row with one more 0. Then add all the rows.',
        beats: [
          { say: 'Make one row for each digit of the bottom number, and start each new row with one more 0.', pic: 0 },
          { say: 'Then add all the rows.' },
        ],
        pictures: [askB('231', '123')] },
      { title: 'The ones row', text: 'Start with the 3 ones: 231 × 3. 1 × 3 = 3, 3 × 3 = 9 and 2 × 3 = 6. The first row is 693.',
        beats: [
          { say: 'Start with the 3 ones: 231 × 3.', pic: 0 },
          { say: '1 × 3 = 3, 3 × 3 = 9 and 2 × 3 = 6. The first row is 693.' },
        ],
        pictures: [mulB('231', '123', '693', undefined, true)] },
      { title: 'The tens row', text: 'Next the 2 in 123. That 2 means 2 tens, so write one 0 first. Then 231 × 2 = 462, and the second row is 4,620.',
        beats: [
          { say: 'Next the 2 in 123. That 2 means 2 tens, so write one 0 first.', pic: 0 },
          { say: 'Then 231 × 2 = 462, and the second row is 4,620.' },
        ],
        pictures: [mulB('231', '123', '4620', undefined, true)] },
      { title: 'The hundreds row, then add', text: 'Last row. The 1 in 123 means 1 hundred, so this time write two 0s first. Then 231 × 1 = 231, and the row is 23,100. Add all three rows: 693 + 4,620 + 23,100 = 28,413 bottles.',
        beats: [
          { say: 'Last row. The 1 in 123 means 1 hundred, so this time write two 0s first.', write: 'each new row → one more 0' },
          { say: 'Then 231 × 1 = 231, and the row is 23,100.' },
      ...
      { title: 'One thing not to do', text: 'Careful right at the end. Do not forget the two 0s in the hundreds row. The 1 in 123 means 1 hundred, so that row is 23,100, not 231.',
        beats: [
          { say: 'Careful right at the end.' },
          { say: 'Do not forget the two 0s in the hundreds row.', pic: 0 },
          { say: 'The 1 in 123 means 1 hundred, so that row is 23,100, not 231.' },
        ],
  ...
  // ── Topic 11 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Estimate first with round numbers. Then multiply the standard way and check that your answer is close.',
    screens: [
      ...
      { title: 'One slip can go far', text: 'You can already multiply 406 × 35 the standard way. But with big numbers, one small slip, like a lost 0, can throw the answer a long way off. And the worst part is that it still looks like a real answer.',
        beats: [
          { say: 'You can already multiply 406 × 35 the standard way.', pic: 0 },
          { say: 'But with big numbers, one small slip, like a lost 0, can throw the answer a long way off.' },
          { say: 'And the worst part is that it still looks like a real answer.' },
        ],
        pictures: [askB('406', '35')] },
      { title: 'The big idea', text: 'Estimate first with round numbers. Then multiply the standard way and check that your answer is close.',
        beats: [
          { say: 'Estimate first with round numbers.', pic: 0 },
          { say: 'Then multiply the standard way and check that your answer is close.' },
        ],
        pictures: [askB('406', '35')] },
      { title: 'Estimate first', text: 'Round each number to its biggest place. 406 rounds to 400, and 35 rounds to 40. 400 × 40 = 16,000, so our answer should land somewhere close to 16,000.',
        beats: [
          { say: 'Round each number to its biggest place. 406 rounds to 400, and 35 rounds to 40.', pic: 0 },
          { say: '400 × 40 = 16,000, so our answer should land somewhere close to 16,000.', pic: 1 },
        ],
        pictures: [askB('406', '35'), eqB('about 400 × 40', ['= 16,000'])] },
      { title: 'Multiply the standard way', text: 'Now the real thing. The ones row is 406 × 5 = 2,030. For the tens row, write a 0 first, then 406 × 3 = 1,218. The row is 12,180.',
        beats: [
          { say: 'Now the real thing. The ones row is 406 × 5 = 2,030.', pic: 0 },
          { say: 'For the tens row, write a 0 first, then 406 × 3 = 1,218. The row is 12,180.' },
        ],
        pictures: [{ kind: 'columns', rows: ['2030', '12180'], op: '+', answer: null }] },
      { title: 'Add, then check', text: 'Add them: 2,030 + 12,180 = 14,210. Now the check. That is close to 16,000, so the answer makes sense. The warehouse ships 14,210 toys.',
        beats: [
          { say: 'Add them: 2,030 + 12,180 = 14,210.', pic: 0 },
          { say: 'Now the check. That is close to 16,000, so the answer makes sense.', pic: 1 },
      ...
      { title: 'One thing not to do', text: 'And here is what the estimate is for. Do not keep an answer that is far from your estimate. 3,248 is nowhere near 16,000, because the tens row lost its 0. Look again and fix that row.',
        beats: [
          { say: 'And here is what the estimate is for.' },
          { say: 'Do not keep an answer that is far from your estimate.', pic: 0 },
          { say: '3,248 is nowhere near 16,000, because the tens row lost its 0. Look again and fix that row.' },
        ],
  ...
  // ── Topic 12 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t12', title: 'Buses for a school trip', text: '240 students are going on a school trip. Each bus has seats for 60 students. How many buses do they fill?',
        pictures: [lineC('ends')] },
      { title: 'Not a fact you know', text: '240 ÷ 60 is not one of the facts you learned. Counting up by 60s all the way to 240 is slow, and one slip changes the answer.',
        beats: [
          { say: '240 ÷ 60 is not one of the facts you learned.', pic: 0 },
          { say: 'Counting up by 60s all the way to 240 is slow, and one slip changes the answer.' },
        ],
        pictures: [lineC('ends')] },
      { title: 'The big idea', text: IDEA12C,
        beats: [
          { say: 'Think in tens.', pic: 0 },
          { say: '240 is 24 tens and 60 is 6 tens, so 240 ÷ 60 is the same as 24 ÷ 6.', pic: 1 },
        ],
        pictures: [lineC('ends'), eqC('240 ÷ 60', ['24 tens ÷ 6 tens', '24 ÷ 6'])] },
      { title: '240 is 24 tens', text: 'Each small step on this line is 10. Jump 10 tens to 100, 10 more tens to 200, then 4 tens to 240. Count them all up, and that is 24 tens.',
        beats: [
          { say: 'Each small step on this line is 10.', pic: 0 },
          { say: 'Jump 10 tens to 100, 10 more tens to 200, then 4 tens to 240.' },
          { say: 'Count them all up, and that is 24 tens.', pic: 1 },
        ],
        pictures: [lineC(labelsC(0, 100, 200, 240), [{ from: 0, to: 100, label: '10 tens' }, { from: 100, to: 200, label: '10 tens' }, { from: 200, to: 240, label: '4 tens' }]),
          eqC('240 = 24 tens')] },
      { title: '60 is 6 tens', text: 'Now one bus. It seats 60 students. 60 is 6 small steps, so it is 6 tens. One busload is one jump of 6 tens.',
        beats: [
          { say: 'Now one bus. It seats 60 students.', pic: 0 },
          { say: '60 is 6 small steps, so it is 6 tens.', pic: 1 },
          { say: 'One busload is one jump of 6 tens.' },
        ],
        pictures: [lineC(labelsC(0, 60, 240), [{ from: 0, to: 60, label: '6 tens' }]), eqC('60 = 6 tens')] },
      { title: 'Count the jumps', text: 'So jump 6 tens at a time, all the way from 0 to 240. It takes 4 jumps, because 24 ÷ 6 = 4. So 240 ÷ 60 = 4. The students fill 4 buses.',
        beats: [
          { say: 'So jump 6 tens at a time, all the way from 0 to 240.', pic: 0 },
          { say: 'It takes 4 jumps, because 24 ÷ 6 = 4.', pic: 1 },
      ...
      { title: 'One thing not to do', text: 'One warning before you go. Do not take the 0 off only one number. That turns 240 ÷ 60 into 240 ÷ 6. Think of both numbers in tens.',
        beats: [
          { say: 'One warning before you go.' },
          { say: 'Do not take the 0 off only one number.', pic: 0 },
          { say: 'That turns 240 ÷ 60 into 240 ÷ 6. Think of both numbers in tens.' },
        ],
  ...
  // ── Topic 13 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t13', title: 'Teams on the field', text: '68 kids come to play on the sports field. The coach puts 17 kids on each team. How many teams can she make?',
        pictures: [kidsC] },
      { title: 'No facts for 17s', text: 'You learned your facts up to 10 × 10, but nobody learns the 17s. And counting 17, 34, 51 and on is slow, and it is hard to keep track.',
        beats: [
          { say: 'You learned your facts up to 10 × 10, but nobody learns the 17s.', pic: 0 },
          { say: 'And counting 17, 34, 51 and on is slow, and it is hard to keep track.' },
        ],
        pictures: [kidsC] },
      { title: 'The big idea', text: IDEA13C,
        beats: [
          { say: 'Round the number you divide by to the nearest ten and make a guess.', pic: 0 },
          { say: 'Multiply to check: if a whole group still fits in what is left, the guess was too small.' },
        ],
        pictures: [kidsC] },
      { title: 'Make a guess', text: '17 is close to 20, so let us guess with 20s. How many 20s fit into 68? 3 × 20 = 60, and 4 × 20 = 80 is too many. So our guess is 3 teams.',
        beats: [
          { say: '17 is close to 20, so let us guess with 20s.', pic: 0 },
          { say: 'How many 20s fit into 68? 3 × 20 = 60, and 4 × 20 = 80 is too many.' },
          { say: 'So our guess is 3 teams.', write: 'guess with the nearest ten' },
        ],
      ...
      { title: 'Check the guess', text: 'Now check with the real team size: 3 × 17 = 51. Take it away: 68 − 51 = 17. There are 17 kids left.',
        beats: [
          { say: 'Now check with the real team size: 3 × 17 = 51.', pic: 0 },
          { say: 'Take it away: 68 − 51 = 17. There are 17 kids left.' },
        ],
        pictures: [{ kind: 'tape', motion: true, rows: [
          { label: 'Kids', cells: [{ w: 17, text: '17', shade: true }, { w: 17, text: '17', shade: true }, { w: 17, text: '17', shade: true }, { w: 17, text: '17 left' }] },
        ] }] },
      { title: 'One more team', text: 'Wait. 17 kids left is a whole team, so the guess was too small. Add one more team: 4 × 17 = 68, with no one left out. So 68 ÷ 17 = 4. The coach makes 4 teams.',
        beats: [
          { say: 'Wait. 17 kids left is a whole team, so the guess was too small.', pic: 0 },
          { say: 'Add one more team: 4 × 17 = 68, with no one left out.', pic: 1 },
      ...
      { title: 'One thing not to do', text: 'Here is the mistake to watch for. Do not stop while a whole group still fits in what is left. 17 kids left make one more team of 17.',
        beats: [
          { say: 'Here is the mistake to watch for.' },
          { say: 'Do not stop while a whole group still fits in what is left.', pic: 0 },
          { say: '17 kids left make one more team of 17.' },
        ],
  ...
  // ── Topic 14 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t14', title: 'Bunches of roses', text: 'A flower shop has 184 roses. It puts 23 roses in each bunch. How many bunches can it make?',
        pictures: [rosesC()] },
      { title: 'The first digits are too small', text: 'You usually start dividing with the first digit, or the first two. But 23 does not fit into 1, and it does not fit into 18 either.',
        beats: [
          { say: 'You usually start dividing with the first digit, or the first two.', pic: 0 },
          { say: 'But 23 does not fit into 1, and it does not fit into 18 either.' },
        ],
        pictures: [rosesC()] },
      { title: 'The big idea', text: IDEA14C,
        beats: [
          { say: 'If the number you divide by does not fit into the first two digits, the answer has one digit.', pic: 0 },
          { say: 'Guess with round numbers, and if the guess is too big, try one less.' },
        ],
        pictures: [rosesC()] },
      { title: 'Only one digit', text: '23 does not fit into 18 tens, so the answer has no tens at all. It has just one digit, and that digit goes up over the 4.',
        beats: [
          { say: '23 does not fit into 18 tens, so the answer has no tens at all.', pic: 0 },
          { say: 'It has just one digit, and that digit goes up over the 4.' },
        ],
        pictures: [rosesC('  ?')] },
      { title: 'Guess with round numbers', text: '23 is close to 20, so guess with 20s. How many 20s fit into 184? 9 × 20 = 180, so guess 9. Now check with the real number: 9 × 23 = 207. That is more than 184, so 9 is too big.',
        beats: [
          { say: '23 is close to 20, so guess with 20s. How many 20s fit into 184?', pic: 0 },
          { say: '9 × 20 = 180, so guess 9.' },
          { say: 'Now check with the real number: 9 × 23 = 207. That is more than 184, so 9 is too big.', pic: 1 },
        ],
        pictures: [rosesC('  ?'), triesC([['9', '207', 'no']])] },
      { title: 'Try one less', text: 'So try one less. 8 × 23 = 184. It fits exactly, with 0 left. Write the 8 over the 4. So 184 ÷ 23 = 8. The shop makes 8 bunches.',
        beats: [
          { say: 'So try one less. 8 × 23 = 184.', pic: 1 },
          { say: 'It fits exactly, with 0 left. Write the 8 over the 4.', pic: 0 },
          { say: 'So 184 ÷ 23 = 8. The shop makes 8 bunches.' },
        ],
        pictures: [rosesC('  8', ['−184', '  0']), triesC([['9', '207', 'no'], ['8', '184', 'yes']])] },
      { title: 'One thing not to do', text: 'Here is the one to watch. Do not keep a guess that is too big. 9 × 23 = 207 is more than 184, so 9 bunches cannot be made. Try one less.',
        beats: [
          { say: 'Here is the one to watch.' },
          { say: 'Do not keep a guess that is too big.', pic: 0 },
          { say: '9 × 23 = 207 is more than 184, so 9 bunches cannot be made. Try one less.' },
        ],
  ...
  // ── Topic 15 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t15', title: 'Cartons of eggs', text: 'A farm store has 312 eggs. Each carton holds 13 eggs. How many cartons can the store fill?',
        pictures: [eggsC()] },
      { title: "Too much for one guess", text: "Can you find 312 ÷ 13 with one guess? Not really. 13 fits into 31, the first two digits. So the answer has a tens digit and a ones digit. We find them one at a time.",
        beats: [
          { say: "Can you find 312 ÷ 13 with one guess? Not really.", pic: 0 },
          { say: "13 fits into 31, the first two digits. So the answer has a tens digit and a ones digit." },
          { say: "We find them one at a time." },
        ],
        pictures: [eggsC(' ??')] },
      { title: "The big idea", text: IDEA15C,
        beats: [
          { say: "Divide the tens first, then bring down the ones and divide again.", pic: 0 },
        ],
        pictures: [eggsC(' ??')] },
      { title: "Divide the tens", text: "Start with the 31 tens. How many 13s fit? 2 × 13 = 26 fits. 3 × 13 = 39 is too many. So write the 2 over the 1, and take away. 31 − 26 = 5.",
        beats: [
          { say: "Start with the 31 tens. How many 13s fit?", pic: 0 },
          { say: "2 × 13 = 26 fits. 3 × 13 = 39 is too many.", pic: 1 },
          { say: "So write the 2 over the 1, and take away. 31 − 26 = 5." },
        ],
        pictures: [eggsC(' 2', ['−26', ' 5']), placesC([['Tens', '2 × 13 = 26', '31 − 26 = 5']])] },
      { title: "Bring down the ones", text: "5 tens are left over. Bring down the 2 ones and write it beside the 5. Now there are 52 to divide.",
        beats: [
          { say: "5 tens are left over.", pic: 0 },
          { say: "Bring down the 2 ones and write it beside the 5. Now there are 52 to divide." },
        ],
      ...
      { title: "One thing not to do", text: "Here's the part people mix up. Don't STOP after the tens. The 2 ones still have to come down. You're done only when every digit has come down. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't STOP after the tens.", pic: 0 },
          { say: "The 2 ones still have to come down. You're done only when every digit has come down." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 16 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t16', title: 'Sharing stickers', text: '24 kids at the craft table share 1,176 stickers equally. How many stickers does each kid get?',
        pictures: [stickersC()] },
      { title: "Where do you start?", text: "Where does the answer start? 24 doesn't fit into 11, the first two digits of 1,176. Start one place too far left, and every digit lands one place off.",
        beats: [
          { say: "Where does the answer start?", pic: 0 },
          { say: "24 doesn't fit into 11, the first two digits of 1,176." },
          { say: "Start one place too far left, and every digit lands one place off." },
        ],
        pictures: [stickersC()] },
      { title: "The big idea", text: IDEA16C,
        beats: [
          { say: "Start where the number you divide by first fits, then bring down one digit at a time.", pic: 0 },
        ],
        pictures: [stickersC()] },
      { title: "Find where to start", text: "Does 24 fit into 1? No. Into 11? No. Into 117, the first three digits? Yes. So the first digit of the answer goes over the 7.",
        beats: [
          { say: "Does 24 fit into 1? No. Into 11? No.", pic: 1 },
          { say: "Into 117, the first three digits? Yes." },
      ...
      { title: "Divide, take away, bring down", text: "How many 24s fit into 117? 4 × 24 = 96 fits, and 5 × 24 = 120 is too many. Write the 4 over the 7, and take away. 117 − 96 = 21. Then bring down the 6. That makes 216.",
        beats: [
          { say: "How many 24s fit into 117? 4 × 24 = 96 fits, and 5 × 24 = 120 is too many.", pic: 0 },
          { say: "Write the 4 over the 7, and take away. 117 − 96 = 21." },
          { say: "Then bring down the 6. That makes 216." },
        ],
        pictures: [stickersC('  4', [' −96', ' 216'])] },
      { title: "The last digit", text: "One more round. 9 × 24 = 216, so write the 9 over the 6. 216 − 216 = 0, and there are no digits left to bring down. So 1,176 ÷ 24 = 49. Each kid gets 49 stickers.",
        beats: [
          { say: "One more round. 9 × 24 = 216, so write the 9 over the 6.", pic: 0 },
          { say: "216 − 216 = 0, and there are no digits left to bring down." },
          { say: "So 1,176 ÷ 24 = 49. Each kid gets 49 stickers." },
        ],
        pictures: [stickersC('  49', [' −96', ' 216', ' −216', '   0'])] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't put the first digit over the second 1. It goes over the 7, the LAST digit of 117. Over the 1, the answer comes out 490. That's 10 times too many. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't put the first digit over the second 1. It goes over the 7, the LAST digit of 117.", pic: 0 },
          { say: "Over the 1, the answer comes out 490. That's 10 times too many." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 17 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "The ( ) keep one bag together, so 3 × (4 + 2) means 3 times as much as 4 + 2.",
    screens: [
      ...
      { title: "A long way to write it", text: "You could add every piece: 4 + 2 + 4 + 2 + 4 + 2. That's long. And it hides the best part. What's the same every time? Each bag. They're all 4 + 2.",
        beats: [
          { say: "You could add every piece: 4 + 2 + 4 + 2 + 4 + 2.", pic: 1 },
          { say: "That's long. And it hides the best part." },
          { say: "What's the same every time? Each bag. They're all 4 + 2.", pic: 0 },
        ],
        pictures: [tapeD([{ label: '3 bags', cells: groupsD(3, 4, 2) }]), eqD('4 + 2 + 4 + 2 + 4 + 2')] },
      { title: "The big idea", text: "The ( ) keep one bag together, so 3 × (4 + 2) means 3 times as much as 4 + 2.",
        beats: [
          { say: "The ( ) keep one bag together, so 3 × (4 + 2) means 3 times as much as 4 + 2.", pic: 0 },
        ],
        pictures: [tapeD([{ label: '1 bag', cells: groupsD(1, 4, 2), brace: '4 + 2' }, { label: '3 bags', cells: groupsD(3, 4, 2), brace: '3 × (4 + 2)' }])] },
      { title: "Keep one bag together", text: "Start with one bag. 4 apples and 2 pears, so 4 + 2. Put ( ) around it. Now the whole bag stays together.",
        beats: [
          { say: "Start with one bag. 4 apples and 2 pears, so 4 + 2.", pic: 0 },
          { say: "Put ( ) around it. Now the whole bag stays together." },
        ],
        pictures: [tapeD([{ label: '1 bag', cells: groupsD(1, 4, 2), brace: '(4 + 2)' }], true)] },
      { title: "Three of the whole bag", text: "There are 3 bags, all the same. So write 3 × (4 + 2). It means 3 times as much as 4 + 2. One bag is 6, so 3 bags are 18.",
        beats: [
          { say: "There are 3 bags, all the same. So write 3 × (4 + 2).", pic: 0 },
        ...
        pictures: [tapeD([{ label: '1 bag', cells: groupsD(1, 4, 2), brace: '(4 + 2)' }, { label: '3 bags', cells: groupsD(3, 4, 2), brace: '3 × (4 + 2)' }], true),
          eqD('3 × (4 + 2)', ['= 3 × 6', '= 18'])] },
      { title: "Compare without working it out", text: "Now look at 3 × 4 + 2. Is it the same? No. It's 3 bags of 4 apples, and just 2 pears in all. 3 × (4 + 2) has 2 pears in every bag, so it's more.",
        beats: [
          { say: "Now look at 3 × 4 + 2. Is it the same?", pic: 0 },
          { say: "No. It's 3 bags of 4 apples, and just 2 pears in all." },
          { say: "3 × (4 + 2) has 2 pears in every bag, so it's more.", pic: 1 },
        ],
        pictures: [tapeD([{ label: 'With ( )', cells: groupsD(3, 4, 2) },
          { label: 'No ( )', cells: [{ w: 4, text: '4' }, { w: 4, text: '4' }, { w: 4, text: '4' }, { w: 2, text: '2', shade: true }] }], true),
          eqD('3 × (4 + 2)', ['>', '3 × 4 + 2'])] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't DROP the ( ). Without them, there are just 2 pears in all, not 2 in every bag. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't DROP the ( ).", pic: 0 },
          { say: "Without them, there are just 2 pears in all, not 2 in every bag." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 18 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "Give every number and sign a job in the story, and let the part in ( ) happen first.",
    screens: [
      { scene: 'g5m1-t18', title: 'A number sentence on the board', text: 'The board in class shows 4 × (6 + 3). What story could these numbers and signs tell?',
        pictures: [eqD('4 × (6 + 3)')] },
      { title: "Numbers alone are not a story", text: "What do the 4, the 6 and the 3 count? What do the × and the + do? The board doesn't say. So a story has to give every part a job.",
        beats: [
          { say: "What do the 4, the 6 and the 3 count? What do the × and the + do?", pic: 0 },
          { say: "The board doesn't say." },
          { say: "So a story has to give every part a job." },
        ],
        pictures: [eqD('4 × (6 + 3)', ['4 what? 6 what? 3 what?'])] },
      { title: "The big idea", text: "Give every number and sign a job in the story, and let the part in ( ) happen first.",
        beats: [
          { say: "Give every number and sign a job in the story, and let the part in ( ) happen first.", pic: 0 },
        ],
        pictures: [eqD('4 × (6 + 3)')] },
      { title: "Start with the ( )", text: "The part in ( ) happens first, so it's one thing. Make 6 + 3 one bag: 6 red marbles and 3 green.",
        beats: [
          { say: "The part in ( ) happens first, so it's one thing." },
          { say: "Make 6 + 3 one bag: 6 red marbles and 3 green.", pic: 0 },
        ],
        pictures: [tapeD([{ label: '1 bag', cells: groupsD(1, 6, 3), brace: '6 + 3' }], true)] },
      { title: "Then the 4 ×", text: "Now the 4 ×. That means 4 of that whole bag. So the story is 4 bags, each with 6 red and 3 green.",
        beats: [
          { say: "Now the 4 ×. That means 4 of that whole bag.", pic: 0 },
          { say: "So the story is 4 bags, each with 6 red and 3 green." },
        ],
        pictures: [tapeD([{ label: '1 bag', cells: groupsD(1, 6, 3), brace: '6 + 3' }, { label: '4 bags', cells: groupsD(4, 6, 3), brace: '4 × (6 + 3)' }], true)] },
      { title: "Solve the story", text: "Does the story match the board? Let's solve it. One bag has 6 + 3 = 9 marbles. 4 bags have 4 × 9 = 36. The board gives 36 too. They match.",
        beats: [
          { say: "Does the story match the board? Let's solve it." },
          { say: "One bag has 6 + 3 = 9 marbles. 4 bags have 4 × 9 = 36.", pic: 0 },
          { say: "The board gives 36 too. They match.", pic: 1 },
        ],
        pictures: [tapeD([{ label: '4 bags', cells: groupsD(4, 6, 3), brace: '36 marbles' }]), eqD('4 × (6 + 3)', ['= 4 × 9', '= 36'])] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't let the story do the × FIRST. 4 bags of 6 red, plus 3 green, is 4 × 6 + 3. The ( ) put 3 green in every bag. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't let the story do the × FIRST.", pic: 0 },
          { say: "4 bags of 6 red, plus 3 green, is 4 × 6 + 3. The ( ) put 3 green in every bag." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 19 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: "The story hides a number", text: "Can we share the markers among 18 classes yet? Not yet. How many markers are there in all? The story never says. That number is hidden. We have to find it first.",
        beats: [
          { say: "Can we share the markers among 18 classes yet? Not yet.", pic: 0 },
          { say: "How many markers are there in all? The story never says." },
          { say: "That number is hidden. We have to find it first." },
        ],
      ...
      { title: "The big idea", text: "Find the hidden number first, then use it to answer the question.",
        beats: [
          { say: "Find the hidden number first, then use it to answer the question.", pic: 0 },
        ],
        pictures: [tapeD([boxesD('? markers in all'), classesD('?')])] },
      { title: "Step 1: find the hidden number", text: "24 boxes, with 36 markers in each. 24 × 36 = 864. So there are 864 markers in all.",
        beats: [
          { say: "24 boxes, with 36 markers in each.", pic: 0 },
          { say: "24 × 36 = 864. So there are 864 markers in all.", pic: 1 },
        ],
        pictures: [tapeD([boxesD('864 markers in all'), classesD('?')], true), eqD('24 × 36 = 864')] },
      { title: "Step 2: use it", text: "Now answer the real question. Share the 864 markers among 18 classes. 864 ÷ 18 = 48. Each class gets 48 markers.",
        beats: [
          { say: "Now answer the real question.", pic: 0 },
          { say: "Share the 864 markers among 18 classes. 864 ÷ 18 = 48.", pic: 1 },
          { say: "Each class gets 48 markers." },
        ],
        pictures: [tapeD([boxesD('864 markers in all'), classesD('48')], true), eqD('864 ÷ 18 = 48')] },
      { title: "Check it makes sense", text: "Does 48 make sense? Check it. 18 classes with 48 each is 18 × 48 = 864. That's every marker in the 24 boxes. It checks out.",
        beats: [
          { say: "Does 48 make sense? Check it." },
          { say: "18 classes with 48 each is 18 × 48 = 864.", pic: 1 },
          { say: "That's every marker in the 24 boxes. It checks out.", pic: 0 },
        ],
        pictures: [tapeD([boxesD('864 markers in all'), classesD('48')]), eqD('18 × 48 = 864')] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't STOP at the hidden number. 864 is all the markers, not one class's share. Finish with the question. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't STOP at the hidden number.", pic: 0 },
          { say: "864 is all the markers, not one class's share. Finish with the question." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 20 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "Draw the story as a tape, solve one part at a time, and check what the question asks.",
    screens: [
      ...
      { title: "Three numbers, no sign yet", text: "The story gives 32, 25 and 186. Which one is the empty seats? None of them. And pick a sign too soon, and you may answer a different question.",
        beats: [
          { say: "The story gives 32, 25 and 186. Which one is the empty seats?", pic: 0 },
          { say: "None of them. And pick a sign too soon, and you may answer a different question." },
        ],
        pictures: [tapeD([seatRowsD(), seatsD('? empty')])] },
      { title: "The big idea", text: "Draw the story as a tape, solve one part at a time, and check what the question asks.",
        beats: [
          { say: "Draw the story as a tape, solve one part at a time, and check what the question asks.", pic: 0 },
        ],
        pictures: [tapeD([seatRowsD(), seatsD('? empty')])] },
      ...
      { title: "Part 2: take away the sold seats", text: "186 seats are sold. That's one part of the 800. The empty seats are the other part. So take away. 800 − 186 = 614.",
        beats: [
          { say: "186 seats are sold. That's one part of the 800.", pic: 0 },
          { say: "The empty seats are the other part. So take away. 800 − 186 = 614.", pic: 1 },
        ],
        pictures: [tapeD([seatRowsD('800 seats'), seatsD('614 empty')], true), eqD('800 − 186 = 614')] },
      { title: "Check what the question asks", text: "Now read the question again. Does it ask for sold seats? No, empty ones. Check it. 614 empty and 186 sold make 800. So 614 seats are still empty.",
        beats: [
          { say: "Now read the question again. Does it ask for sold seats? No, empty ones.", pic: 0 },
      ...
      { title: "One thing not to do", text: "Here's the part people mix up. Don't ADD the sold seats. They're part of the 800, so take them away. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't ADD the sold seats.", pic: 0 },
          { say: "They're part of the 800, so take them away." },
          { say: "Okay. Your turn." },
        ],
