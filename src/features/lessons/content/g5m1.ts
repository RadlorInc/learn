...
export const G5M1: Lesson[] = [
  ...
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "Slide a digit one place to the left, and it's worth 10 times as much. Slide it one place to the right, and it's worth 1/10 as much.",
    screens: [
      ...
      { title: 'Adding takes too long', text: "Hmm. You could add 40, ten times over. That works! But it takes a while, and it's so easy to lose count. Here's the good news. There's a much faster way, and it lives right here, in a chart of places.",
        beats: [
          { say: 'Hmm. You could add 40, ten times over.' },
          { say: "That works! But it takes a while, and it's so easy to lose count." },
          { say: "Here's the good news. There's a much faster way, and it lives right here, in a chart of places.", pic: 0 },
        ],
        pictures: [chartA(4, ['40'])] },
      { title: 'The big idea', text: "Slide a digit one place to the left, and it's worth 10 times as much. Slide it one place to the right, and it's worth 1/10 as much.",
        beats: [
          { say: "Slide a digit one place to the left, and it's worth 10 times as much.", pic: 0 },
          { say: "Slide it one place to the right, and it's worth 1/10 as much." },
        ],
        pictures: [chartA(4, ['40', '400'])] },
      { title: 'Each place is 10 of the next', text: "Let's walk through the places, starting from the right. 10 ones make 1 ten. 10 tens make 1 hundred. And 10 hundreds make 1 thousand! See the pattern? Every step to the left is worth 10 times as much.",
        beats: [
          { say: "Let's walk through the places, starting from the right.", pic: 0 },
          { say: '10 ones make 1 ten. 10 tens make 1 hundred. And 10 hundreds make 1 thousand!', pic: 1 },
          { say: 'See the pattern? Every step to the left is worth 10 times as much.', write: 'one place left = × 10' },
        ],
      ...
      { title: 'Slide the 4 to the left', text: "Look at 40. The 4 is sitting in the tens place, so it's worth 4 tens. Now watch. Slide it one place to the left, and it lands in the hundreds. Now it's 4 hundreds: 400! That slide is what 10 times as much looks like. So a carton holds 400 pencils!",
        beats: [
          { say: "Look at 40. The 4 is sitting in the tens place, so it's worth 4 tens.", pic: 0 },
          { say: "Now watch. Slide it one place to the left, and it lands in the hundreds. Now it's 4 hundreds: 400!" },
          { say: 'That slide is what 10 times as much looks like. So a carton holds 400 pencils!', pic: 1 },
        ],
        pictures: [chartA(4, ['40', '400'], [[1, 1]], true), eqA('10 × 40 = 400')] },
      { title: 'Slide it back to the right', text: "Now let's go back the other way. One box is 1/10 of a carton. So slide the 4 in 400 one place to the right, back into the tens place. And it's 40 again! There it is! 1/10 of 400 is 40 pencils.",
        beats: [
          { say: "Now let's go back the other way. One box is 1/10 of a carton.", pic: 0 },
          { say: "So slide the 4 in 400 one place to the right, back into the tens place. And it's 40 again!" },
          { say: 'There it is! 1/10 of 400 is 40 pencils.', pic: 1 },
        ],
        pictures: [chartA(4, ['400', '40'], [[1, 2]], true), eqA('1/10 of 400 = 40')] },
      { title: 'One thing not to do', text: "Now, here's a trap I want you to watch out for. Ten times as much does not mean add 10! It slides every single digit one place to the left.",
        beats: [
          { say: "Now, here's a trap I want you to watch out for." },
          { say: 'Ten times as much does not mean add 10!', pic: 0 },
          { say: 'It slides every single digit one place to the left.' },
        ],
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "Count the zeros in 10, 100 or 1,000. That's how many places every digit slides: left to multiply, right to divide.",
    screens: [
      ...
      { title: 'Too many to add', text: "Add 37 one thousand times? That would take all day! But there's a much faster way. And the best part? It works for dividing too!",
        beats: [
          { say: 'Add 37 one thousand times? That would take all day!', pic: 0 },
          { say: "But there's a much faster way. And the best part? It works for dividing too!" },
        ],
        pictures: [chartA(5, ['37'])] },
      { title: 'The big idea', text: "Count the zeros in 10, 100 or 1,000. That's how many places every digit slides: left to multiply, right to divide.",
        beats: [
          { say: 'Count the zeros in 10, 100 or 1,000.', pic: 0 },
          { say: "That's how many places every digit slides: left to multiply, right to divide." },
        ],
        pictures: [chartA(5, ['37', '37000'])] },
      { title: 'One zero, one place', text: "Let's start with the easy one. 10 has just one zero. So 37 × 10 slides the 3 and the 7 one place to the left. Now the ones place is empty, so a 0 fills that spot. And we get 370!",
        beats: [
          { say: "Let's start with the easy one. 10 has just one zero.", pic: 0 },
          { say: 'So 37 × 10 slides the 3 and the 7 one place to the left.', write: 'one zero → one place' },
          { say: 'Now the ones place is empty, so a 0 fills that spot. And we get 370!', pic: 1 },
        ],
        pictures: [chartA(5, ['37', '370'], [[1, 4]], true), eqA('37 × 10 = 370')] },
      { title: 'More zeros, more places', text: "Now add a zero. 100 has two zeros, so the digits slide two places: 3,700. And 1,000 has three zeros, so they slide three places: 37,000. And there's our answer. The shop has 37,000 beads!",
        beats: [
          ...
          { say: "And there's our answer. The shop has 37,000 beads!", pic: 1 },
        ],
        pictures: [chartA(5, ['37', '370', '3700', '37000'], [[1, 4], [2, 3], [2, 4], [3, 2], [3, 3], [3, 4]], true),
          eqA('37 × 10 = 370', ['37 × 100 = 3,700', '37 × 1,000 = 37,000'])] },
      { title: 'Dividing slides right', text: "Now let's go backwards. The shop shares all 37,000 beads into 1,000 bags. 1,000 still has three zeros, so every digit slides three places. But this time, to the right. The zeros slide right off the end, and 37 beads go in each bag.",
        beats: [
          { say: "Now let's go backwards. The shop shares all 37,000 beads into 1,000 bags.", pic: 0 },
          { say: '1,000 still has three zeros, so every digit slides three places. But this time, to the right.', write: 'divide → slide right' },
      ...
      { title: 'One thing not to do', text: "Now, one more thing to watch out for. When you divide, don't slide to the left! Dividing makes the number smaller, so every digit slides to the right.",
        beats: [
          { say: 'Now, one more thing to watch out for.' },
          { say: "When you divide, don't slide to the left!", pic: 0 },
