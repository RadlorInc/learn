...
export const G5M1: Lesson[] = [
  ...
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Adding takes too long', text: 'You could add 40 ten times. That takes a long time, and you can lose count. A chart of places shows a faster way.',
        pictures: [chartA(4, ['40'])] },
      ...
      { title: 'Slide it back to the right', text: 'One box is 1/10 of a carton. Slide the 4 in 400 one place right, back to the tens place: 40. So 1/10 of 400 is 40 pencils.',
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Too many to add', text: 'Adding 37 one thousand times would take all day. There is a much faster way, and it works for dividing too.',
      ...
      { title: 'One zero, one place', text: '10 has one zero. So 37 × 10 slides the 3 and the 7 one place to the left. A 0 fills the empty ones place: 370.',
        pictures: [chartA(5, ['37', '370'], [[1, 4]], true), eqA('37 × 10 = 370')] },
      { title: 'More zeros, more places', text: '100 has two zeros, so the digits slide two places: 3,700. 1,000 has three zeros, so they slide three places: 37,000. The shop has 37,000 beads.',
        pictures: [chartA(5, ['37', '370', '3700', '37000'], [[1, 4], [2, 3], [2, 4], [3, 2], [3, 3], [3, 4]], true),
          eqA('37 × 10 = 370', ['37 × 100 = 3,700', '37 × 1,000 = 37,000'])] },
      { title: 'Dividing slides right', text: 'Now the shop shares 37,000 beads equally into 1,000 bags. 1,000 has three zeros, so every digit slides three places to the right. The zeros slide off, and 37 beads go in each bag.',
        pictures: [chartA(5, ['37000', '37'], [[1, 3], [1, 4]], true), eqA('37,000 ÷ 1,000 = 37')] },
      { title: 'One thing not to do', text: "Don't slide left when you divide. Dividing makes the number smaller, so every digit slides right.",
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Zeros are hard to count', text: 'Six zeros in a row are hard to count at a glance. Write one zero too many and the number is 10 times too big.',
      ...
      { title: 'Count the 10s', text: '10 × 10 is two 10s, so write 10². 10 × 10 × 10 is three 10s, so write 10³. Each 10 you multiply adds one zero.',
        pictures: [{ kind: 'table', head: ['Short way', 'Long way', 'Number'], rows: [['10¹', '10', '10'], ['10²', '10 × 10', '100'], ['10³', '10 × 10 × 10', '1,000']], motion: true }] },
      { title: 'The city the short way', text: '1,000,000 is a 1 with 6 zeros. That is six 10s multiplied, so the city has 10⁶ people.',
      ...
      { title: 'It says how far to slide', text: 'The small number also says how many places the digits slide. 45 × 10³ slides them 3 places left: 45,000. 62,000 ÷ 10³ slides them 3 places right: 62.',
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Round each number', text: 'Round each number at its biggest place. 28 is only 2 away from 30. 412 is only 12 away from 400. So 28 × 412 is close to 30 × 400.',
        pictures: [roundA(20, 30, 28, 30, '2 away'), roundA(400, 500, 412, 400, '12 away')] },
      { title: 'Use a fact, then the zeros', text: '3 × 4 = 12. 30 has one zero and 400 has two, so write three zeros after the 12: 12,000. The farm packs about 12,000 eggs.',
        pictures: [eqA('3 × 4 = 12', ['30 × 400 = 12,000', 'about 12,000 eggs'])] },
      { title: 'Dividing works the same way', text: '2,380 eggs go into crates of 58. Round 58 to the nearest ten, 60, and 2,380 to the nearest hundred, 2,400. 24 ÷ 6 = 4, and 60 × 40 = 2,400. So it is about 40 crates.',
        pictures: [roundA(2300, 2400, 2380, 2400, '20 away'), eqA('2,380 ÷ 58', ['2,400 ÷ 60 = 40'])] },
      { title: 'One thing not to do', text: "Don't lose zeros. 30 has one zero and 400 has two, so the answer needs three zeros after the 12.",
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Two different units', text: 'The jug is measured in liters, but the cups are in milliliters. The 2 and the 250 count different units, so you cannot divide them yet.',
      ...
      { title: 'First, the same unit', text: '1 L is 1,000 mL. So the jug holds 2 × 1,000 = 2,000 mL. Now the jug and the cups are both in milliliters.',
        pictures: [twoWaysA(2, ['L', '1 L'], ['mL', '1,000 mL'], '2,000 mL', true)] },
      { title: 'Then, how many cups', text: '4 cups of 250 mL make 1,000 mL. The jug holds two of those, so 2 × 4 = 8 cups. That is 2,000 ÷ 250 = 8.',
        pictures: [cupsA(undefined, true), eqA('2,000 ÷ 250 = 8')] },
      { title: 'Check the answer', text: '8 cups of 250 mL is 8 × 250 = 2,000 mL. That is 2 L, the whole jug. You can fill 8 cups.',
        pictures: [cupsA('2,000 mL = 2 L'), eqA('8 × 250 = 2,000')] },
      { title: 'One thing not to do', text: "Don't do the math with two different units. Change 2 L into 2,000 mL first, then divide.",
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Not in the times tables', text: '6 × 128 is not a fact you know by heart. Adding 128 six times takes a long time, and one slip changes the answer.',
        pictures: [areaB('6', ['128'])] },
      ...
      { title: 'Multiply each part', text: '6 × 1 hundred is 6 hundreds, so 6 × 100 = 600. 6 × 2 tens is 12 tens, so 6 × 20 = 120. And 6 × 8 = 48.',
        pictures: [areaB('6', ['100', '20', '8'], ['600', '120', '48'], true)] },
      { title: 'Add all the parts', text: '600 + 120 + 48 = 768. So 6 × 128 = 768. There are 768 corn plants in the field.',
        pictures: [areaB('6', ['100', '20', '8'], ['600', '120', '48']), eqB('6 × 128 = 600 + 120 + 48', ['= 768'])] },
      { title: 'One thing not to do', text: "Don't multiply the digits as if they were all ones. The 1 in 128 means 100 and the 2 means 20, so the parts are 600 and 120, not 6 and 12.",
  ...
  // ── Topic 8 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Two digits this time', text: 'You can multiply 115 by one digit. But 26 has two digits, and adding 115 twenty-six times would take far too long.',
        pictures: [areaB('115', ['26'])] },
      ...
      { title: 'Break 26 apart', text: '26 is 2 tens and 6 ones: 20 + 6. So 26 boxes are 20 boxes and 6 more boxes. Each box still holds 115 books.',
        pictures: [areaB('115', ['20', '6']), eqB('26 = 20 + 6')] },
      { title: 'Multiply by each part', text: '115 × 2 = 230. 20 is 10 times 2, so 115 × 20 is 10 times as much: 2,300. Then 115 × 6 = 690.',
        pictures: [areaB('115', ['20', '6'], ['2,300', '690'], true)] },
      { title: 'Add the two answers', text: '2,300 + 690 = 2,990. So 115 × 26 = 2,990. The shop gets 2,990 books.',
        pictures: [areaB('115', ['20', '6'], ['2,300', '690']), eqB('115 × 26 = 2,300 + 690', ['= 2,990'])] },
      { title: 'One thing not to do', text: "Don't multiply by 2 when the 2 is in the tens place. It means 2 tens, which is 20. So multiply 115 by 20, not by 2.",
  ...
  // ── Topic 9 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'A shorter way to write it', text: 'Breaking 23 into 20 and 3 works, but writing out 124 × 20 and 124 × 3 takes a lot of space. Columns do the same work in less writing.',
        pictures: [askB('124', '23')] },
      { title: 'The big idea', text: 'Multiply by the ones, then write a 0 and multiply by the tens. Add the two rows.',
        pictures: [askB('124', '23')] },
      { title: 'Times the 3 ones', text: 'First multiply 124 by the 3 ones. 4 × 3 = 12: write 2, carry the 1. 2 × 3 = 6, plus the 1 is 7. 1 × 3 = 3. The first row is 372.',
      ...
      { title: 'Add the two rows', text: '372 + 2,480 = 2,852. The rows are 124 × 3 and 124 × 20, the same two parts as breaking 23 apart. There are 2,852 chairs.',
  ...
  // ── Topic 10 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Two rows are not enough', text: 'For a two-digit number you made two rows: the ones and the tens. But 123 has three digits, so it has hundreds too.',
        pictures: [askB('231', '123')] },
      ...
      { title: 'The tens row', text: 'The 2 in 123 means 2 tens, so write one 0 first. Then 231 × 2 = 462. The second row is 4,620.',
        pictures: [mulB('231', '123', '4620', undefined, true)] },
      { title: 'The hundreds row, then add', text: 'The 1 in 123 means 1 hundred, so write two 0s first. Then 231 × 1 = 231, and the row is 23,100. Add the three rows: 693 + 4,620 + 23,100 = 28,413 bottles.',
        pictures: [{ kind: 'columns', rows: ['693', '4620', '23100'], op: '+', carry: '11  ', answer: '28413', motion: true }] },
      { title: 'One thing not to do', text: "Don't forget the two 0s in the hundreds row. The 1 in 123 means 1 hundred, so that row is 23,100, not 231.",
  ...
  // ── Topic 11 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'One slip can go far', text: 'You can already multiply 406 × 35 the standard way. But with big numbers, one small slip, like a lost 0, can make the answer far off. And it still looks like a real answer.',
        pictures: [askB('406', '35')] },
      { title: 'The big idea', text: 'Estimate first with round numbers. Then multiply the standard way and check that your answer is close.',
        pictures: [askB('406', '35')] },
      { title: 'Estimate first', text: 'Round each number to its biggest place: 406 rounds to 400, and 35 rounds to 40. 400 × 40 = 16,000, so the answer should be close to 16,000.',
        pictures: [askB('406', '35'), eqB('about 400 × 40', ['= 16,000'])] },
      { title: 'Multiply the standard way', text: 'The ones row is 406 × 5 = 2,030. For the tens row, write a 0, then 406 × 3 = 1,218. The row is 12,180.',
        pictures: [{ kind: 'columns', rows: ['2030', '12180'], op: '+', answer: null }] },
      { title: 'Add, then check', text: '2,030 + 12,180 = 14,210. That is close to 16,000, so the answer makes sense. The warehouse ships 14,210 toys.',
        pictures: [{ kind: 'columns', rows: ['2030', '12180'], op: '+', carry: '1  ', answer: '14210', motion: true }, eqB('14,210', ['is close to 16,000'])] },
      { title: 'One thing not to do', text: "Don't keep an answer that is far from your estimate. 3,248 is nowhere near 16,000, because the tens row lost its 0. Look again and fix that row.",
  ...
  // ── Topic 12 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: '240 is 24 tens', text: 'Each small step on this line is 10. Jump 10 tens to 100, 10 more tens to 200, then 4 tens to 240. That is 24 tens.',
        pictures: [lineC(labelsC(0, 100, 200, 240), [{ from: 0, to: 100, label: '10 tens' }, { from: 100, to: 200, label: '10 tens' }, { from: 200, to: 240, label: '4 tens' }]),
          eqC('240 = 24 tens')] },
      { title: '60 is 6 tens', text: 'One bus seats 60 students. 60 is 6 small steps, so it is 6 tens. One busload is one jump of 6 tens.',
        pictures: [lineC(labelsC(0, 60, 240), [{ from: 0, to: 60, label: '6 tens' }]), eqC('60 = 6 tens')] },
      { title: 'Count the jumps', text: 'Jump 6 tens at a time from 0 to 240. It takes 4 jumps, because 24 ÷ 6 = 4. So 240 ÷ 60 = 4. The students fill 4 buses.',
      ...
      { title: 'One thing not to do', text: "Don't take the 0 off only one number. That turns 240 ÷ 60 into 240 ÷ 6. Think of both numbers in tens.",
  ...
  // ── Topic 13 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t13', title: 'Teams on the field', text: '68 kids come to play on the sports field. The coach puts 17 kids on each team. How many teams can she make?',
        pictures: [kidsC] },
      { title: 'No facts for 17s', text: 'You learned your facts up to 10 × 10, but not the 17s. Counting 17, 34, 51 and on is slow, and it is hard to keep track.',
        pictures: [kidsC] },
      { title: 'The big idea', text: IDEA13C,
        pictures: [kidsC] },
      { title: 'Make a guess', text: '17 is close to 20. How many 20s fit into 68? 3 × 20 = 60, and 4 × 20 = 80 is too many. So guess 3 teams.',
      ...
      { title: 'Check the guess', text: 'Now multiply the real team size: 3 × 17 = 51. Take it away: 68 − 51 = 17. There are 17 kids left.',
        pictures: [{ kind: 'tape', motion: true, rows: [
          { label: 'Kids', cells: [{ w: 17, text: '17', shade: true }, { w: 17, text: '17', shade: true }, { w: 17, text: '17', shade: true }, { w: 17, text: '17 left' }] },
        ] }] },
      { title: 'One more team', text: '17 kids left is a whole team, so the guess was too small. Add one more team: 4 × 17 = 68, with no one left. So 68 ÷ 17 = 4. The coach makes 4 teams.',
        pictures: [{ kind: 'tape', motion: true, rows: [
      ...
      { title: 'One thing not to do', text: "Don't stop while a whole group still fits in what is left. 17 kids left make one more team of 17.",
  ...
  // ── Topic 14 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The big idea', text: IDEA14C,
        pictures: [rosesC()] },
      { title: 'Only one digit', text: '23 does not fit into 18 tens, so the answer has no tens. It has just one digit, and that digit goes over the 4.',
        pictures: [rosesC('  ?')] },
      { title: 'Guess with round numbers', text: '23 is close to 20. How many 20s fit into 184? 9 × 20 = 180, so guess 9. Check with the real number: 9 × 23 = 207. That is more than 184, so 9 is too big.',
        pictures: [rosesC('  ?'), triesC([['9', '207', 'no']])] },
      { title: 'Try one less', text: 'Try 8: 8 × 23 = 184. It fits, with 0 left. Write 8 over the 4. So 184 ÷ 23 = 8. The shop makes 8 bunches.',
        pictures: [rosesC('  8', ['−184', '  0']), triesC([['9', '207', 'no'], ['8', '184', 'yes']])] },
      { title: 'One thing not to do', text: "Don't keep a guess that is too big. 9 × 23 = 207 is more than 184, so 9 bunches cannot be made. Try one less.",
  ...
  // ── Topic 15 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t15', title: 'Cartons of eggs', text: 'A farm store has 312 eggs. Each carton holds 13 eggs. How many cartons can the store fill?',
        pictures: [eggsC()] },
      { title: 'Too much for one guess', text: '13 fits into 31, the first two digits of 312. So the answer has a tens digit and a ones digit. That is too much to find with one guess.',
        pictures: [eggsC(' ??')] },
      { title: 'The big idea', text: IDEA15C,
        pictures: [eggsC(' ??')] },
      { title: 'Divide the tens', text: 'Start with 31 tens. 2 × 13 = 26 fits, and 3 × 13 = 39 is too many. Write 2 over the 1. Take away: 31 − 26 = 5.',
        pictures: [eggsC(' 2', ['−26', ' 5']), placesC([['Tens', '2 × 13 = 26', '31 − 26 = 5']])] },
      { title: 'Bring down the ones', text: '5 tens are left. Bring down the 2 ones and write the 2 beside the 5. Now there are 52 to divide.',
        pictures: [eggsC(' 2', ['−26', ' 52'])] },
      { title: 'Divide the ones', text: '4 × 13 = 52. Write 4 over the 2. Take away: 52 − 52 = 0. So 312 ÷ 13 = 24. The store fills 24 cartons.',
        pictures: [eggsC(' 24', ['−26', ' 52', ' −52', '  0']), placesC([['Tens', '2 × 13 = 26', '31 − 26 = 5'], ['Ones', '4 × 13 = 52', '52 − 52 = 0']])] },
      { title: 'One thing not to do', text: "Don't stop after the tens. The 2 ones still have to come down. You are done only when every digit has come down.",
  ...
  // ── Topic 16 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t16', title: 'Sharing stickers', text: '24 kids at the craft table share 1,176 stickers equally. How many stickers does each kid get?',
        pictures: [stickersC()] },
      { title: 'Where do you start?', text: 'The first two digits of 1,176 make 11, and 24 does not fit into 11. If the answer starts one place too far left, every digit of it lands one place off.',
        pictures: [stickersC()] },
      { title: 'The big idea', text: IDEA16C,
        pictures: [stickersC()] },
      { title: 'Find where to start', text: '24 does not fit into 1 or into 11. It does fit into 117, the first three digits. So the first digit of the answer goes over the 7.',
        pictures: [stickersC('  ?'), { kind: 'table', head: ['Start with', 'Does 24 fit?'], rows: [['1', 'no'], ['11', 'no'], ['117', 'yes']], mark: [[2, 0], [2, 1]], motion: true }] },
      { title: 'Divide, take away, bring down', text: '4 × 24 = 96 fits into 117, and 5 × 24 = 120 is too many. Write 4 over the 7. 117 − 96 = 21. Bring down the 6 to make 216.',
        pictures: [stickersC('  4', [' −96', ' 216'])] },
      { title: 'The last digit', text: '9 × 24 = 216. Write 9 over the 6. 216 − 216 = 0, and no digits are left to bring down. So 1,176 ÷ 24 = 49. Each kid gets 49 stickers.',
        pictures: [stickersC('  49', [' −96', ' 216', ' −216', '   0'])] },
      { title: 'One thing not to do', text: "Don't write the first digit over the second 1. It goes over the 7, the last digit of 117. Multiply to check: 490 × 24 = 11,760, which is 10 times too many.",
  ...
  // ── Topic 17 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'A long way to write it', text: 'You could add every piece: 4 + 2 + 4 + 2 + 4 + 2. That is long, and it hides that the 3 bags are all the same.',
      ...
      { title: 'Keep one bag together', text: 'One bag is 4 apples and 2 pears: 4 + 2. Put ( ) around it, so the bag stays together: (4 + 2).',
      ...
      { title: 'Three of the whole bag', text: 'There are 3 bags, all the same, so write 3 × (4 + 2). It means 3 times as much as 4 + 2. One bag is 6, so 3 bags are 18.',
        pictures: [tapeD([{ label: '1 bag', cells: groupsD(1, 4, 2), brace: '(4 + 2)' }, { label: '3 bags', cells: groupsD(3, 4, 2), brace: '3 × (4 + 2)' }], true),
          eqD('3 × (4 + 2)', ['= 3 × 6', '= 18'])] },
      { title: 'Compare without working it out', text: 'Look at 3 × (4 + 2) and 3 × 4 + 2. Both have 3 bags of 4 apples. The first has 2 pears in every bag. The second has just 2 pears in all. So the first is more.',
        pictures: [tapeD([{ label: 'With ( )', cells: groupsD(3, 4, 2) },
          { label: 'No ( )', cells: [{ w: 4, text: '4' }, { w: 4, text: '4' }, { w: 4, text: '4' }, { w: 2, text: '2', shade: true }] }], true),
          eqD('3 × (4 + 2)', ['>', '3 × 4 + 2'])] },
      { title: 'One thing not to do', text: "Don't leave out the ( ). 3 × 4 + 2 is 3 bags of apples and just 2 pears. The ( ) put 2 pears in every bag.",
  ...
  // ── Topic 18 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { scene: 'g5m1-t18', title: 'A number sentence on the board', text: 'The board in class shows 4 × (6 + 3). What story could these numbers and signs tell?',
        pictures: [eqD('4 × (6 + 3)')] },
      { title: 'Numbers alone are not a story', text: 'The board does not say what the 4, the 6 or the 3 count, or what the × and the + do. A story has to give every part a job.',
      ...
      { title: 'Then the 4 ×', text: '4 × means 4 of that whole bag. So the story is: 4 bags, each with 6 red marbles and 3 green marbles.',
        pictures: [tapeD([{ label: '1 bag', cells: groupsD(1, 6, 3), brace: '6 + 3' }, { label: '4 bags', cells: groupsD(4, 6, 3), brace: '4 × (6 + 3)' }], true)] },
      { title: 'Solve the story', text: 'One bag has 6 + 3 = 9 marbles. 4 bags have 4 × 9 = 36 marbles. The story and the board give the same answer.',
        pictures: [tapeD([{ label: '4 bags', cells: groupsD(4, 6, 3), brace: '36 marbles' }]), eqD('4 × (6 + 3)', ['= 4 × 9', '= 36'])] },
      { title: 'One thing not to do', text: "Don't let the story do the × first. 4 bags of 6 red marbles, plus 3 green ones, is 4 × 6 + 3. The ( ) put 3 green marbles in every bag.",
  ...
  // ── Topic 19 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The story hides a number', text: 'You want to share the markers among 18 classes. But how many markers are there in all? The story does not say. That number is hidden.',
      ...
      { title: 'Step 2: use it', text: 'Now share the 864 markers equally among 18 classes: 864 ÷ 18 = 48. Each class gets 48 markers.',
        pictures: [tapeD([boxesD('864 markers in all'), classesD('48')], true), eqD('864 ÷ 18 = 48')] },
      { title: 'Check it makes sense', text: '18 classes with 48 markers each: 18 × 48 = 864. That is all the markers in the 24 boxes. So each class gets 48 markers.',
        pictures: [tapeD([boxesD('864 markers in all'), classesD('48')]), eqD('18 × 48 = 864')] },
      { title: 'One thing not to do', text: "Don't stop at the hidden number. 864 is all the markers, not the markers for one class. Always finish with the question.",
  ...
  // ── Topic 20 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Three numbers, no sign yet', text: 'The story gives 32, 25 and 186. None of them is the number of empty seats. Pick a sign too soon, and you may answer a different question.',
        pictures: [tapeD([seatRowsD(), seatsD('? empty')])] },
      ...
      { title: 'Part 2: take away the sold seats', text: 'The 186 sold seats are one part of the 800. The empty seats are the other part. So take away: 800 − 186 = 614.',
        pictures: [tapeD([seatRowsD('800 seats'), seatsD('614 empty')], true), eqD('800 − 186 = 614')] },
      { title: 'Check what the question asks', text: 'The question asks for empty seats, not sold seats. Check: 614 empty and 186 sold make 800. So 614 seats are still empty.',
        pictures: [tapeD([seatRowsD('800 seats'), seatsD('614 empty')]), eqD('614 + 186 = 800')] },
      { title: 'One thing not to do', text: "Don't add the sold seats. They are part of the 800 seats, so take them away.",
