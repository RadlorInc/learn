...
export const G5M1: Lesson[] = [
  ...
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Adding takes too long', text: 'You could add 40 ten times. That works, but it takes a while, and it is really easy to lose count. There is a much faster way, and it lives right here in a chart of places.',
        beats: [
          { say: 'You could add 40 ten times.' },
          { say: 'That works, but it takes a while, and it is really easy to lose count.' },
          { say: 'There is a much faster way, and it lives right here in a chart of places.', pic: 0 },
        ],
        pictures: [chartA(4, ['40'])] },
      { title: 'The big idea', text: 'Move a digit one place to the left and it is worth 10 times as much. One place to the right, it is worth 1/10 as much.',
        beats: [
          { say: 'Move a digit one place to the left and it is worth 10 times as much.', pic: 0 },
          { say: 'One place to the right, it is worth 1/10 as much.' },
        ],
        pictures: [chartA(4, ['40', '400'])] },
      { title: 'Each place is 10 of the next', text: "Let's walk the places from the right. 10 ones make 1 ten. 10 tens make 1 hundred. And 10 hundreds make 1 thousand. Every step to the left is worth 10 times as much.",
        beats: [
          { say: "Let's walk the places from the right.", pic: 0 },
          { say: '10 ones make 1 ten. 10 tens make 1 hundred. And 10 hundreds make 1 thousand.', pic: 1 },
          { say: 'Every step to the left is worth 10 times as much.', write: 'one place left = × 10' },
        ],
      ...
      { title: 'Slide the 4 to the left', text: 'Look at 40. The 4 is sitting in the tens place, so it is 4 tens. Now slide it one place to the left. It lands in the hundreds, and it is 4 hundreds: 400. That slide is what 10 times as much looks like. A carton holds 400 pencils.',
        beats: [
          { say: 'Look at 40. The 4 is sitting in the tens place, so it is 4 tens.', pic: 0 },
          { say: 'Now slide it one place to the left. It lands in the hundreds, and it is 4 hundreds: 400.' },
          { say: 'That slide is what 10 times as much looks like. A carton holds 400 pencils.', pic: 1 },
        ],
        pictures: [chartA(4, ['40', '400'], [[1, 1]], true), eqA('10 × 40 = 400')] },
      { title: 'Slide it back to the right', text: 'Now let us go back the other way. One box is 1/10 of a carton. So slide the 4 in 400 one place to the right, back into the tens place. It is 40 again. And there it is: 1/10 of 400 is 40 pencils.',
        beats: [
          { say: 'Now let us go back the other way. One box is 1/10 of a carton.', pic: 0 },
          { say: 'So slide the 4 in 400 one place to the right, back into the tens place. It is 40 again.' },
          { say: 'And there it is: 1/10 of 400 is 40 pencils.', pic: 1 },
        ],
        pictures: [chartA(4, ['400', '40'], [[1, 2]], true), eqA('1/10 of 400 = 40')] },
      { title: 'One thing not to do', text: 'Here is the trap I want you to watch for. Ten times as much does not mean add 10. It slides every digit one place to the left.',
        beats: [
          { say: 'Here is the trap I want you to watch for.' },
          { say: 'Ten times as much does not mean add 10.', pic: 0 },
          { say: 'It slides every digit one place to the left.' },
        ],
    ...
    turn: {
      ...
      twin: { text: 'In 300, the 3 is in the hundreds place. What is the 3 worth if it slides one place to the left?',
        ...
        hint2: 'One place to the left is worth 10 times as much. What is 10 times 3 hundreds?' },
    },
    won: { text: 'You slid the 7 one place left and made it worth 10 times as much.', sticker: 'What a digit is worth in its place is its place value. Each place is worth 10 times the place to its right.' },
    twinWon: { text: 'You slid the 3 one place left, from 300 to 3,000.', sticker: 'What a digit is worth in its place is its place value. Each place is worth 10 times the place to its right.' },
    practice: [
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Count the zeros in 10, 100 or 1,000. That is how many places every digit slides: left to multiply, right to divide.',
    screens: [
      ...
      { title: 'Too many to add', text: 'Adding 37 one thousand times? That would take all day. There is a much faster way, and the best part is that it works for dividing too.',
        beats: [
          { say: 'Adding 37 one thousand times? That would take all day.', pic: 0 },
          { say: 'There is a much faster way, and the best part is that it works for dividing too.' },
        ],
        pictures: [chartA(5, ['37'])] },
      { title: 'The big idea', text: 'Count the zeros in 10, 100 or 1,000. That is how many places every digit slides: left to multiply, right to divide.',
        beats: [
          { say: 'Count the zeros in 10, 100 or 1,000.', pic: 0 },
          { say: 'That is how many places every digit slides: left to multiply, right to divide.' },
        ],
        pictures: [chartA(5, ['37', '37000'])] },
      { title: 'One zero, one place', text: 'Start with the easy one. 10 has just one zero. So 37 × 10 slides the 3 and the 7 one place to the left. Nothing is left in the ones, so a 0 fills that spot: 370.',
        beats: [
          { say: 'Start with the easy one. 10 has just one zero.', pic: 0 },
          { say: 'So 37 × 10 slides the 3 and the 7 one place to the left.', write: 'one zero → one place' },
          { say: 'Nothing is left in the ones, so a 0 fills that spot: 370.', pic: 1 },
        ],
        pictures: [chartA(5, ['37', '370'], [[1, 4]], true), eqA('37 × 10 = 370')] },
      { title: 'More zeros, more places', text: 'Now add a zero. 100 has two zeros, so the digits slide two places: 3,700. And 1,000 has three zeros, so they slide three places: 37,000. There is our answer. The shop has 37,000 beads.',
        beats: [
          { say: 'Now add a zero. 100 has two zeros, so the digits slide two places: 3,700.', pic: 0 },
          { say: 'And 1,000 has three zeros, so they slide three places: 37,000.' },
          { say: 'There is our answer. The shop has 37,000 beads.', pic: 1 },
        ],
        pictures: [chartA(5, ['37', '370', '3700', '37000'], [[1, 4], [2, 3], [2, 4], [3, 2], [3, 3], [3, 4]], true),
          eqA('37 × 10 = 370', ['37 × 100 = 3,700', '37 × 1,000 = 37,000'])] },
      { title: 'Dividing slides right', text: 'Now let us go backwards. The shop shares all 37,000 beads into 1,000 bags. 1,000 still has three zeros, so every digit slides three places, only this time to the right. The zeros slide right off the end, and 37 beads go in each bag.',
        beats: [
          { say: 'Now let us go backwards. The shop shares all 37,000 beads into 1,000 bags.', pic: 0 },
          { say: '1,000 still has three zeros, so every digit slides three places, only this time to the right.', write: 'divide → slide right' },
          { say: 'The zeros slide right off the end, and 37 beads go in each bag.', pic: 1 },
        ],
        pictures: [chartA(5, ['37000', '37'], [[1, 3], [1, 4]], true), eqA('37,000 ÷ 1,000 = 37')] },
      { title: 'One thing not to do', text: 'One more thing to watch out for. When you divide, do not slide to the left. Dividing makes the number smaller, so every digit slides to the right.',
        beats: [
          { say: 'One more thing to watch out for.' },
          { say: 'When you divide, do not slide to the left.', pic: 0 },
          { say: 'Dividing makes the number smaller, so every digit slides to the right.' },
        ],
    ...
    won: { text: 'You counted three zeros and slid every digit three places left.', sticker: 'The answer to a multiplication is the product. The answer to a division is the quotient.' },
    twinWon: { text: 'You counted two zeros and slid 29 two places left, to 2,900.', sticker: 'The answer to a multiplication is the product. The answer to a division is the quotient.' },
    practice: [
    ...
    screens: [
      ...
      { title: 'Round each number', text: 'Round each number at its biggest place. 28 is only 2 away from 30. Look how close that is. And 412 is only 12 away from 400. So 28 × 412 is close to 30 × 400.',
        beats: [
          ...
          { say: '28 is only 2 away from 30. Look how close that is.', pic: 0, effect: 'draw' },
          { say: 'And 412 is only 12 away from 400.', pic: 1, effect: 'draw' },
      ...
      { title: 'Dividing works the same way', text: 'Dividing works the very same way. 2,380 eggs go into crates of 58. Round 58 to the nearest ten, 60, and round 2,380 to the nearest hundred, 2,400. 24 ÷ 6 = 4, and 60 × 40 = 2,400. So it is about 40 crates.',
        beats: [
          ...
          { say: 'Round 58 to the nearest ten, 60, and round 2,380 to the nearest hundred, 2,400.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'A meter is much shorter', text: 'A kilometer is a long way. You could walk it, but it would take you a while. A meter? That is about one big step. So the run is only 5 kilometers, but it is going to be a lot of meters.',
        beats: [
          { say: 'A kilometer is a long way. You could walk it, but it would take you a while.', pic: 0, effect: 'draw' },
      ...
      { title: 'One kilometer is 1,000 meters', text: 'The kilometer is the bigger unit here. And 1 km is exactly the same length as 1,000 m. So every single kilometer of that run is 1,000 m.',
        beats: [
          { say: 'The kilometer is the bigger unit here.', pic: 0, effect: 'draw' },
      ...
      { title: 'Bigger unit: divide', text: 'Now, a runner has gone 3,000 m so far. Kilometers are bigger, so there are fewer of them. Fewer of them means we go the other way, and divide. 3,000 ÷ 1,000 = 3. That runner has gone 3 km.',
        beats: [
          { say: 'Now, a runner has gone 3,000 m so far.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The big idea', text: 'Change to the same unit first. Then solve the story one step at a time.',
        beats: [
          { say: 'Change to the same unit first.', pic: 0, effect: 'draw' },
      ...
      { title: 'First, the same unit', text: '1 L is 1,000 mL, so let us count that jug in milliliters. The jug holds 2 × 1,000 = 2,000 mL. Now the jug and the cups are both in milliliters.',
        beats: [
          { say: '1 L is 1,000 mL, so let us count that jug in milliliters.', pic: 0, effect: 'draw' },
      ...
      { title: 'Then, how many cups', text: 'Now the cups. 4 cups of 250 mL make 1,000 mL. The jug holds two of those thousands, so 2 × 4 = 8 cups. And that is exactly what 2,000 ÷ 250 asks.',
        beats: [
          { say: 'Now the cups. 4 cups of 250 mL make 1,000 mL.', pic: 0, effect: 'draw' },
      ...
      { title: 'Check the answer', text: 'Always check. 8 cups of 250 mL is 8 × 250 = 2,000 mL. That is 2 L, the whole jug, with nothing left over. You can fill 8 cups.',
        beats: [
          ...
          { say: 'That is 2 L, the whole jug, with nothing left over.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Not in the times tables', text: '6 × 128 is not a fact you know by heart, is it? And adding 128 six times takes a long time, where one slip changes the answer.',
        beats: [
          { say: '6 × 128 is not a fact you know by heart, is it?', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Break the big number into hundreds, tens and ones. Multiply each part, then add all the parts.',
        beats: [
          { say: 'Break the big number into hundreds, tens and ones.', pic: 0, effect: 'draw' },
      ...
      { title: 'Break 128 apart', text: '128 is 1 hundred, 2 tens and 8 ones. So split each row of 128 into three parts: 100, 20 and 8.',
        beats: [
          ...
          { say: 'So split each row of 128 into three parts: 100, 20 and 8.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'Multiply each part', text: 'Now take them one at a time. 6 × 1 hundred is 6 hundreds, so 6 × 100 = 600. 6 × 2 tens is 12 tens, so 6 × 20 = 120. And 6 × 8 = 48.',
        beats: [
          { say: 'Now take them one at a time. 6 × 1 hundred is 6 hundreds, so 6 × 100 = 600.', pic: 0, effect: 'draw' },
      ...
      { title: 'Add all the parts', text: 'Last move. Add the three parts: 600 + 120 + 48 = 768. So 6 × 128 = 768. There are 768 corn plants in the field.',
        beats: [
          { say: 'Last move. Add the three parts: 600 + 120 + 48 = 768.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 8 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Two digits this time', text: 'You can already multiply 115 by one digit. But 26 has two digits, and adding 115 twenty-six times would take far too long.',
        beats: [
          { say: 'You can already multiply 115 by one digit.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Break the two-digit number into tens and ones. Multiply by each part, then add the two answers.',
        beats: [
          { say: 'Break the two-digit number into tens and ones.', pic: 0, effect: 'draw' },
      ...
      { title: 'Break 26 apart', text: '26 is 2 tens and 6 ones. So 26 boxes are 20 boxes and 6 more boxes, and each box still holds 115 books.',
        beats: [
          ...
          { say: 'So 26 boxes are 20 boxes and 6 more boxes, and each box still holds 115 books.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'Multiply by each part', text: 'Start with the easy piece. 115 × 2 = 230. 20 is 10 times 2, so 115 × 20 is 10 times as much: 2,300. Then the ones: 115 × 6 = 690.',
        beats: [
          { say: 'Start with the easy piece. 115 × 2 = 230.', pic: 0, effect: 'draw' },
      ...
      { title: 'Add the two answers', text: 'Now add the two answers: 2,300 + 690 = 2,990. So 115 × 26 = 2,990. The shop gets 2,990 books.',
        beats: [
          { say: 'Now add the two answers: 2,300 + 690 = 2,990.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 9 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'A shorter way to write it', text: 'Breaking 23 into 20 and 3 works just fine. But writing out 124 × 20 and 124 × 3 takes a lot of space. Columns do the same work with much less writing.',
        beats: [
          { say: 'Breaking 23 into 20 and 3 works just fine.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Multiply by the ones, then write a 0 and multiply by the tens. Add the two rows.',
        beats: [
          { say: 'Multiply by the ones, then write a 0 and multiply by the tens.', pic: 0, effect: 'draw' },
      ...
      { title: 'Times the 3 ones', text: 'First row first. Multiply 124 by the 3 ones. 4 × 3 = 12, so write the 2 and carry the 1. 2 × 3 = 6, plus the carried 1 makes 7. And 1 × 3 = 3. The first row is 372.',
        beats: [
          { say: 'First row first. Multiply 124 by the 3 ones.', pic: 0, effect: 'draw' },
      ...
      { title: 'Times the 2 tens', text: 'Now the 2 in 23. It is not 2, it is 2 tens. So write a 0 in the ones place first, to hold it there. Then 124 × 2 = 248, and the second row is 2,480.',
        beats: [
          ...
          { say: 'So write a 0 in the ones place first, to hold it there.', pic: 0, effect: 'draw' },
      ...
      { title: 'Add the two rows', text: 'Now add them. 372 + 2,480 = 2,852. And look: those rows are 124 × 3 and 124 × 20, the same two parts as breaking 23 apart. There are 2,852 chairs in the hall.',
        beats: [
          { say: 'Now add them. 372 + 2,480 = 2,852.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 10 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Two rows are not enough', text: 'For a two-digit number you made two rows: the ones and the tens. But 123 has three digits, so there are hundreds to deal with too.',
        beats: [
          { say: 'For a two-digit number you made two rows: the ones and the tens.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Make one row for each digit of the bottom number, and start each new row with one more 0. Then add all the rows.',
        beats: [
          { say: 'Make one row for each digit of the bottom number, and start each new row with one more 0.', pic: 0, effect: 'draw' },
          { say: 'Then add all the rows.' },
        ],
        pictures: [askB('231', '123')] },
      { title: 'The ones row', text: 'Start with the 3 ones: 231 × 3. 1 × 3 = 3, 3 × 3 = 9 and 2 × 3 = 6. The first row is 693.',
        beats: [
          { say: 'Start with the 3 ones: 231 × 3.', pic: 0, effect: 'draw' },
      ...
      { title: 'The tens row', text: 'Next the 2 in 123. That 2 means 2 tens, so write one 0 first. Then 231 × 2 = 462, and the second row is 4,620.',
        beats: [
          { say: 'Next the 2 in 123. That 2 means 2 tens, so write one 0 first.', pic: 0, effect: 'draw' },
      ...
      { title: 'The hundreds row, then add', text: 'Last row. The 1 in 123 means 1 hundred, so this time write two 0s first. Then 231 × 1 = 231, and the row is 23,100. Add all three rows: 693 + 4,620 + 23,100 = 28,413 bottles.',
        beats: [
          ...
          { say: 'Add all three rows: 693 + 4,620 + 23,100 = 28,413 bottles.', pic: 0, effect: 'draw' },
        ],
  ...
  // ── Topic 11 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'One slip can go far', text: 'You can already multiply 406 × 35 the standard way. But with big numbers, one small slip, like a lost 0, can throw the answer a long way off. And the worst part is that it still looks like a real answer.',
        beats: [
          { say: 'You can already multiply 406 × 35 the standard way.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Estimate first with round numbers. Then multiply the standard way and check that your answer is close.',
        beats: [
          { say: 'Estimate first with round numbers.', pic: 0, effect: 'draw' },
      ...
      { title: 'Estimate first', text: 'Round each number to its biggest place. 406 rounds to 400, and 35 rounds to 40. 400 × 40 = 16,000, so our answer should land somewhere close to 16,000.',
        beats: [
          { say: 'Round each number to its biggest place. 406 rounds to 400, and 35 rounds to 40.', pic: 0, effect: 'draw' },
      ...
      { title: 'Multiply the standard way', text: 'Now the real thing. The ones row is 406 × 5 = 2,030. For the tens row, write a 0 first, then 406 × 3 = 1,218. The row is 12,180.',
        beats: [
          { say: 'Now the real thing. The ones row is 406 × 5 = 2,030.', pic: 0, effect: 'draw' },
      ...
      { title: 'Add, then check', text: 'Add them: 2,030 + 12,180 = 14,210. Now the check. That is close to 16,000, so the answer makes sense. The warehouse ships 14,210 toys.',
        beats: [
          { say: 'Add them: 2,030 + 12,180 = 14,210.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 12 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: '240 is 24 tens', text: 'Each small step on this line is 10. Jump 10 tens to 100, 10 more tens to 200, then 4 tens to 240. Count them all up, and that is 24 tens.',
        beats: [
          { say: 'Each small step on this line is 10.', pic: 0, effect: 'draw' },
      ...
      { title: '60 is 6 tens', text: 'Now one bus. It seats 60 students. 60 is 6 small steps, so it is 6 tens. One busload is one jump of 6 tens.',
        beats: [
          { say: 'Now one bus. It seats 60 students.', pic: 0, effect: 'draw' },
      ...
      { title: 'Count the jumps', text: 'So jump 6 tens at a time, all the way from 0 to 240. It takes 4 jumps, because 24 ÷ 6 = 4. So 240 ÷ 60 = 4. The students fill 4 buses.',
        beats: [
          { say: 'So jump 6 tens at a time, all the way from 0 to 240.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 13 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'No facts for 17s', text: 'You learned your facts up to 10 × 10, but nobody learns the 17s. And counting 17, 34, 51 and on is slow, and it is hard to keep track.',
        beats: [
          { say: 'You learned your facts up to 10 × 10, but nobody learns the 17s.', pic: 0, effect: 'draw' },
          { say: 'And counting 17, 34, 51 and on is slow, and it is hard to keep track.' },
        ],
        pictures: [kidsC] },
      { title: 'The big idea', text: IDEA13C,
        beats: [
          { say: 'Round the number you divide by to the nearest ten and make a guess.', pic: 0, effect: 'draw' },
      ...
      { title: 'Make a guess', text: '17 is close to 20, so let us guess with 20s. How many 20s fit into 68? 3 × 20 = 60, and 4 × 20 = 80 is too many. So our guess is 3 teams.',
        beats: [
          { say: '17 is close to 20, so let us guess with 20s.', pic: 0, effect: 'draw' },
      ...
      { title: 'Check the guess', text: 'Now check with the real team size: 3 × 17 = 51. Take it away: 68 − 51 = 17. There are 17 kids left.',
        beats: [
          { say: 'Now check with the real team size: 3 × 17 = 51.', pic: 0, effect: 'draw' },
      ...
      { title: 'One more team', text: 'Wait. 17 kids left is a whole team, so the guess was too small. Add one more team: 4 × 17 = 68, with no one left out. So 68 ÷ 17 = 4. The coach makes 4 teams.',
        beats: [
          { say: 'Wait. 17 kids left is a whole team, so the guess was too small.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 14 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The first digits are too small', text: 'You usually start dividing with the first digit, or the first two. But 23 does not fit into 1, and it does not fit into 18 either.',
        beats: [
          { say: 'You usually start dividing with the first digit, or the first two.', pic: 0, effect: 'draw' },
          { say: 'But 23 does not fit into 1, and it does not fit into 18 either.' },
        ],
        pictures: [rosesC()] },
      { title: 'The big idea', text: IDEA14C,
        beats: [
          { say: 'If the number you divide by does not fit into the first two digits, the answer has one digit.', pic: 0, effect: 'draw' },
      ...
      { title: 'Only one digit', text: '23 does not fit into 18 tens, so the answer has no tens at all. It has just one digit, and that digit goes up over the 4.',
        beats: [
          { say: '23 does not fit into 18 tens, so the answer has no tens at all.', pic: 0, effect: 'draw' },
      ...
      { title: 'Guess with round numbers', text: '23 is close to 20, so guess with 20s. How many 20s fit into 184? 9 × 20 = 180, so guess 9. Now check with the real number: 9 × 23 = 207. That is more than 184, so 9 is too big.',
        beats: [
          { say: '23 is close to 20, so guess with 20s. How many 20s fit into 184?', pic: 0, effect: 'draw' },
      ...
      { title: 'Try one less', text: 'So try one less. 8 × 23 = 184. It fits exactly, with 0 left. Write the 8 over the 4. So 184 ÷ 23 = 8. The shop makes 8 bunches.',
        beats: [
          ...
          { say: 'It fits exactly, with 0 left. Write the 8 over the 4.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 15 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Too much for one guess', text: 'This time 13 does fit into 31, the first two digits of 312. So the answer has a tens digit and a ones digit. That is too much to find with one guess.',
        beats: [
          { say: 'This time 13 does fit into 31, the first two digits of 312.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: IDEA15C,
        beats: [
          { say: 'Divide the tens first and take away.', pic: 0, effect: 'draw' },
      ...
      { title: 'Divide the tens', text: 'Start with the 31 tens. 2 × 13 = 26 fits, and 3 × 13 = 39 is too many. So write the 2 over the 1. Take away: 31 − 26 = 5.',
        beats: [
          ...
          { say: 'So write the 2 over the 1. Take away: 31 − 26 = 5.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'Bring down the ones', text: '5 tens are left over. Now bring down the 2 ones and write it beside the 5. Now there are 52 to divide.',
        beats: [
          { say: '5 tens are left over. Now bring down the 2 ones and write it beside the 5.', pic: 0, effect: 'draw' },
      ...
      { title: 'Divide the ones', text: 'Round two. 4 × 13 = 52, so write the 4 over the 2. Take away: 52 − 52 = 0. So 312 ÷ 13 = 24. The store fills 24 cartons.',
        beats: [
          { say: 'Round two. 4 × 13 = 52, so write the 4 over the 2.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 16 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Where do you start?', text: 'The first two digits of 1,176 make 11, and 24 does not fit into 11. And if the answer starts one place too far left, every digit of it lands one place off.',
        beats: [
          { say: 'The first two digits of 1,176 make 11, and 24 does not fit into 11.', pic: 0, effect: 'draw' },
          { say: 'And if the answer starts one place too far left, every digit of it lands one place off.' },
        ],
        pictures: [stickersC()] },
      { title: 'The big idea', text: IDEA16C,
        beats: [
          { say: 'Find where to start: if the number you divide by does not fit into the first two digits, start with the first three.', pic: 0, effect: 'draw' },
      ...
      { title: 'Find where to start', text: 'Walk it with me. 24 does not fit into 1 or into 11. It does fit into 117, the first three digits. So the first digit of the answer goes over the 7.',
        beats: [
          ...
          { say: 'So the first digit of the answer goes over the 7.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'Divide, take away, bring down', text: '4 × 24 = 96 fits into 117, and 5 × 24 = 120 is too many. Write the 4 over the 7, and take away: 117 − 96 = 21. Then bring down the 6 to make 216.',
        beats: [
          { say: '4 × 24 = 96 fits into 117, and 5 × 24 = 120 is too many.', pic: 0, effect: 'draw' },
      ...
      { title: 'The last digit', text: 'One more round. 9 × 24 = 216, so write the 9 over the 6. 216 − 216 = 0, and no digits are left to bring down. So 1,176 ÷ 24 = 49. Each kid gets 49 stickers.',
        beats: [
          { say: 'One more round. 9 × 24 = 216, so write the 9 over the 6.', pic: 0, effect: 'draw' },
    ...
    screens: [
      ...
      { title: 'A long way to write it', text: 'You could add up every single piece: 4 + 2 + 4 + 2 + 4 + 2. That is long to write, and it hides the best part, which is that the 3 bags are all the same.',
        beats: [
          ...
          { say: 'That is long to write, and it hides the best part, which is that the 3 bags are all the same.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'The big idea', text: 'The ( ) keep together what goes together. 3 × (4 + 2) means 3 times as much as 4 + 2.',
        beats: [
          { say: 'The ( ) keep together what goes together.', pic: 0, effect: 'draw' },
      ...
      { title: 'Keep one bag together', text: 'Start with one bag. It has 4 apples and 2 pears, so that is 4 + 2. Now put ( ) around it, so the whole bag stays together.',
        beats: [
          { say: 'Start with one bag. It has 4 apples and 2 pears, so that is 4 + 2.', pic: 0, effect: 'draw' },
      ...
      { title: 'Three of the whole bag', text: 'There are 3 bags, all the same, so we write 3 × (4 + 2). It means 3 times as much as 4 + 2. One bag is 6, so 3 bags are 18.',
        beats: [
          { say: 'There are 3 bags, all the same, so we write 3 × (4 + 2).', pic: 0, effect: 'draw' },
      ...
      { title: 'Compare without working it out', text: 'Now look at these two: 3 × (4 + 2) and 3 × 4 + 2. Both have 3 bags of 4 apples. But the first one has 2 pears in every bag. The second has just 2 pears in all. So the first one is more.',
        beats: [
          { say: 'Now look at these two: 3 × (4 + 2) and 3 × 4 + 2.', pic: 0, effect: 'draw' },
    ...
    screens: [
      ...
      { title: 'Start with the ( )', text: 'The ( ) happen first, so they make one thing in the story. Make 6 + 3 one bag: 6 red marbles and 3 green marbles.',
        beats: [
          ...
          { say: 'Make 6 + 3 one bag: 6 red marbles and 3 green marbles.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'Then the 4 ×', text: 'Now the 4 ×. That means 4 of that whole bag. So the story is 4 bags, each with 6 red marbles and 3 green marbles.',
        beats: [
          { say: 'Now the 4 ×. That means 4 of that whole bag.', pic: 0, effect: 'draw' },
      ...
      { title: 'Solve the story', text: 'Let us solve it. One bag has 6 + 3 = 9 marbles. And 4 bags have 4 × 9 = 36 marbles. The story and the board give the same answer.',
        beats: [
          { say: 'Let us solve it. One bag has 6 + 3 = 9 marbles.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 19 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The story hides a number', text: 'We want to share the markers among 18 classes. But how many markers are there in all? The story never says. That number is hidden, and we have to find it first.',
        beats: [
          { say: 'We want to share the markers among 18 classes.', pic: 0, effect: 'draw' },
      ...
      { title: 'Step 1: find the hidden number', text: '24 boxes, with 36 markers in each one. 24 × 36 = 864, so there are 864 markers in all.',
        beats: [
          { say: '24 boxes, with 36 markers in each one.', pic: 0, effect: 'draw' },
      ...
      { title: 'Step 2: use it', text: 'Now we can answer the real question. Share the 864 markers equally among 18 classes: 864 ÷ 18 = 48. Each class gets 48 markers.',
        beats: [
          { say: 'Now we can answer the real question.', pic: 0, effect: 'draw' },
      ...
      { title: 'Check it makes sense', text: 'Let us check it. 18 classes with 48 markers each is 18 × 48 = 864. That is every marker in the 24 boxes. So each class gets 48 markers.',
        beats: [
          ...
          { say: 'That is every marker in the 24 boxes.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 20 ─────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Three numbers, no sign yet', text: 'The story gives us 32, 25 and 186. None of them is the number of empty seats. Pick a sign too soon, and you may answer a different question.',
        beats: [
          { say: 'The story gives us 32, 25 and 186.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Draw the story as a tape. Solve one part at a time, then check what the question asks.',
        beats: [
          { say: 'Draw the story as a tape.', pic: 0, effect: 'draw' },
      ...
      { title: 'Part 1: all the seats', text: '32 rows of 25 seats make one long tape. 32 × 25 = 800, so the theater has 800 seats.',
        beats: [
          { say: '32 rows of 25 seats make one long tape.', pic: 0, effect: 'draw' },
      ...
      { title: 'Part 2: take away the sold seats', text: 'The 186 sold seats are one part of the 800, and the empty seats are the other part. So we take away: 800 − 186 = 614.',
        beats: [
          { say: 'The 186 sold seats are one part of the 800, and the empty seats are the other part.', pic: 0, effect: 'draw' },
      ...
      { title: 'Check what the question asks', text: 'Now read the question again. It asks for empty seats, not sold seats. Check it: 614 empty and 186 sold make 800. So 614 seats are still empty.',
        beats: [
          { say: 'Now read the question again. It asks for empty seats, not sold seats.', pic: 0, effect: 'draw' },
