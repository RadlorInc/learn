  ...
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Counting stars is not enough', text: "Count Mia's stars with me. There are 3 of them. But here is the catch: she did not read 3 books. Look at the little line under the graph. It says each star is 2 books.",
        beats: [
          { say: "Count Mia's stars with me. There are 3 of them.", pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Each star stands for 2. Count the stars by 2s, and a half star is 1.',
        beats: [
          { say: 'Each star stands for 2.', pic: 0, effect: 'draw' },
      ...
      { title: 'Count by 2s', text: 'Mia has 3 stars in her row. Count them by 2s, one star at a time. 2, 4, 6. So Mia read 6 books.',
        beats: [
          { say: 'Mia has 3 stars in her row.', pic: 0, effect: 'draw' },
      ...
      { title: 'Half a star', text: 'Now look at Ava. She has 2 whole stars and a half star. Count the whole stars first: 2, 4. Half a star is half of 2, so it is 1 more. Ava read 5 books.',
        beats: [
          { say: 'Now look at Ava. She has 2 whole stars and a half star.', pic: 0, effect: 'draw' },
      ...
      { title: 'How many more?', text: 'Now, how many more books did Mia read than Leo? We know Mia read 6, and Leo has 2 stars, so Leo read 4. How many more means we subtract. 6 − 4 = 2. Mia read 2 more books than Leo.',
        beats: [
          { say: 'Now, how many more books did Mia read than Leo?', pic: 0, effect: 'draw' },
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The lines do not count by 1', text: 'Count the lines up the grapes bar. It is 7 lines tall. But careful, 7 kids did not choose grapes. Look at the numbers running up the side. They go 0, 5, 10, 15, so every line is 5 kids.',
        beats: [
          { say: 'Count the lines up the grapes bar. It is 7 lines tall.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Go from the top of the bar straight across to the numbers on the side. Check what those numbers count by.',
        beats: [
          { say: 'Go from the top of the bar straight across to the numbers on the side.', pic: 0, effect: 'draw' },
      ...
      { title: 'Across to the side', text: 'Put your finger on the top of the grapes bar. Now slide it straight across to the numbers on the side. It lands right on 35. So 35 kids chose grapes.',
        beats: [
          { say: 'Put your finger on the top of the grapes bar.', pic: 0, effect: 'draw' },
      ...
      { title: 'Now the pears', text: 'Now do the same thing for pears. Top of the bar, straight across. It lands on 15, so 15 kids chose pears.',
        beats: [
          { say: 'Now do the same thing for pears.', pic: 0, effect: 'draw' },
      ...
      { title: 'How many more?', text: 'So we have 35 kids for grapes and 15 for pears. The question asks how many more, so we subtract. 35 − 15 = 20. That is 20 more kids for grapes.',
        beats: [
          { say: 'So we have 35 kids for grapes and 15 for pears.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'It stops between two numbers', text: 'Look at the end of the crayon. It does not stop on a number. It stops somewhere between 2 and 3. So we need a way to say exactly where it stopped.',
        beats: [
          { say: 'Look at the end of the crayon. It does not stop on a number.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Start at 0. Count the whole inches, then add the part of an inch past the last one.',
        beats: [
          { say: 'Start at 0.', pic: 0, effect: 'draw' },
      ...
      { title: 'Whole inches first', text: 'Always start at 0, right at the end of the crayon. Follow it along: past 1, past 2, but it never reaches 3. So that is 2 whole inches, and a little bit more.',
        beats: [
          { say: 'Always start at 0, right at the end of the crayon.', pic: 0, effect: 'draw' },
      ...
      { title: 'Then the part past the inch', text: 'Now look at just the inch from 2 to 3. It is cut into 2 equal parts by that middle mark. The crayon stops right on the middle mark, which is half of an inch. So the crayon is 2 1/2 inches long.',
        beats: [
          { say: 'Now look at just the inch from 2 to 3.', pic: 0, effect: 'draw' },
      ...
      { title: 'Quarter inches', text: 'Here is a different ruler. This one cuts every inch into 4 equal parts, so each small part is a quarter inch. The pencil goes past 1, then 3 small parts more. That makes it 1 3/4 inches long.',
        beats: [
          { say: 'Here is a different ruler.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The big idea', text: 'Each ✕ is one thing we measured. It sits above its length, so count the ✕s to answer.',
        beats: [
          { say: 'Each ✕ is one thing we measured.', pic: 0, effect: 'draw' },
      ...
      { title: 'Put the lengths in order', text: 'We are going to build a better picture. First draw a line, and write the lengths along it in order, a half inch apart: 4, 4 1/2, 5, 5 1/2, 6.',
        beats: [
          ...
          { say: 'First draw a line, and write the lengths along it in order, a half inch apart: 4, 4 1/2, 5, 5 1/2, 6.', pic: 0, effect: 'draw' },
        ],
      ...
      { title: 'One ✕ for each pencil', text: 'Now take the pencils one at a time. Each pencil gets one ✕, put above its own length. 7 pencils, so we end up with 7 ✕s.',
        beats: [
          { say: 'Now take the pencils one at a time.', pic: 0, effect: 'draw' },
      ...
      { title: 'Now count', text: 'Now the picture answers our question fast. See the 3 ✕s sitting above 4 1/2? That means 3 pencils are 4 1/2 inches long. We were asked for longer than 5 inches, so look to the right of 5. There is just 1 ✕ there, so 1 pencil is longer than 5 inches.',
        beats: [
          { say: 'Now the picture answers our question fast.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: '4 sides is not enough', text: 'Every one of these tiles has 4 sides, and yet they do not look the same at all. So 4 sides on its own does not tell us much. To tell them apart, we have to look closer.',
        beats: [
          { say: 'Every one of these tiles has 4 sides, and yet they do not look the same at all.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Check the sides and the corners. Are all 4 sides the same length? Are all 4 corners square corners?',
        beats: [
          { say: 'Check the sides and the corners.', pic: 0, effect: 'draw' },
      ...
      { title: 'Look at the corners', text: 'Start with the corners. A small square drawn in a corner means it is a square corner, like the corner of a book. Look at the top two tiles. All 4 of their corners have that mark.',
        beats: [
          { say: 'Start with the corners.', pic: 0, effect: 'draw' },
      ...
      { title: 'Look at the sides', text: 'Now the sides. A little tick mark on a side means that side is the same length as the other ticked sides. The top left tile has 4 ticks, and so does the leaning tile. Both of them have 4 equal sides.',
        beats: [
          { say: 'Now the sides.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Around the edge', text: 'Think about where the fence actually goes. It runs all the way around the edge of the garden, not across the middle. So what we need is how long that whole edge is.',
        beats: [
          { say: 'Think about where the fence actually goes.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'The distance around a shape is all of its sides added together.',
        beats: [
          { say: 'The distance around a shape is all of its sides added together.', pic: 0, effect: 'draw' },
        ],
        pictures: [{ kind: 'poly', shapes: [{ pts: GARDEN, sides: ['5 ft', '3 ft', '5 ft', '3 ft'], right: ALL4, tone: 1 }] }] },
      { title: 'Walk around', text: "Let's walk it together. Start at one corner and follow every side all the way back to where you started. 5 feet, 3 feet, 5 feet, 3 feet, and we are home.",
        beats: [
          { say: "Let's walk it together.", pic: 0, effect: 'draw' },
      ...
      { title: 'Add the sides', text: 'Now add up every side you walked. All 4 of them, not just the two different numbers. 5 + 3 + 5 + 3 = 16. So Sam needs 16 feet of fence.',
        beats: [
          { say: 'Now add up every side you walked.', pic: 0, effect: 'draw' },
      ...
      { title: 'A side with no number', text: 'Sometimes a side is left blank, like this one with a question mark on it. In a rectangle, the sides across from each other are always the same length. The side across from the ? is 5 feet, so the ? is 5 feet too.',
        beats: [
          { say: 'Sometimes a side is left blank, like this one with a question mark on it.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Same fence, same inside?', text: 'It feels obvious, does it not? Same fence, so the same room inside. But feeling sure is not the same as knowing, so let us count and check.',
        beats: [
          { say: 'It feels obvious, does it not? Same fence, so the same room inside.', pic: 0, effect: 'draw' },
          { say: 'But feeling sure is not the same as knowing, so let us count and check.', pic: 1, effect: 'draw' },
        ],
        pictures: [{ kind: 'grid', rows: 1, cols: 5, top: '5 ft', left: '1 ft' }, { kind: 'grid', rows: 2, cols: 4, top: '4 ft', left: '2 ft' }] },
      ...
      { title: 'Walk the fence', text: 'First we check that the fences really are the same. Walk around the long thin garden: 5 + 1 + 5 + 1 = 12. Now the wider one: 4 + 2 + 4 + 2 = 12. Both fences are 12 feet.',
        beats: [
          ...
          { say: 'Walk around the long thin garden: 5 + 1 + 5 + 1 = 12.', pic: 0, effect: 'draw' },
          { say: 'Now the wider one: 4 + 2 + 4 + 2 = 12.', pic: 1, effect: 'draw' },
      ...
      { title: 'Count the squares inside', text: 'Now count what is inside each one. The long thin garden is one row of 5, so it holds 5 squares. The wider garden has 2 rows of 4, and that is 8 squares. Same fence, and not the same room inside at all.',
        beats: [
          ...
          { say: 'The long thin garden is one row of 5, so it holds 5 squares.', pic: 0, effect: 'draw' },
          { say: 'The wider garden has 2 rows of 4, and that is 8 squares.', pic: 1, effect: 'draw' },
      ...
      { title: 'One more garden', text: "Let's try one more. A garden 3 feet by 3 feet uses 12 feet of fence too. Count inside: 3 rows of 3, which is 9 squares. That is the most room of all three, and it is the square one.",
        beats: [
          ...
          { say: 'A garden 3 feet by 3 feet uses 12 feet of fence too.', pic: 0, effect: 'draw' },
