...
export const G3M6: Lesson[] = [
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Books we read', text: 'This picture graph shows how many books three friends read. How many books did Mia read?',
        pictures: [BOOKS] },
      { title: 'Counting stars is not enough', text: "Count Mia's stars with me. There are 3 of them. But here is the catch: she did not read 3 books. Look at the little line under the graph. It says each star is 2 books.",
        beats: [
          { say: "Count Mia's stars with me. There are 3 of them.", pic: 0 },
          { say: 'But here is the catch: she did not read 3 books.', write: 'a star is worth more than 1' },
          { say: 'Look at the little line under the graph. It says each star is 2 books.' },
        ],
        pictures: [BOOKS] },
      { title: 'The big idea', text: 'Each star stands for 2. Count the stars by 2s, and a half star is 1.',
        beats: [
          { say: 'Each star stands for 2.', pic: 0 },
          { say: 'Count the stars by 2s, and a half star is 1.' },
        ],
        pictures: [BOOKS] },
      { title: 'Count by 2s', text: 'Mia has 3 stars in her row. Count them by 2s, one star at a time. 2, 4, 6. So Mia read 6 books.',
        beats: [
          { say: 'Mia has 3 stars in her row.', pic: 0 },
          { say: 'Count them by 2s, one star at a time.', write: 'count the stars by 2s' },
          { say: '2, 4, 6. So Mia read 6 books.', pic: 1 },
        ],
        pictures: [{ ...BOOKS, motion: true }, { kind: 'eq', text: '2, 4, 6' }] },
      { title: 'Half a star', text: 'Now look at Ava. She has 2 whole stars and a half star. Count the whole stars first: 2, 4. Half a star is half of 2, so it is 1 more. Ava read 5 books.',
        beats: [
          { say: 'Now look at Ava. She has 2 whole stars and a half star.', pic: 0 },
          { say: 'Count the whole stars first: 2, 4.', write: 'whole stars first, then the half' },
          { say: 'Half a star is half of 2, so it is 1 more. Ava read 5 books.', pic: 1 },
        ],
        pictures: [BOOKS, { kind: 'eq', text: '2 + 2 + 1 = 5' }] },
      { title: 'How many more?', text: 'Now, how many more books did Mia read than Leo? We know Mia read 6, and Leo has 2 stars, so Leo read 4. How many more means we subtract. 6 − 4 = 2. Mia read 2 more books than Leo.',
        beats: [
          { say: 'Now, how many more books did Mia read than Leo?', pic: 0 },
          { say: 'We know Mia read 6, and Leo has 2 stars, so Leo read 4.' },
          { say: 'How many more means we subtract.', write: 'how many more → subtract' },
          { say: '6 − 4 = 2. Mia read 2 more books than Leo.', pic: 1 },
        ],
        pictures: [BOOKS, { kind: 'eq', text: '6 − 4 = 2' }] },
      { title: 'One thing not to do', text: "Here is the slip almost everybody makes. Don't count each star as 1. Mia's 3 stars are 6 books, not 3 books.",
        beats: [
          { say: 'Here is the slip almost everybody makes.' },
          { say: "Don't count each star as 1.", pic: 0 },
          { say: "Mia's 3 stars are 6 books, not 3 books." },
        ],
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Favorite fruit', text: 'A class voted for their favorite fruit. The bars show the votes. How many more kids chose grapes than pears?',
        pictures: [FRUIT] },
      { title: 'The lines do not count by 1', text: 'Count the lines up the grapes bar. It is 7 lines tall. But careful, 7 kids did not choose grapes. Look at the numbers running up the side. They go 0, 5, 10, 15, so every line is 5 kids.',
        beats: [
          { say: 'Count the lines up the grapes bar. It is 7 lines tall.', pic: 0 },
          { say: 'But careful, 7 kids did not choose grapes.', write: 'a line is not always 1' },
          { say: 'Look at the numbers running up the side. They go 0, 5, 10, 15, so every line is 5 kids.' },
        ],
        pictures: [FRUIT] },
      { title: 'The big idea', text: 'Go from the top of the bar straight across to the numbers on the side. Check what those numbers count by.',
        beats: [
          { say: 'Go from the top of the bar straight across to the numbers on the side.', pic: 0 },
          { say: 'Check what those numbers count by.' },
        ],
        pictures: [FRUIT] },
      { title: 'Across to the side', text: 'Put your finger on the top of the grapes bar. Now slide it straight across to the numbers on the side. It lands right on 35. So 35 kids chose grapes.',
        beats: [
          { say: 'Put your finger on the top of the grapes bar.', pic: 0 },
          { say: 'Now slide it straight across to the numbers on the side.', write: 'top of the bar → straight across' },
          { say: 'It lands right on 35. So 35 kids chose grapes.' },
        ],
        pictures: [{ ...FRUIT, motion: true }] },
      { title: 'Now the pears', text: 'Now do the same thing for pears. Top of the bar, straight across. It lands on 15, so 15 kids chose pears.',
        beats: [
          { say: 'Now do the same thing for pears.', pic: 0 },
          { say: 'Top of the bar, straight across.' },
          { say: 'It lands on 15, so 15 kids chose pears.' },
        ],
        pictures: [FRUIT] },
      { title: 'How many more?', text: 'So we have 35 kids for grapes and 15 for pears. The question asks how many more, so we subtract. 35 − 15 = 20. That is 20 more kids for grapes.',
        beats: [
          { say: 'So we have 35 kids for grapes and 15 for pears.', pic: 0 },
          { say: 'The question asks how many more, so we subtract.', write: 'how many more → subtract' },
          { say: '35 − 15 = 20. That is 20 more kids for grapes.', pic: 1 },
        ],
        pictures: [FRUIT, { kind: 'eq', text: '35 − 15 = 20' }] },
      { title: 'One thing not to do', text: "Here is the one that catches people. Don't count the lines by 1s. Each line on this graph is 5 more, so the grapes bar is 35, not 7.",
        beats: [
          { say: 'Here is the one that catches people.' },
          { say: "Don't count the lines by 1s.", pic: 0 },
          { say: 'Each line on this graph is 5 more, so the grapes bar is 35, not 7.' },
        ],
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'It stops between two numbers', text: 'Look at the end of the crayon. It does not stop on a number. It stops somewhere between 2 and 3. So we need a way to say exactly where it stopped.',
        beats: [
          { say: 'Look at the end of the crayon. It does not stop on a number.', pic: 0 },
          { say: 'It stops somewhere between 2 and 3.' },
          { say: 'So we need a way to say exactly where it stopped.' },
        ],
        pictures: [{ kind: 'measure', tool: 'ruler', max: 4, step: 0.5, labelEvery: 1, value: 2.5, unit: 'inches' }] },
      { title: 'The big idea', text: 'Start at 0. Count the whole inches, then add the part of an inch past the last one.',
        beats: [
          { say: 'Start at 0.', pic: 0 },
          { say: 'Count the whole inches, then add the part of an inch past the last one.' },
        ],
        pictures: [{ kind: 'measure', tool: 'ruler', max: 4, step: 0.5, labelEvery: 1, value: 2.5, unit: 'inches' }] },
      { title: 'Whole inches first', text: 'Always start at 0, right at the end of the crayon. Follow it along: past 1, past 2, but it never reaches 3. So that is 2 whole inches, and a little bit more.',
        beats: [
          { say: 'Always start at 0, right at the end of the crayon.', pic: 0 },
          { say: 'Follow it along: past 1, past 2, but it never reaches 3.', write: 'whole inches first' },
          { say: 'So that is 2 whole inches, and a little bit more.' },
        ],
        pictures: [{ kind: 'measure', tool: 'ruler', max: 4, step: 0.5, labelEvery: 1, value: 2.5, unit: 'inches' }] },
      { title: 'Then the part past the inch', text: 'Now look at just the inch from 2 to 3. It is cut into 2 equal parts by that middle mark. The crayon stops right on the middle mark, which is half of an inch. So the crayon is 2 1/2 inches long.',
        beats: [
          { say: 'Now look at just the inch from 2 to 3.', pic: 0 },
          { say: 'It is cut into 2 equal parts by that middle mark.' },
          { say: 'The crayon stops right on the middle mark, which is half of an inch.' },
      ...
      { title: 'Quarter inches', text: 'Here is a different ruler. This one cuts every inch into 4 equal parts, so each small part is a quarter inch. The pencil goes past 1, then 3 small parts more. That makes it 1 3/4 inches long.',
        beats: [
          { say: 'Here is a different ruler.', pic: 0 },
          { say: 'This one cuts every inch into 4 equal parts, so each small part is a quarter inch.', write: '4 equal parts → quarters' },
          { say: 'The pencil goes past 1, then 3 small parts more.' },
          { say: 'That makes it 1 3/4 inches long.', pic: 1 },
        ],
      ...
      { title: 'One thing not to do', text: "Here is the mix-up to watch for. Don't count every mark on the ruler as a whole inch. Those small marks are only parts of an inch, so 5 half inches make 2 1/2 inches, not 5.",
        beats: [
          { say: 'Here is the mix-up to watch for.' },
          { say: "Don't count every mark on the ruler as a whole inch.", pic: 0 },
          { say: 'Those small marks are only parts of an inch, so 5 half inches make 2 1/2 inches, not 5.' },
        ],
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Our pencils', text: 'We measured 7 pencils. Here are their lengths in inches. How many pencils are longer than 5 inches?',
        pictures: [LENGTHS] },
      { title: 'A list is hard to read', text: 'Look at that list again. The lengths are all jumbled up. It is hard to see how many pencils are the same, and harder still to see which ones are longer.',
        beats: [
          { say: 'Look at that list again. The lengths are all jumbled up.', pic: 0 },
          { say: 'It is hard to see how many pencils are the same, and harder still to see which ones are longer.', write: 'a list hides the pattern' },
        ],
        pictures: [LENGTHS] },
      { title: 'The big idea', text: 'Each ✕ is one thing we measured. It sits above its length, so count the ✕s to answer.',
        beats: [
          { say: 'Each ✕ is one thing we measured.', pic: 0 },
          { say: 'It sits above its length, so count the ✕s to answer.' },
        ],
        pictures: [{ kind: 'chart', type: 'dot', labels: PENCIL_LABELS, values: PENCILS, xLabel: 'Length in inches' }] },
      { title: 'Put the lengths in order', text: 'We are going to build a better picture. First draw a line, and write the lengths along it in order, a half inch apart: 4, 4 1/2, 5, 5 1/2, 6.',
        beats: [
          { say: 'We are going to build a better picture.' },
          { say: 'First draw a line, and write the lengths along it in order, a half inch apart: 4, 4 1/2, 5, 5 1/2, 6.', pic: 0 },
        ],
        pictures: [{ kind: 'chart', type: 'dot', labels: PENCIL_LABELS, values: [0, 0, 0, 0, 0], xLabel: 'Length in inches' }] },
      { title: 'One ✕ for each pencil', text: 'Now take the pencils one at a time. Each pencil gets one ✕, put above its own length. 7 pencils, so we end up with 7 ✕s.',
        beats: [
          { say: 'Now take the pencils one at a time.', pic: 0 },
          { say: 'Each pencil gets one ✕, put above its own length.', write: 'one ✕ = one pencil' },
          { say: '7 pencils, so we end up with 7 ✕s.' },
        ],
        pictures: [{ kind: 'chart', type: 'dot', labels: PENCIL_LABELS, values: PENCILS, xLabel: 'Length in inches', motion: true }] },
      { title: 'Now count', text: 'Now the picture answers our question fast. See the 3 ✕s sitting above 4 1/2? That means 3 pencils are 4 1/2 inches long. We were asked for longer than 5 inches, so look to the right of 5. There is just 1 ✕ there, so 1 pencil is longer than 5 inches.',
        beats: [
          { say: 'Now the picture answers our question fast.', pic: 0 },
          { say: 'See the 3 ✕s sitting above 4 1/2? That means 3 pencils are 4 1/2 inches long.' },
          { say: 'We were asked for longer than 5 inches, so look to the right of 5.', write: 'longer than 5 → to the right of 5' },
          { say: 'There is just 1 ✕ there, so 1 pencil is longer than 5 inches.' },
        ],
        pictures: [{ kind: 'chart', type: 'dot', labels: PENCIL_LABELS, values: PENCILS, xLabel: 'Length in inches' }] },
      { title: 'One thing not to do', text: "One thing to watch for. Don't count the numbers under the line. Those are lengths, not pencils. Count the ✕s when you want to know how many.",
        beats: [
          { say: 'One thing to watch for.' },
          { say: "Don't count the numbers under the line.", pic: 0 },
          { say: 'Those are lengths, not pencils. Count the ✕s when you want to know how many.' },
        ],
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Check two things: are all 4 sides the same length, and are all 4 corners square corners?',
    screens: [
      ...
      { title: '4 sides is not enough', text: "Every tile has 4 sides. But they don't look the same at all. So is 4 sides enough to tell them apart? No. We have to look closer.",
        beats: [
          { say: 'Every tile has 4 sides.', pic: 0 },
          { say: "But they don't look the same at all." },
          { say: 'So is 4 sides enough to tell them apart? No. We have to look closer.' },
        ],
        pictures: [{ kind: 'poly', shapes: [{ pts: sq, tone: 1 }, { pts: rect, tone: 2 }, { pts: rhom, tone: 3 }, { pts: other, tone: 4 }] }] },
      { title: 'The big idea', text: 'Check two things: are all 4 sides the same length, and are all 4 corners square corners?',
        beats: [
          { say: 'Check two things: are all 4 sides the same length, and are all 4 corners square corners?', pic: 0 },
        ],
        pictures: [{ kind: 'poly', shapes: [{ pts: sq, tone: 1 }, { pts: rect, tone: 2 }, { pts: rhom, tone: 3 }, { pts: other, tone: 4 }] }] },
      { title: 'Look at the corners', text: 'Start with the corners. A square corner is like the corner of a book. We mark it with a small square. The first two tiles have that mark in all 4 corners.',
        beats: [
          { say: 'Start with the corners.', pic: 0 },
          { say: 'A square corner is like the corner of a book. We mark it with a small square.' },
          { say: 'The first two tiles have that mark in all 4 corners.' },
        ],
      ...
      { title: 'Look at the sides', text: 'Now the sides. A tick on a side means it matches the other sides with a tick. Which tiles have 4 ticks? The first one, and the leaning one.',
        beats: [
          { say: 'Now the sides.', pic: 0 },
          { say: 'A tick on a side means it matches the other sides with a tick.' },
          { say: 'Which tiles have 4 ticks? The first one, and the leaning one.' },
        ],
      ...
      { title: 'Put it together', text: 'So what is each tile? A square has both, 4 equal sides and 4 square corners. The rectangle has the square corners, but not the equal sides. The leaning tile has the equal sides, but not the square corners.',
        beats: [
          { say: 'So what is each tile?', pic: 0 },
          { say: 'A square has both, 4 equal sides and 4 square corners.' },
          { say: 'The rectangle has the square corners, but not the equal sides.' },
          { say: 'The leaning tile has the equal sides, but not the square corners.' },
        ],
      ...
      { title: 'One thing not to do', text: "Here's the part people mix up. Don't say a square is NOT a rectangle. It has 4 square corners, so it is a rectangle too. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't say a square is NOT a rectangle.", pic: 0 },
          { say: 'It has 4 square corners, so it is a rectangle too.' },
          { say: 'Okay. Your turn.' },
        ],
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Around the edge', text: 'Where does the fence go? Not across the middle. It goes all the way around the edge. So we need to know how long the whole edge is.',
        beats: [
          { say: 'Where does the fence go? Not across the middle.', pic: 0 },
          { say: 'It goes all the way around the edge.' },
          { say: 'So we need to know how long the whole edge is.' },
        ],
        pictures: [{ kind: 'poly', shapes: [{ pts: GARDEN, sides: ['5 ft', '3 ft', '5 ft', '3 ft'], right: ALL4, tone: 1 }] }] },
      { title: 'The big idea', text: 'The distance around a shape is all of its sides added together.',
        ...
        pictures: [{ kind: 'poly', shapes: [{ pts: GARDEN, sides: ['5 ft', '3 ft', '5 ft', '3 ft'], right: ALL4, tone: 1 }] }] },
      { title: 'Walk around', text: "Let's walk it. Start at this corner. 5 feet across the top, then 3 feet down. 5 feet back, then 3 feet up. We're back where we started.",
        beats: [
          { say: "Let's walk it. Start at this corner.", pic: 0 },
          { say: '5 feet across the top, then 3 feet down.' },
          { say: '5 feet back, then 3 feet up.' },
          { say: "We're back where we started." },
        ],
      ...
      { title: 'Add every side', text: "Now add every side you walked. How many is that, 2 or 4? It's 4. 5 + 3 + 5 + 3 = 16. So Sam needs 16 feet of fence.",
        beats: [
          { say: 'Now add every side you walked.', pic: 0 },
          { say: "How many is that, 2 or 4? It's 4." },
          { say: '5 + 3 + 5 + 3 = 16.', pic: 1 },
          { say: 'So Sam needs 16 feet of fence.' },
        ],
        pictures: [{ kind: 'poly', shapes: [{ pts: GARDEN, sides: ['5 ft', '3 ft', '5 ft', '3 ft'], right: ALL4, tone: 1 }] }, { kind: 'eq', text: '5 + 3 + 5 + 3 = 16' }] },
      { title: 'A side with no number', text: 'Sometimes a side has no number. What is it? In a rectangle, the sides across from each other are the same length. The top is 5 feet, so the bottom is 5 feet too.',
        beats: [
          { say: 'Sometimes a side has no number. What is it?', pic: 0 },
          { say: 'In a rectangle, the sides across from each other are the same length.' },
          { say: 'The top is 5 feet, so the bottom is 5 feet too.' },
        ],
        pictures: [{ kind: 'poly', shapes: [{ pts: GARDEN, sides: ['5 ft', '3 ft', '?', '3 ft'], right: ALL4, tone: 1 }] }] },
      { title: 'One thing not to do', text: "Here's the part people mix up. Don't add just TWO sides. 5 + 3 = 8 only takes you halfway around. Add all 4, and you get 16. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't add just TWO sides.", pic: 0 },
          { say: '5 + 3 = 8 only takes you halfway around. Add all 4, and you get 16.' },
          { say: 'Okay. Your turn.' },
        ],
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Same fence, same inside?', text: "Same fence, so the same room inside? It sounds right. But let's not guess. Let's count and check.",
        beats: [
          { say: 'Same fence, so the same room inside? It sounds right.', pic: 0 },
          { say: "But let's not guess. Let's count and check.", pic: 1 },
        ],
        pictures: [{ kind: 'grid', rows: 1, cols: 5, top: '5 ft', left: '1 ft' }, { kind: 'grid', rows: 2, cols: 4, top: '4 ft', left: '2 ft' }] },
      { title: 'The big idea', text: 'Two gardens can have the same fence around them but hold a different number of squares inside.',
        ...
        pictures: [{ kind: 'grid', rows: 1, cols: 5, top: '5 ft', left: '1 ft' }, { kind: 'grid', rows: 2, cols: 4, top: '4 ft', left: '2 ft' }] },
      { title: 'Walk the fence', text: 'First, are the fences really the same? Walk the long thin garden. 5 + 1 + 5 + 1 = 12. Now the wider one. 4 + 2 + 4 + 2 = 12. Yes. Both fences are 12 feet.',
        beats: [
          { say: 'First, are the fences really the same?' },
          { say: 'Walk the long thin garden. 5 + 1 + 5 + 1 = 12.', pic: 0 },
          { say: 'Now the wider one. 4 + 2 + 4 + 2 = 12.', pic: 1 },
          { say: 'Yes. Both fences are 12 feet.', pic: 2 },
        ],
        pictures: [{ kind: 'grid', rows: 1, cols: 5, top: '5 ft', left: '1 ft' }, { kind: 'grid', rows: 2, cols: 4, top: '4 ft', left: '2 ft' },
          { kind: 'eq', text: '5 + 1 + 5 + 1 = 12', lines: ['4 + 2 + 4 + 2 = 12'] }] },
      { title: 'Count the squares inside', text: "Now count the squares inside. The long thin garden is one row of 5. That's 5 squares. The wider garden is 2 rows of 4. That's 8 squares. Same fence, but not the same room inside.",
        beats: [
          { say: 'Now count the squares inside.' },
          { say: "The long thin garden is one row of 5. That's 5 squares.", pic: 0 },
          { say: "The wider garden is 2 rows of 4. That's 8 squares.", pic: 1 },
          { say: 'Same fence, but not the same room inside.' },
        ],
      ...
      { title: 'One more garden', text: "One more. A garden 3 feet by 3 feet uses 12 feet of fence too. Inside, it's 3 rows of 3. That's 9 squares. That's the most room of all three.",
        beats: [
          { say: 'One more. A garden 3 feet by 3 feet uses 12 feet of fence too.', pic: 0 },
          { say: "Inside, it's 3 rows of 3. That's 9 squares." },
          { say: "That's the most room of all three." },
        ],
        pictures: [{ kind: 'grid', rows: 3, cols: 3, top: '3 ft', left: '3 ft', shade: [{ r: 0, c: 0, h: 3, w: 3, tone: 3 }], motion: true }] },
      { title: 'One thing not to do', text: "Here's the part people mix up. The same fence does NOT mean the same room inside. 12 feet of fence held 5, 8 and 9 squares. So count the squares to check. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: 'The same fence does NOT mean the same room inside.', pic: 0 },
          { say: '12 feet of fence held 5, 8 and 9 squares. So count the squares to check.' },
          { say: 'Okay. Your turn.' },
        ],
