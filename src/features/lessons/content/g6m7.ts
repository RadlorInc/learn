...
export const G6M7: Lesson[] = [
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Four towers of cubes', text: 'Four friends built towers of cubes. The towers are all different heights. If they shared the cubes fairly, how tall would each tower be?',
        pictures: [TOWERS] },
      { title: 'Picking one tower is not fair', text: 'You could pick the tallest tower, 6, or the shortest, 2. But neither one is fair to everyone. We need one number that treats every tower the same.',
        pictures: [TOWERS] },
      { title: 'The big idea', text: 'Put everything together, then share it out equally. Total ÷ how many = the fair share.',
        pictures: [TOWERS] },
      { title: 'Put all the cubes together', text: 'Push every tower into one pile. 2 + 6 + 3 + 5 = 16 cubes.',
        pictures: [{ ...TOWERS, motion: true }, { kind: 'eq', text: '2 + 6 + 3 + 5 = 16' }] },
      { title: 'Share them out', text: 'There are 4 towers. Share the 16 cubes into 4 equal towers. 16 ÷ 4 = 4, so each tower is 4 tall.',
        pictures: [{ ...EVEN, motion: true }, { kind: 'eq', text: '16 ÷ 4 = 4' }] },
      { title: 'Check by moving cubes', text: 'Take 2 cubes off the 6 and give them to the 2. Take 1 cube off the 5 and give it to the 3. Now every tower is 4.',
        pictures: [EVEN, { kind: 'eq', text: '6 − 2 = 4 and 2 + 2 = 4', lines: ['5 − 1 = 4 and 3 + 1 = 4'] }] },
      { title: 'One thing not to do', text: "Don't divide by 2 or by the biggest tower. Divide the total by how many towers there are. Here that is 4.",
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The middle spot is not the middle', text: 'The number in the middle spot of this list is 9. But 9 is the tallest! The list is jumbled, so its middle spot tells you nothing yet.',
        pictures: [row([7, 3, 9, 4, 6], ['Seedling', 'A', 'B', 'C', 'D', 'E'])] },
      { title: 'The big idea', text: 'Put the numbers in order from smallest to biggest. The number in the very middle splits them in half.',
        pictures: [row([7, 3, 9, 4, 6], ['Seedling', 'A', 'B', 'C', 'D', 'E'])] },
      { title: 'Line them up', text: 'Sort the heights from smallest to biggest: 3, 4, 6, 7, 9.',
        pictures: [{ kind: 'table', rows: [['3', '4', '6', '7', '9']], motion: true }] },
      { title: 'Find the middle', text: 'Cross off one number from each end: 3 and 9. Then 4 and 7. The one left is 6. The middle height is 6 inches.',
        pictures: [{ kind: 'table', rows: [['3', '4', '6', '7', '9']], mark: [[0, 2]] }, { kind: 'eq', text: '3, 4, 6, 7, 9', lines: ['middle: 6'] }] },
      { title: 'Two in the middle', text: 'Add a seedling that is 10 inches. Now there are six: 3, 4, 6, 7, 9, 10. Two numbers share the middle, 6 and 7. Take the number halfway between them.',
        pictures: [{ kind: 'table', rows: [['3', '4', '6', '7', '9', '10']], mark: [[0, 2], [0, 3]] }, { kind: 'eq', text: '(6 + 7) ÷ 2 = 6.5' }] },
      { title: 'One thing not to do', text: "Don't take the middle spot before you sort. Put the numbers in order first.",
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'How many pets?', text: '12 kids said how many pets they have. Each ✕ is one kid. Which number of pets is the most common?',
        pictures: [PETS] },
      { title: 'Adding them up does not help', text: 'You could add up all the pets. But that tells you how many pets there are in all, not which answer kids gave most often.',
        pictures: [PETS] },
      { title: 'The big idea', text: 'The most common value is the one that shows up most often. Find the tallest stack and read the number under it.',
        pictures: [PETS] },
      { title: 'Build the stacks', text: 'Each kid puts one ✕ above their number of pets. The stacks grow as the answers come in.',
        pictures: [{ ...PETS, motion: true }] },
      { title: 'Find the tallest stack', text: 'The stack above 1 has 5 ✕s. No other stack is that tall.',
        pictures: [PETS, { kind: 'eq', text: '1 pet: 5 kids' }] },
      { title: 'Read the number under it', text: 'The tallest stack sits above 1. So the most common number of pets is 1.',
        pictures: [PETS, { kind: 'eq', text: 'most common: 1 pet' }] },
      { title: 'One thing not to do', text: "Don't give how tall the stack is. The stack has 5 kids, but the most common answer is 1 pet.",
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'His best game is not enough', text: 'His best game was 15. But that does not tell you how far apart his games are. A player who scores 15 every game is very different.',
        pictures: [line20([4, 11, 7, 15, 9])] },
      { title: 'The big idea', text: 'To see how spread out numbers are, take the biggest number minus the smallest number.',
        pictures: [line20([4, 11, 7, 15, 9])] },
      { title: 'Find the two ends', text: 'The smallest score is 4. The biggest is 15. Every other game sits between them.',
        pictures: [line20([11, 7, 9], { points: [{ at: 4, label: 'smallest' }, { at: 15, label: 'biggest' }], motion: true })] },
      { title: 'Measure the gap', text: 'Jump from 4 to 15. The jump is 15 − 4 = 11 points.',
        pictures: [line20([4, 11, 7, 15, 9], { jumps: [{ from: 4, to: 15, label: '11' }], motion: true }), { kind: 'eq', text: '15 − 4 = 11' }] },
      { title: 'A small gap', text: 'Kim scored 9, 10, 8, 11 and 10. Her gap is 11 − 8 = 3. Her scores sit close together.',
        pictures: [line20([9, 10, 8, 11, 10], { jumps: [{ from: 8, to: 11, label: '3' }] }), { kind: 'eq', text: '11 − 8 = 3' }] },
      { title: 'One thing not to do', text: "Don't subtract the first and last numbers in the list. Find the smallest and the biggest first.",
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Ages at a party', text: 'Five people are at a party. Four kids are 9, 10, 10 and 11. One grown-up is 40. Which one number describes their ages best?',
        pictures: [line40()] },
      { title: 'The mean says 16', text: 'Add the ages: 80. Share by 5: 80 ÷ 5 = 16. But nobody at the party is anywhere near 16.',
      ...
      { title: 'The big idea', text: 'One number far from the rest pulls the mean toward it. The median barely moves, so it fits the group better.',
        pictures: [line40()] },
      { title: 'Watch the mean get pulled', text: 'Without the grown-up, the mean of 9, 10, 10 and 11 is 40 ÷ 4 = 10. Add the 40, and the mean jumps up to 16.',
        pictures: [line40([{ at: 16, label: 'mean' }], [{ from: 10, to: 16, label: 'pulled' }], true), { kind: 'eq', text: '40 ÷ 4 = 10', lines: ['80 ÷ 5 = 16'] }] },
      { title: 'The median stays put', text: 'Sort the ages: 9, 10, 10, 11, 40. The middle one is 10. Even with the 40 in the list, the median is still 10.',
        pictures: [line40([{ at: 10, label: 'median' }], undefined, true), { kind: 'eq', text: '9, 10, 10, 11, 40', lines: ['median: 10'] }] },
      { title: 'Pick the one that fits', text: 'Most people here are about 10. The median, 10, says that. The mean, 16, does not. When one number sits far away, the median fits best.',
        pictures: [line40([{ at: 10, label: 'median' }, { at: 16, label: 'mean' }])] },
      { title: 'One thing not to do', text: "Don't reach for the mean every time. When one number is far from the rest, use the median.",
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'A long list is slow', text: 'You could read a long list of names and times, one by one. A picture sorts them for you, so you can count at a glance.',
        pictures: [PRACTICE_DOTS] },
      { title: 'The big idea', text: 'On a plot of ✕s, each ✕ is one thing. On a bar graph of groups, each bar counts everything in its group.',
        pictures: [PRACTICE_DOTS] },
      { title: 'Count the ✕s', text: 'Each ✕ is one kid. Above 30 there are 5. Above 40 there are 3. Above 50 there is 1.',
        pictures: [{ ...PRACTICE_DOTS, motion: true }] },
      { title: 'Add the stacks you need', text: '30 minutes or more means 30, 40 and 50. Add those stacks: 5 + 3 + 1 = 9 kids.',
        pictures: [PRACTICE_DOTS, { kind: 'eq', text: '5 + 3 + 1 = 9' }] },
      { title: 'Bars for groups', text: 'When the times are all different, put them in groups. The bar over 20–29 counts every kid who practiced 20 to 29 minutes. It reaches 8, so that is 8 kids.',
        pictures: [{ ...PRACTICE_BARS, motion: true }] },
      { title: 'One thing not to do', text: "Don't count the numbers along the bottom. Count the ✕s, or read how tall each bar is.",
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Spin for a prize', text: 'This spinner has 8 equal parts. You win a prize if it lands on red. What is your chance of winning?',
        pictures: [PRIZE] },
      { title: 'Win or lose is not half and half', text: 'There are two results: you win or you lose. But that does not make it 1/2. Red covers only some of the parts.',
        pictures: [PRIZE] },
      { title: 'The big idea', text: 'The chance of something is the number of ways it can happen over the number of all the ways.',
        pictures: [PRIZE] },
      { title: 'Count the ways to win', text: 'Count the red parts: 1, 2, 3. There are 3 ways to win.',
        pictures: [PRIZE, { kind: 'table', head: ['red', 'blue', 'green', 'yellow'], rows: [['3', '3', '1', '1']], mark: [[0, 0]], motion: true }] },
      { title: 'Count all the ways', text: 'Now count every part. The spinner can land on any of them: 3 + 3 + 1 + 1 = 8.',
        pictures: [PRIZE, { kind: 'eq', text: '3 + 3 + 1 + 1 = 8' }] },
      { title: 'Write it as a fraction', text: 'The ways to win go on top. All the ways go on the bottom. The chance of red is 3/8.',
        pictures: [PRIZE, { kind: 'eq', text: 'red parts / all parts', lines: ['3/8'] }] },
      { title: 'One thing not to do', text: "Don't put red over the parts that are not red. Put red over ALL the parts.",
  ...
  // ── Topic 8 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Reach into the bag', text: 'A bag has 4 marbles: 3 red and 1 blue. You reach in without looking. Are you likely to pull out red?',
        pictures: [chance()] },
      { title: 'Words alone are fuzzy', text: '"Maybe" and "probably" mean different things to different people. Putting each chance on one line from 0 to 1 makes it clear.',
        pictures: [chance()] },
      { title: 'The big idea', text: 'Every chance is a number from 0 to 1. 0 is impossible, 1 is certain, and 1/2 is right in the middle.',
        pictures: [chance()] },
      { title: 'The two ends', text: 'A green marble from this bag? 0 ways out of 4, so its chance is 0: impossible. A marble of any color? 4 ways out of 4, so its chance is 1: certain.',
        pictures: [chance([{ at: 0, label: 'green' }, { at: 1, label: 'any color' }], true)] },
      { title: 'Right in the middle', text: 'A coin lands on heads 1 way out of 2. That is 1/2, right in the middle. Heads and tails are equally likely.',
        pictures: [chance([{ at: 0.5, label: 'heads' }])] },
      { title: 'Place red and blue', text: 'Red is 3 ways out of 4: 3/4. That is past the middle, so red is likely. Blue is 1/4, below the middle, so blue is unlikely.',
        pictures: [chance([{ at: 0.25, label: 'blue' }, { at: 0.75, label: 'red' }], true)] },
      { title: 'One thing not to do', text: "Don't call something likely just because it can happen. Blue can happen, but 1/4 is below 1/2, so it is unlikely.",
