  ...
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Picking one tower is not fair', text: 'Look at these four towers. You could pick the tallest one, 6. Or the shortest one, 2. But neither of those is fair to everybody. We want one number that treats all four towers the same.',
        beats: [
          { say: 'Look at these four towers.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'Put everything together, then share it out equally. Total ÷ how many = the fair share.',
        beats: [
          { say: 'Put everything together, then share it out equally.', pic: 0, effect: 'draw' },
      ...
      { title: 'Put all the cubes together', text: 'So watch. Push every tower into one single pile. Add up what is in the pile: 2 + 6 + 3 + 5. That gives us 16 cubes in all.',
        beats: [
          { say: 'So watch. Push every tower into one single pile.', pic: 0, effect: 'draw' },
      ...
      { title: 'Share them out', text: 'Now we share. There are 4 towers, so the 16 cubes split into 4 equal towers. 16 ÷ 4 = 4. Every tower comes out 4 tall. Total, shared by how many.',
        beats: [
          { say: 'Now we share. There are 4 towers, so the 16 cubes split into 4 equal towers.', pic: 0, effect: 'draw' },
          { say: '16 ÷ 4 = 4.', pic: 1 },
      ...
      { title: 'Check by moving cubes', text: "Let's check it a different way. Take 2 cubes off the 6 and hand them to the 2. Take 1 cube off the 5 and hand it to the 3. Look at that: every tower is 4 now, and we never added a single cube.",
        beats: [
          { say: "Let's check it a different way.", pic: 0, effect: 'draw' },
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'Adding them up does not help', text: 'Your first thought might be to add up all the pets. But that would tell us how many pets there are in all. It would not tell us which answer the kids gave most often.',
        beats: [
          { say: 'Your first thought might be to add up all the pets.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'The most common value is the one that shows up most often. Find the tallest stack and read the number under it.',
        beats: [
          { say: 'The most common value is the one that shows up most often.', pic: 0, effect: 'draw' },
      ...
      { title: 'Build the stacks', text: 'Here is how this picture got made. Every kid puts one ✕ above their own number of pets. Watch the stacks grow as the answers come in.',
        beats: [
          ...
          { say: 'Every kid puts one ✕ above their own number of pets.', pic: 0, effect: 'draw' },
      ...
      { title: 'Find the tallest stack', text: 'Now run your eye along the stacks and find the tallest one. The stack above 1 has 5 ✕s in it. Nothing else comes close.',
        beats: [
          { say: 'Now run your eye along the stacks and find the tallest one.', pic: 0, effect: 'draw' },
      ...
      { title: 'Read the number under it', text: 'Last step, and it is the one people rush. Look underneath the tallest stack. It sits above 1, so the most common number of pets is 1.',
        beats: [
          { say: 'Last step, and it is the one people rush.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'His best game is not enough', text: "Sam's best game was 15 points. Nice, but that one number does not tell us how far apart his games are. A player who scores 15 in every single game is a completely different player.",
        beats: [
          { say: "Sam's best game was 15 points.", pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'To see how spread out numbers are, take the biggest number minus the smallest number.',
        beats: [
          { say: 'To see how spread out numbers are, take the biggest number minus the smallest number.', pic: 0, effect: 'draw' },
        ],
        pictures: [line20([4, 11, 7, 15, 9])] },
      { title: 'Find the two ends', text: 'Start at the two ends. His smallest score is 4. His biggest is 15. Every other game he played sits somewhere in between those two.',
        beats: [
          { say: 'Start at the two ends.', pic: 0, effect: 'draw' },
      ...
      { title: 'Measure the gap', text: 'Now measure the gap between them. Jump all the way from 4 up to 15. 15 − 4 = 11, so his scores are spread over 11 points.',
        beats: [
          ...
          { say: 'Jump all the way from 4 up to 15.', pic: 0, effect: 'draw' },
      ...
      { title: 'A small gap', text: 'Now compare that with Kim. She scored 9, 10, 8, 11 and 10. Her gap is 11 − 8 = 3. See how her scores huddle together?',
        beats: [
          { say: 'Now compare that with Kim. She scored 9, 10, 8, 11 and 10.', pic: 0, effect: 'draw' },
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: 'The mean says 16', text: "Let's try the mean first. Add all five ages up and you get 80. Share that by 5: 80 ÷ 5 = 16. But look back at the party. Nobody there is anywhere near 16.",
        beats: [
          { say: "Let's try the mean first.", pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'One number far from the rest pulls the mean toward it. The median barely moves, so it fits the group better.',
        beats: [
          { say: 'One number far from the rest pulls the mean toward it.', pic: 0, effect: 'draw' },
      ...
      { title: 'Watch the mean get pulled', text: 'Watch what that one grown-up does. Take the four kids on their own: 9, 10, 10 and 11 give a mean of 40 ÷ 4 = 10. Now drop the 40 back in, and the mean jumps all the way up to 16. One age dragged it up 6 whole years.',
        beats: [
          { say: 'Watch what that one grown-up does.', pic: 0, effect: 'draw' },
      ...
      { title: 'The median stays put', text: 'Now try the median instead. Sort the ages: 9, 10, 10, 11, 40. The one in the middle is 10. And here is the good part: even with that 40 sitting in the list, the median is still 10.',
        beats: [
          { say: 'Now try the median instead.', pic: 0, effect: 'draw' },
      ...
      { title: 'Pick the one that fits', text: 'So which number describes this party? Almost everyone here is about 10, and the median says 10. The mean says 16, and that fits nobody in the room. When one number sits way off on its own, pick the median.',
        beats: [
          { say: 'So which number describes this party?', pic: 0, effect: 'draw' },
    ...
    screens: [
      ...
      { title: 'A long list is slow', text: 'We could read this as a long list of names and times, one kid at a time. That works, but it is slow. A picture sorts them for us, so we can count at a glance.',
        beats: [
          ...
          { say: 'A picture sorts them for us, so we can count at a glance.', pic: 0, effect: 'draw' },
        ],
        pictures: [PRACTICE_DOTS] },
      { title: 'The big idea', text: 'On a plot of ✕s, each ✕ is one thing. On a bar graph of groups, each bar counts everything in its group.',
        beats: [
          { say: 'On a plot of ✕s, each ✕ is one thing.', pic: 0, effect: 'draw' },
      ...
      { title: 'Count the ✕s', text: "So let's count. Every ✕ here is one kid. Above 30 I count 5. Above 40 there are 3. Above 50 there is just 1.",
        beats: [
          { say: "So let's count.", pic: 0, effect: 'draw' },
      ...
      { title: 'Add the stacks you need', text: 'The question asked for 30 minutes or more. That means 30, and 40, and 50, all three stacks. So add them up: 5 + 3 + 1 = 9 kids.',
        beats: [
          { say: 'The question asked for 30 minutes or more.', pic: 0, effect: 'draw' },
      ...
      { title: 'Bars for groups', text: 'Sometimes every time is different, and every stack would be only 1 tall. So we put the times into groups and draw a bar for each group. This bar over 20–29 counts every kid who practiced 20 to 29 minutes. It reaches 8, so that is 8 kids.',
        beats: [
          ...
          { say: 'So we put the times into groups and draw a bar for each group.', pic: 0, effect: 'draw' },
    ...
    screens: [
      ...
      { title: 'Win or lose is not half and half', text: 'There are only two things that can happen to you: you win, or you lose. That makes it sound like 1/2. But it is not, and the spinner shows you why. Red covers only some of the parts.',
        beats: [
          ...
          { say: 'That makes it sound like 1/2. But it is not, and the spinner shows you why.', pic: 0, effect: 'draw' },
      ...
      { title: 'The big idea', text: 'The chance of something is the number of ways it can happen over the number of all the ways.',
        beats: [
          { say: 'The chance of something is the number of ways it can happen over the number of all the ways.', pic: 0, effect: 'draw' },
        ],
        pictures: [PRIZE] },
      { title: 'Count the ways to win', text: 'First job: count the ways to win. Point at each red part along with me. 1, 2, 3. So there are 3 ways to win.',
        beats: [
          { say: 'First job: count the ways to win.', pic: 0, effect: 'draw' },
      ...
      { title: 'Count all the ways', text: 'Second job: count every part on the wheel, because the arrow could stop on any one of them. 3 red, 3 blue, 1 green and 1 yellow. That is 8 parts in all.',
        beats: [
          { say: 'Second job: count every part on the wheel, because the arrow could stop on any one of them.', pic: 0, effect: 'draw' },
      ...
      { title: 'Write it as a fraction', text: 'Now put those two numbers together as a fraction. The ways to win go on top. All the ways go underneath. So the chance of red is 3/8.',
        beats: [
          { say: 'Now put those two numbers together as a fraction.', pic: 0, effect: 'draw' },
    ...
    screens: [
      ...
      { title: 'Words alone are fuzzy', text: 'You might say "maybe", or you might say "probably". The trouble is that those words mean different things to different people. So we put every chance on one line, from 0 to 1, and then there is nothing to argue about.',
        beats: [
          ...
          { say: 'So we put every chance on one line, from 0 to 1, and then there is nothing to argue about.', pic: 0, effect: 'draw' },
        ],
        pictures: [chance()] },
      { title: 'The big idea', text: 'Every chance is a number from 0 to 1. 0 is impossible, 1 is certain, and 1/2 is right in the middle.',
        beats: [
          { say: 'Every chance is a number from 0 to 1.', pic: 0, effect: 'draw' },
      ...
      { title: 'The two ends', text: "Let's nail down the two ends first. Could you pull a green marble out of this bag? That is 0 ways out of 4, so its chance is 0. Could you pull out a marble of any color at all? That is 4 ways out of 4, so its chance is 1.",
        beats: [
          { say: "Let's nail down the two ends first.", pic: 0, effect: 'draw' },
      ...
      { title: 'Right in the middle', text: 'Now the middle. Flip a coin: heads is 1 way out of 2, which is 1/2. That lands exactly halfway along the line, because heads and tails have the very same chance.',
        beats: [
          { say: 'Now the middle.', pic: 0, effect: 'draw' },
      ...
      { title: 'Place red and blue', text: 'Back to our bag. Red is 3 ways out of 4, so 3/4, and that sits past the middle. Blue is 1 way out of 4, so 1/4, and that sits below the middle. Compare each chance with 1/2, and the word falls right out.',
        beats: [
          { say: 'Back to our bag.', pic: 0, effect: 'draw' },
