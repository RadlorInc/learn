...
export const G6M7: Lesson[] = [
  // ── Topic 1 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "Put it all together, then share it out equally: the total ÷ how many is the fair share.",
    screens: [
      { title: 'Four towers of cubes', text: 'Four friends built towers of cubes. The towers are all different heights. If they shared the cubes fairly, how tall would each tower be?',
        pictures: [TOWERS] },
      { title: "Picking one tower is not fair", text: "Look at these four towers. Pick the tallest, 6? Or the shortest, 2? Neither one is fair to every tower. We need one number that treats all four the same.",
        beats: [
          { say: "Look at these four towers.", pic: 0 },
          { say: "Pick the tallest, 6? Or the shortest, 2?" },
          { say: "Neither one is fair to every tower. We need one number that treats all four the same." },
        ],
        pictures: [TOWERS] },
      { title: "The big idea", text: "Put it all together, then share it out equally: the total ÷ how many is the fair share.",
        beats: [
          { say: "Put it all together, then share it out equally: the total ÷ how many is the fair share.", pic: 0 },
        ],
        pictures: [TOWERS] },
      { title: "Put all the cubes together", text: "So push every tower into one pile. 2 + 6 + 3 + 5 = 16 cubes in all.",
        beats: [
          { say: "So push every tower into one pile.", pic: 0 },
          { say: "2 + 6 + 3 + 5 = 16 cubes in all.", pic: 1 },
        ],
        pictures: [{ ...TOWERS, motion: true }, { kind: 'eq', text: '2 + 6 + 3 + 5 = 16' }] },
      { title: "Share them out", text: "There are 4 towers, so share the 16 cubes into 4 equal towers. 16 ÷ 4 = 4. Every tower is 4 tall.",
        beats: [
          { say: "There are 4 towers, so share the 16 cubes into 4 equal towers.", pic: 0 },
          { say: "16 ÷ 4 = 4.", pic: 1 },
          { say: "Every tower is 4 tall." },
        ],
        pictures: [{ ...EVEN, motion: true }, { kind: 'eq', text: '16 ÷ 4 = 4' }] },
      { title: "Check by moving cubes", text: "Let's check it. Take 2 cubes off the 6 and give them to the 2. Take 1 off the 5 and give it to the 3. Now every tower is 4, and no cube was added.",
        beats: [
          { say: "Let's check it.", pic: 0 },
          { say: "Take 2 cubes off the 6 and give them to the 2.", pic: 1 },
          { say: "Take 1 off the 5 and give it to the 3." },
          { say: "Now every tower is 4, and no cube was added." },
        ],
        pictures: [EVEN, { kind: 'eq', text: '6 − 2 = 4 and 2 + 2 = 4', lines: ['5 − 1 = 4 and 3 + 1 = 4'] }] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't stop at the total. 16 is the whole pile, NOT one tower. Divide it by 4 towers. 16 ÷ 4 = 4. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't stop at the total. 16 is the whole pile, NOT one tower.", pic: 0 },
          { say: "Divide it by 4 towers. 16 ÷ 4 = 4." },
          { say: "Okay. Your turn." },
        ],
        pictures: [{ kind: 'cards', wrong: 'Each tower: 16', right: '16 ÷ 4 = 4' }] },
    ],
    turn: {
  ...
  // ── Topic 2 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "Put the numbers in order, and the one in the very middle splits them in half.",
    screens: [
      ...
      { title: "The middle spot is not the middle", text: "The middle spot of this list holds 9. But 9 is the tallest seedling. Can the tallest be the middle? No. This list is jumbled.",
        beats: [
          { say: "The middle spot of this list holds 9.", pic: 0 },
          { say: "But 9 is the tallest seedling. Can the tallest be the middle? No." },
          { say: "This list is jumbled." },
        ],
        pictures: [row([7, 3, 9, 4, 6], ['Seedling', 'A', 'B', 'C', 'D', 'E'])] },
      { title: "The big idea", text: "Put the numbers in order, and the one in the very middle splits them in half.",
        beats: [
          { say: "Put the numbers in order, and the one in the very middle splits them in half.", pic: 0 },
        ],
        pictures: [row([7, 3, 9, 4, 6], ['Seedling', 'A', 'B', 'C', 'D', 'E'])] },
      { title: "Line them up", text: "So the first job, every time, is to sort them. Smallest to biggest, that's 3, 4, 6, 7, 9.",
        beats: [
          { say: "So the first job, every time, is to sort them." },
          { say: "Smallest to biggest, that's 3, 4, 6, 7, 9.", pic: 0 },
        ],
        pictures: [{ kind: 'table', rows: [['3', '4', '6', '7', '9']], motion: true }] },
      { title: "Find the middle", text: "Now cross off one from each end. 3 and 9 go. Then 4 and 7 go. The one left is 6, so the middle height is 6 inches.",
        beats: [
          { say: "Now cross off one from each end.", pic: 0 },
          { say: "3 and 9 go. Then 4 and 7 go." },
          { say: "The one left is 6, so the middle height is 6 inches.", pic: 1 },
        ],
        pictures: [{ kind: 'table', rows: [['3', '4', '6', '7', '9']], mark: [[0, 2]] }, { kind: 'eq', text: '3, 4, 6, 7, 9', lines: ['middle: 6'] }] },
      { title: "Two in the middle", text: "What if there's no single middle? Add a seedling that's 10 inches tall. Now two numbers share the middle, 6 and 7. Halfway between them is 6.5.",
        beats: [
          { say: "What if there's no single middle?" },
          { say: "Add a seedling that's 10 inches tall.", pic: 0 },
          { say: "Now two numbers share the middle, 6 and 7." },
          { say: "Halfway between them is 6.5.", pic: 1 },
        ],
        pictures: [{ kind: 'table', rows: [['3', '4', '6', '7', '9', '10']], mark: [[0, 2], [0, 3]] }, { kind: 'eq', text: '(6 + 7) ÷ 2 = 6.5' }] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't grab the middle spot BEFORE you sort. That gives 9. Sort first, and the middle is 6. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't grab the middle spot BEFORE you sort. That gives 9.", pic: 0 },
          { say: "Sort first, and the middle is 6." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 3 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: "The most common value is the one that shows up most often, so find the tallest stack and read the number under it.",
    screens: [
      { title: 'How many pets?', text: '12 kids said how many pets they have. Each ✕ is one kid. Which number of pets is the most common?',
        pictures: [PETS] },
      { title: "Adding them up does not help", text: "You could add up all the pets. Would that show which answer came up most? No. It only tells how many pets there are in all.",
        beats: [
          { say: "You could add up all the pets.", pic: 0 },
          { say: "Would that show which answer came up most? No." },
          { say: "It only tells how many pets there are in all." },
        ],
        pictures: [PETS] },
      { title: "The big idea", text: "The most common value is the one that shows up most often, so find the tallest stack and read the number under it.",
        beats: [
          { say: "The most common value is the one that shows up most often, so find the tallest stack and read the number under it.", pic: 0 },
        ],
        pictures: [PETS] },
      { title: "Build the stacks", text: "Here's how this picture is made. Each kid puts one ✕ above their number of pets. Watch the stacks grow.",
        beats: [
          { say: "Here's how this picture is made." },
          { say: "Each kid puts one ✕ above their number of pets.", pic: 0 },
          { say: "Watch the stacks grow." },
        ],
        pictures: [{ ...PETS, motion: true }] },
      { title: "Find the tallest stack", text: "Which stack is the tallest? Count each one: 3, 5, 2, 1, 1. The tallest has 5 ✕s, more than any other.",
        beats: [
          { say: "Which stack is the tallest?", pic: 0 },
          { say: "Count each one: 3, 5, 2, 1, 1." },
          { say: "The tallest has 5 ✕s, more than any other.", pic: 1 },
        ],
        pictures: [PETS, { kind: 'eq', text: 'tallest stack: 5 ✕s' }] },
      { title: "Read the number under it", text: "Now look under that stack. It sits above 1. So the most common number of pets is 1.",
        beats: [
          { say: "Now look under that stack.", pic: 0 },
          { say: "It sits above 1." },
          { say: "So the most common number of pets is 1.", pic: 1 },
        ],
        pictures: [PETS, { kind: 'eq', text: 'most common: 1 pet' }] },
      { title: "One thing not to do", text: "Here's the part people mix up. The answer is NOT how tall the stack is. It holds 5 kids, but the most common answer is 1 pet. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "The answer is NOT how tall the stack is.", pic: 0 },
          { say: "It holds 5 kids, but the most common answer is 1 pet." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 4 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { title: "His best game is not enough", text: "Sam's best game was 15 points. But does one number show how far apart his games are? No. A player who scores 15 every game is very different.",
        beats: [
          { say: "Sam's best game was 15 points.", pic: 0 },
          { say: "But does one number show how far apart his games are? No." },
          { say: "A player who scores 15 every game is very different." },
        ],
        pictures: [line20([4, 11, 7, 15, 9])] },
      { title: "The big idea", text: "To see how spread out numbers are, take the biggest number minus the smallest number.",
        ...
        pictures: [line20([4, 11, 7, 15, 9])] },
      { title: "Find the two ends", text: "Start at the two ends. His smallest score is 4. His biggest is 15. Every other game sits in between.",
        beats: [
          { say: "Start at the two ends.", pic: 0 },
          { say: "His smallest score is 4. His biggest is 15." },
          { say: "Every other game sits in between." },
        ],
        pictures: [line20([11, 7, 9], { points: [{ at: 4, label: 'smallest' }, { at: 15, label: 'biggest' }], motion: true })] },
      { title: "Measure the gap", text: "How far is it from 4 up to 15? 15 − 4 = 11. So his scores are spread over 11 points.",
        beats: [
          { say: "How far is it from 4 up to 15?", pic: 0 },
          { say: "15 − 4 = 11.", pic: 1 },
          { say: "So his scores are spread over 11 points." },
        ],
        pictures: [line20([4, 11, 7, 15, 9], { jumps: [{ from: 4, to: 15, label: '11' }], motion: true }), { kind: 'eq', text: '15 − 4 = 11' }] },
      { title: "A small gap", text: "Now Kim. She scored 9, 10, 8, 11 and 10. Her gap is 11 − 8 = 3. See how her scores huddle close together?",
        beats: [
          { say: "Now Kim. She scored 9, 10, 8, 11 and 10.", pic: 0 },
          { say: "Her gap is 11 − 8 = 3.", pic: 1 },
          { say: "See how her scores huddle close together?" },
        ],
        pictures: [line20([9, 10, 8, 11, 10], { jumps: [{ from: 8, to: 11, label: '3' }] }), { kind: 'eq', text: '11 − 8 = 3' }] },
      { title: "One thing not to do", text: "Here's the part people mix up. Don't subtract the FIRST number from the LAST one. That gives 9 − 4 = 5. Find the smallest and the biggest instead. 15 − 4 = 11. Okay. Your turn.",
        beats: [
          { say: "Here's the part people mix up." },
          { say: "Don't subtract the FIRST number from the LAST one. That gives 9 − 4 = 5.", pic: 0 },
          { say: "Find the smallest and the biggest instead. 15 − 4 = 11." },
          { say: "Okay. Your turn." },
        ],
  ...
  // ── Topic 5 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'One number far from the rest pulls the mean toward it. The median barely moves, so it fits the group better.',
    screens: [
      { title: 'Ages at a party', text: 'Five people are at a party. Four kids are 9, 10, 10 and 11. One grown-up is 40. Which one number describes their ages best?',
        pictures: [line40()] },
      { title: 'The mean says 16', text: "Let's try the mean first. Add all five ages up and you get 80. Share that by 5: 80 ÷ 5 = 16. But look back at the party. Nobody there is anywhere near 16.",
        beats: [
          { say: "Let's try the mean first.", pic: 0 },
          { say: 'Add all five ages up and you get 80. Share that by 5: 80 ÷ 5 = 16.', pic: 1 },
          { say: 'But look back at the party. Nobody there is anywhere near 16.' },
        ],
        pictures: [line40(), { kind: 'eq', text: '80 ÷ 5 = 16' }] },
      { title: 'The big idea', text: 'One number far from the rest pulls the mean toward it. The median barely moves, so it fits the group better.',
        beats: [
          { say: 'One number far from the rest pulls the mean toward it.', pic: 0 },
          { say: 'The median barely moves, so it fits the group better.' },
        ],
        pictures: [line40()] },
      { title: 'Watch the mean get pulled', text: 'Watch what that one grown-up does. Take the four kids on their own: 9, 10, 10 and 11 give a mean of 40 ÷ 4 = 10. Now drop the 40 back in, and the mean jumps all the way up to 16. One age dragged it up 6 whole years.',
        beats: [
          { say: 'Watch what that one grown-up does.', pic: 0 },
          { say: 'Take the four kids on their own: 9, 10, 10 and 11 give a mean of 40 ÷ 4 = 10.', pic: 1 },
          { say: 'Now drop the 40 back in, and the mean jumps all the way up to 16.' },
          { say: 'One age dragged it up 6 whole years.', write: 'one far number → the mean moves' },
        ],
        pictures: [line40([{ at: 16, label: 'mean' }], [{ from: 10, to: 16, label: 'pulled' }], true), { kind: 'eq', text: '40 ÷ 4 = 10', lines: ['80 ÷ 5 = 16'] }] },
      { title: 'The median stays put', text: 'Now try the median instead. Sort the ages: 9, 10, 10, 11, 40. The one in the middle is 10. And here is the good part: even with that 40 sitting in the list, the median is still 10.',
        beats: [
          { say: 'Now try the median instead.', pic: 0 },
          { say: 'Sort the ages: 9, 10, 10, 11, 40. The one in the middle is 10.', pic: 1 },
          { say: 'And here is the good part: even with that 40 sitting in the list, the median is still 10.', write: 'the median barely moves' },
        ],
        pictures: [line40([{ at: 10, label: 'median' }], undefined, true), { kind: 'eq', text: '9, 10, 10, 11, 40', lines: ['median: 10'] }] },
      { title: 'Pick the one that fits', text: 'So which number describes this party? Almost everyone here is about 10, and the median says 10. The mean says 16, and that fits nobody in the room. When one number sits way off on its own, pick the median.',
        beats: [
          { say: 'So which number describes this party?', pic: 0 },
          { say: 'Almost everyone here is about 10, and the median says 10.' },
          { say: 'The mean says 16, and that fits nobody in the room.' },
          { say: 'When one number sits way off on its own, pick the median.', write: 'one far number → use the median' },
        ],
        pictures: [line40([{ at: 10, label: 'median' }, { at: 16, label: 'mean' }])] },
      { title: 'One thing not to do', text: "Last thing. Don't reach for the mean every time out of habit. When one number is far from the rest, the median is the one you want.",
        beats: [
          { say: 'Last thing.' },
          { say: "Don't reach for the mean every time out of habit.", pic: 0 },
          { say: 'When one number is far from the rest, the median is the one you want.' },
        ],
  ...
  // ── Topic 6 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'On a plot of ✕s, each ✕ is one thing. On a bar graph of groups, each bar counts everything in its group.',
    screens: [
      ...
      { title: 'A long list is slow', text: 'We could read this as a long list of names and times, one kid at a time. That works, but it is slow. A picture sorts them for us, so we can count at a glance.',
        beats: [
          { say: 'We could read this as a long list of names and times, one kid at a time.' },
          { say: 'That works, but it is slow.' },
          { say: 'A picture sorts them for us, so we can count at a glance.', pic: 0 },
        ],
        pictures: [PRACTICE_DOTS] },
      { title: 'The big idea', text: 'On a plot of ✕s, each ✕ is one thing. On a bar graph of groups, each bar counts everything in its group.',
        beats: [
          { say: 'On a plot of ✕s, each ✕ is one thing.', pic: 0 },
          { say: 'On a bar graph of groups, each bar counts everything in its group.' },
        ],
        pictures: [PRACTICE_DOTS] },
      { title: 'Count the ✕s', text: "So let's count. Every ✕ here is one kid. Above 30 I count 5. Above 40 there are 3. Above 50 there is just 1.",
        beats: [
          { say: "So let's count.", pic: 0 },
          { say: 'Every ✕ here is one kid.', write: 'one ✕ = one kid' },
          { say: 'Above 30 I count 5. Above 40 there are 3. Above 50 there is just 1.' },
        ],
        pictures: [{ ...PRACTICE_DOTS, motion: true }] },
      { title: 'Add the stacks you need', text: 'The question asked for 30 minutes or more. That means 30, and 40, and 50, all three stacks. So add them up: 5 + 3 + 1 = 9 kids.',
        beats: [
          { say: 'The question asked for 30 minutes or more.', pic: 0 },
          { say: 'That means 30, and 40, and 50, all three stacks.', write: 'or more → add every stack above it' },
          { say: 'So add them up: 5 + 3 + 1 = 9 kids.', pic: 1 },
        ],
        pictures: [PRACTICE_DOTS, { kind: 'eq', text: '5 + 3 + 1 = 9' }] },
      { title: 'Bars for groups', text: 'Sometimes every time is different, and every stack would be only 1 tall. So we put the times into groups and draw a bar for each group. This bar over 20–29 counts every kid who practiced 20 to 29 minutes. It reaches 8, so that is 8 kids.',
        beats: [
          { say: 'Sometimes every time is different, and every stack would be only 1 tall.' },
          { say: 'So we put the times into groups and draw a bar for each group.', pic: 0 },
          { say: 'This bar over 20–29 counts every kid who practiced 20 to 29 minutes.' },
          { say: 'It reaches 8, so that is 8 kids.', write: 'bar height = how many in the group' },
        ],
        pictures: [{ ...PRACTICE_BARS, motion: true }] },
      { title: 'One thing not to do', text: "Here is the slip to avoid. Don't count the numbers written along the bottom. Count the ✕s, or read how tall the bar is.",
        beats: [
          { say: 'Here is the slip to avoid.' },
          { say: "Don't count the numbers written along the bottom.", pic: 0 },
          { say: 'Count the ✕s, or read how tall the bar is.' },
        ],
  ...
  // ── Topic 7 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      { title: 'Spin for a prize', text: 'This spinner has 8 equal parts. You win a prize if it lands on red. What is your chance of winning?',
        pictures: [PRIZE] },
      { title: 'Win or lose is not half and half', text: 'There are only two things that can happen to you: you win, or you lose. That makes it sound like 1/2. But it is not, and the spinner shows you why. Red covers only some of the parts.',
        beats: [
          { say: 'There are only two things that can happen to you: you win, or you lose.' },
          { say: 'That makes it sound like 1/2. But it is not, and the spinner shows you why.', pic: 0 },
          { say: 'Red covers only some of the parts.', write: 'count the parts, not the results' },
        ],
        pictures: [PRIZE] },
      { title: 'The big idea', text: 'The chance of something is the number of ways it can happen over the number of all the ways.',
        ...
        pictures: [PRIZE] },
      { title: 'Count the ways to win', text: 'First job: count the ways to win. Point at each red part along with me. 1, 2, 3. So there are 3 ways to win.',
        beats: [
          { say: 'First job: count the ways to win.', pic: 0 },
          { say: 'Point at each red part along with me. 1, 2, 3.' },
          { say: 'So there are 3 ways to win.', pic: 1 },
        ],
        pictures: [PRIZE, { kind: 'table', head: ['red', 'blue', 'green', 'yellow'], rows: [['3', '3', '1', '1']], mark: [[0, 0]], motion: true }] },
      { title: 'Count all the ways', text: 'Second job: count every part on the wheel, because the arrow could stop on any one of them. 3 red, 3 blue, 1 green and 1 yellow. That is 8 parts in all.',
        beats: [
          { say: 'Second job: count every part on the wheel, because the arrow could stop on any one of them.', pic: 0 },
          { say: '3 red, 3 blue, 1 green and 1 yellow.', pic: 1 },
          { say: 'That is 8 parts in all.' },
        ],
        pictures: [PRIZE, { kind: 'eq', text: '3 + 3 + 1 + 1 = 8' }] },
      { title: 'Write it as a fraction', text: 'Now put those two numbers together as a fraction. The ways to win go on top. All the ways go underneath. So the chance of red is 3/8.',
        beats: [
          { say: 'Now put those two numbers together as a fraction.', pic: 0 },
          { say: 'The ways to win go on top. All the ways go underneath.' },
          { say: 'So the chance of red is 3/8.', pic: 1 },
        ],
        pictures: [PRIZE, { kind: 'eq', text: 'red parts / all parts', lines: ['3/8'] }] },
      { title: 'One thing not to do', text: "And here is the classic mistake. Don't put the red parts over the parts that are not red. Red goes over every part on the wheel, all 8 of them.",
        beats: [
          { say: 'And here is the classic mistake.' },
          { say: "Don't put the red parts over the parts that are not red.", pic: 0 },
          { say: 'Red goes over every part on the wheel, all 8 of them.' },
        ],
  ...
  // ── Topic 8 ──────────────────────────────────────────────────────────────────────────────────
  {
    ...
    bigIdea: 'Every chance is a number from 0 to 1. 0 is impossible, 1 is certain, and 1/2 is right in the middle.',
    screens: [
      { title: 'Reach into the bag', text: 'A bag has 4 marbles: 3 red and 1 blue. You reach in without looking. Are you likely to pull out red?',
        pictures: [chance()] },
      { title: 'Words alone are fuzzy', text: 'You might say "maybe", or you might say "probably". The trouble is that those words mean different things to different people. So we put every chance on one line, from 0 to 1, and then there is nothing to argue about.',
        beats: [
          { say: 'You might say "maybe", or you might say "probably".' },
          { say: 'The trouble is that those words mean different things to different people.' },
          { say: 'So we put every chance on one line, from 0 to 1, and then there is nothing to argue about.', pic: 0 },
        ],
        pictures: [chance()] },
      { title: 'The big idea', text: 'Every chance is a number from 0 to 1. 0 is impossible, 1 is certain, and 1/2 is right in the middle.',
        beats: [
          { say: 'Every chance is a number from 0 to 1.', pic: 0 },
          { say: '0 is impossible, 1 is certain, and 1/2 is right in the middle.' },
        ],
        pictures: [chance()] },
      { title: 'The two ends', text: "Let's nail down the two ends first. Could you pull a green marble out of this bag? That is 0 ways out of 4, so its chance is 0. Could you pull out a marble of any color at all? That is 4 ways out of 4, so its chance is 1.",
        beats: [
          { say: "Let's nail down the two ends first.", pic: 0 },
          { say: 'Could you pull a green marble out of this bag? That is 0 ways out of 4, so its chance is 0.' },
          { say: 'Could you pull out a marble of any color at all? That is 4 ways out of 4, so its chance is 1.' },
        ],
        pictures: [chance([{ at: 0, label: 'green' }, { at: 1, label: 'any color' }], true)] },
      { title: 'Right in the middle', text: 'Now the middle. Flip a coin: heads is 1 way out of 2, which is 1/2. That lands exactly halfway along the line, because heads and tails have the very same chance.',
        beats: [
          { say: 'Now the middle.', pic: 0 },
          { say: 'Flip a coin: heads is 1 way out of 2, which is 1/2.' },
          { say: 'That lands exactly halfway along the line, because heads and tails have the very same chance.' },
        ],
        pictures: [chance([{ at: 0.5, label: 'heads' }])] },
      { title: 'Place red and blue', text: 'Back to our bag. Red is 3 ways out of 4, so 3/4, and that sits past the middle. Blue is 1 way out of 4, so 1/4, and that sits below the middle. Compare each chance with 1/2, and the word falls right out.',
        beats: [
          { say: 'Back to our bag.', pic: 0 },
          { say: 'Red is 3 ways out of 4, so 3/4, and that sits past the middle.' },
          { say: 'Blue is 1 way out of 4, so 1/4, and that sits below the middle.' },
          { say: 'Compare each chance with 1/2, and the word falls right out.', write: 'compare with 1/2' },
        ],
        pictures: [chance([{ at: 0.25, label: 'blue' }, { at: 0.75, label: 'red' }], true)] },
      { title: 'One thing not to do', text: "One last warning. Don't call something likely just because it could happen. Blue can happen, but 1/4 is below 1/2, so blue is unlikely.",
        beats: [
          { say: 'One last warning.' },
          { say: "Don't call something likely just because it could happen.", pic: 0 },
          { say: 'Blue can happen, but 1/4 is below 1/2, so blue is unlikely.' },
        ],
