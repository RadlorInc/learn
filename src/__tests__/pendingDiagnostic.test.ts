...
import { stashPendingDiagnostic, peekPendingDiagnostic, takePendingDiagnostic } from '@/infra/storage/pendingDiagnostic'
import type { PendingDiagnostic } from '@/infra/storage/pendingDiagnostic'
