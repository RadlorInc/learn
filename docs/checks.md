# Checks — the full rules and the incident log

> Moved verbatim out of `CLAUDE.md` on 2026-09-26 (Rafi's N20: the auto-loaded context had reached ~130 KiB a
> session). `CLAUDE.md` keeps the core rule and a one-line index of every rule below. **Add new instances here.**
...
- ⚠️⚠️ **A GATE IS NOT WORTH A CAPABILITY MORE DANGEROUS THAN WHAT IT DETECTS.** Founder's rule,
  ...
  but "what could hold this, and what would they reach?" See also **[docs/security.md](security.md)** — the
