...
|---|---|
| A child's profile and their work | Until you delete the profile or close the account. We do not delete it on a timer, because it is what lets your child pick up where they left off |
...
We treat every child on the service the same way, whatever their age. A parent holds the account, a parent gives permission before we collect anything, and every protection described in this policy applies to a 15-year-old exactly as it does to a 9-year-old. COPPA itself covers only children under 13; we apply the same standard above that age because it is simpler and because it is the standard we would want applied to our own children.
