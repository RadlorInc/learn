...
**You must be 18 or older and the parent or legal guardian of any child you set up.** You are the account holder. You are the only party to this agreement.

A child does not hold an account. A child uses a **profile** inside your account, under your supervision. You are responsible for your child's use of the Service, for keeping your login details private, and for anything done through your account.

You confirm that the information you give us at sign-up is accurate, and that you are legally able to enter into this agreement.
...
**We do not promise any particular result.** Learning outcomes differ from child to child. We make no guarantee of grade improvement, mastery, test performance or academic progress.
...
- **We keep a record of that consent** — the date, how it was given, your email address, and the version of each document you were shown. We keep it so that we can show, later, exactly what you agreed to. If you close your account, that record is deleted along with everything else.
...
- misrepresent what the Service does — for example, in advertising or resale.

We may suspend or close an account that breaches this section. Where it is reasonable to do so, we will tell you first and give you a chance to put it right.
...
**Yours.** Anything your child submits — answers, work, and anything else you or your child puts into the Service — stays yours ("User Content"). You grant us the licence we need to **operate the Service for you**: to store it, display it back to you and your child, and process it so the Service can adapt and report progress. That licence ends when the content is deleted.

**Model training.** We do not use User Content — including your child's work — to train, develop or evaluate artificial-intelligence models, and we do not provide it to anyone else for that purpose. We use it only to run the Service for you, as described above.

**Feedback.** If you send us a suggestion, we may use it freely and without obligation to you.

## 8. Artificial intelligence: what it can and cannot do
...
We aim to keep the Service running, but we do not promise it will be uninterrupted or error-free. We may change, add or remove features. If we make a change you do not want, you can stop using the Service and close your account at any time.

We may perform maintenance, and we may suspend the Service where necessary for security.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE", WITHOUT WARRANTIES OF ANY KIND, EXPRESS, IMPLIED OR STATUTORY, INCLUDING ANY IMPLIED WARRANTY OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, OR NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED OR ERROR-FREE, OR THAT IT WILL MEET ANY PARTICULAR LEARNING GOAL.
...
You agree to indemnify us against claims, losses and reasonable legal costs arising from your breach of these Terms, your misuse of the Service, or your infringement of someone else's rights. This does not apply to anything caused by us.
...
Before starting formal proceedings, we both agree to try to resolve the dispute by contacting each other first — write to support@radlor.com and we will respond within 30 days.

If a dispute is not resolved informally, it will be brought exclusively in the state or federal courts located in Delaware, and we each consent to that jurisdiction.

## 16. General

- **Entire agreement.** These Terms, together with the Privacy Policy, are the whole agreement between us about the Service.
- **Changes.** We may update these Terms. We will post the updated version with a new date and, for material changes, email you at least 14 days before they take effect. If you do not agree, you may close your account. Changes affecting children's information follow the additional rule in the Privacy Policy.
- **Severability.** If a provision is unenforceable, the rest stands.
- **No waiver.** Not enforcing a right once does not waive it.
- **Assignment.** You may not transfer your account. We may assign these Terms in connection with a merger or sale, subject to the Privacy Policy.
...
1. **Section 2.** Please confirm the parent-as-sole-party structure is sound, including the parent's responsibility for the child's use, and whether anything is needed for a child aged 13–17 who may be capable of contracting in some respects.
2. **Section 5.** These Terms point at the Refund and Cancellation Policy for the automatic renewal detail. Please confirm the state automatic renewal statutes are satisfied by that split, or tell us what must appear in the Terms themselves.
3. **Section 7, model training.** Radlor has decided this is a "no", and both this document and the Privacy Policy now say so. Please review the wording and confirm it is a commitment Radlor can keep given its vendor stack — see the corresponding note on the Privacy Policy.
4. **Section 8.** Please review the AI disclaimer against the fact that the content is aimed at children and that a wrong answer taught confidently is the realistic failure mode.
5. **Section 14.** Please advise whether DMCA agent registration is warranted.
6. **Section 15.** Arbitration and class waiver: please advise, and draft if adopted. Delaware as governing law was carried over from the earlier draft — please confirm it is the right choice for a consumer product sold nationwide.
7. **Section 12.** Please set the liability floor and confirm the carve-outs.
8. Please advise on anything needed for advertising claims and testimonials, since marketing will run alongside launch.
