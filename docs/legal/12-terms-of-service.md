...
**Ours.** The Service, and everything in it — lessons, questions, diagrams, audio, software, models and design — belongs to us or our licensors. We grant you a limited, personal, non-exclusive, non-transferable licence to use it for your own household's non-commercial educational use while your subscription is active.
...
We aim to keep the Service running, but we do not promise it will be uninterrupted or error-free. We may change, add or remove features. If we make a change that materially reduces what you have paid for, we will tell you and [PLACEHOLDER — state the remedy: a pro-rata refund, or the right to cancel].
...
- **Entire agreement.** These Terms, together with the Privacy Policy and the Refund and Cancellation Policy, are the whole agreement between us about the Service.
- **Changes.** We may update these Terms. We will post the updated version with a new date and, for material changes, email you at least [PLACEHOLDER — number] days before they take effect. If you do not agree, you may cancel. Changes never apply retroactively to a period you have already paid for, and changes affecting children's information follow the additional rule in the Privacy Policy.
