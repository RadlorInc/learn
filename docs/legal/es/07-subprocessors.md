...
| **Resend** | Entrega todos los correos electrónicos que envía el servicio. La aplicación envía sus propios correos directamente a través de Resend — el correo de registro, los dos correos de consentimiento y el aviso de cancelación — y Resend es también el relé SMTP detrás del sistema de correo del servicio de autenticación (restablecer la contraseña, cambiar la dirección de correo). **Todos los mensajes que recibe un padre o una madre los entrega Resend** | **No**, salvo que algún día se cree un correo de progreso que nombre a un niño — no existe ninguno | La dirección de correo electrónico del padre o la madre y el contenido del mensaje | Estados Unidos: Virginia del Norte, us-east-1 (confirmado en el panel de Resend el 24 de septiembre de 2026) | Proveedor de servicios |
