...
## Signup page — shown above the signup buttons (no tick box since 25 September 2026: consent is the email-plus request the parent starts from the dashboard, after reading the full notice there)
